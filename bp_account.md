...
You can also manage account resources as code by using Terraform IBM Modules. Key modules include [IAM Account Settings module](https://github.com/terraform-ibm-modules/terraform-ibm-iam-account-settings) for account settings, [IAM Access Groups module](https://github.com/terraform-ibm-modules/terraform-ibm-iam-access-group) for access groups, and [Context-Based Restrictions module](https://github.com/terraform-ibm-modules/terraform-ibm-cbr) for context-based restrictions. For more information, see [About Terraform IBM Modules](https://cloud.ibm.com/docs/ibm-cloud-provider-for-terraform?topic=ibm-cloud-provider-for-terraform-about-tim).
{: tip}
...
- To automate account resource provisioning with Terraform, see the [IAM Account Settings module](https://github.com/terraform-ibm-modules/terraform-ibm-iam-account-settings), [IAM Access Groups module](https://github.com/terraform-ibm-modules/terraform-ibm-iam-access-group), and [Context-Based Restrictions module](https://github.com/terraform-ibm-modules/terraform-ibm-cbr). You can explore all available modules in the [Terraform IBM Modules registry](https://registry.terraform.io/namespaces/terraform-ibm-modules).

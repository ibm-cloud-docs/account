...
1. Log in to your SoftLayer account, and click **OK** when the prompt to switch to an IBMid is displayed.
   ...
   If you are a master user and a prompt to switch to an IBMid is not displayed in the customer portal, contact IBM support for help. See [Getting support](/docs/get-support/howtogetsupport.html#getting-customer-support) for more information about contacting support.

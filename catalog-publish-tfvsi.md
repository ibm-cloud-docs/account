...
# Publishing products that use Terraform with virtual server images
{: #publishtfvsi}
...
When users install the software, they can select the link to your readme file to view product information. The information in the Readme link is generated from the readme file that you uploaded to your repository.

...
Broader organizations and other users with broader cloud workloads can benefit from the savings and predictable billing that are provided by subscriptions. {{site.data.keyword.cloud_notm}} offers multiple types of subscriptions to fit your usage needs.
...
Service bundle subscriptions aren't available through the {{site.data.keyword.cloud_notm}} console. To learn more and purchase a service bundle, contact [{{site.data.keyword.cloud_notm}} Sales](https://www.ibm.com/solutions/cloud?contactmodule){: external}.
{: tip}
...
You can work with [{{site.data.keyword.cloud_notm}} Sales](https://www.ibm.com/solutions/cloud?contactmodule){: external} to renew your subscription account.

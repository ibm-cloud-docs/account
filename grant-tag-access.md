...
1. Select **All Identity and Access enabled services** or a specific service as the type of access to assign.
1. Select a specific location. 
1. Select **Editor** from the list of platform access roles, and click **Add**.
1. Review your access summary, and click **Assign**. 

...
To view and manage your support cases, go to the [Manage cases page](/unifiedsupport/cases). You can also get a quick view of your 5 most recently updated open cases by typing `case status` in the [{{site.data.keyword.cloud_notm}} AI assistant](/docs/overview?topic=overview-ask-ai-assistant#support-case-status). If you're a classic infrastructure user, and you don't see a listing of a previous case, click **View classic infrastructure cases**.

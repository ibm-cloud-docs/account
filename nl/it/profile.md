...
La prima volta che utilizzi {{site.data.keyword.Bluemix}}, vorrai configurare il tuo profilo account. Vai all'icona **{{site.data.keyword.avatar}}** ![Icona Avatar](../icons/i-avatar-icon.svg) &gt; **Visualizza profilo** per impostare o aggiornare le impostazioni del tuo profilo.
{:shortdesc}
...
Se sei un amministratore di {{site.data.keyword.Bluemix_notm}} locale o {{site.data.keyword.Bluemix_notm}} dedicato, vedi [Gestione di {{site.data.keyword.Bluemix_notm}} locale o {{site.data.keyword.Bluemix_notm}} dedicato](/docs/hybrid/index.html#mng) per i dettagli sulla gestione del tuo account utilizzando la pagina Amministrazione.

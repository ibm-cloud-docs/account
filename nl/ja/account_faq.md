...
従量課金 (PAYG) アカウントをサブスクリプション・アカウントにアップグレードするには、[IBM Cloud 営業担当員](https://www.ibm.com/cloud-computing/bluemix/contact-us){: new_window} ![外部リンク・アイコン](../icons/launch-glyph.svg "外部リンク・アイコン") にお問い合わせください。
...
タグを使用すると、リソース・リストからタグをフィルタリングすることによって、アカウント全体でリソースを編成および表示することができます。 詳しくは、『[リソースのタグ付け](/docs/resources?topic=resources-add-remove#add-remove)』を参照してください。

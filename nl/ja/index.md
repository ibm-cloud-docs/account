...
サービス・バンドル・サブスクリプションは、{{site.data.keyword.Bluemix_notm}} コンソールからはご利用になれません。 サービス・バンドルの詳細と購入については、[{{site.data.keyword.Bluemix_notm}} 営業担当員 ![外部リンク・アイコン](../icons/launch-glyph.svg "外部リンク・アイコン")](https://www.ibm.com/cloud-computing/bluemix/contact-us){: new_window} にお問い合わせください。{:tip}

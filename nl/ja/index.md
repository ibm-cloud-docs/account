...
従量課金 (PAYG) アカウントにアップグレードすると $200 のプロモーション・クレジットが渡され、そのクレジットの使用を開始するために必要なアクションはありません。 この $200 のクレジットは 30 日間有効であり、請求書に自動的に適用されます。 このクレジットを、サード・パーティーのオファリングで使用することはできません。

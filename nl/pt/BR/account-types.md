...
É possível começar a construir no {{site.data.keyword.Bluemix}} de graça. Quando estiver pronto para crescer, faça upgrade e pague somente pelo que você usar além dos abonos grátis. Temos quatro tipos de contas diferentes que você pode escolher: Lite, Pay-As-You-Go, Assinatura e Promocional. É possível usar qualquer um dos tipos de contas para começar a usar o {{site.data.keyword.Bluemix_notm}} - basta escolher aquele que se ajuste melhor às suas necessidades. 
{:shortdesc}

...
É possível começar a construir no {{site.data.keyword.Bluemix}} de graça. Quando estiver pronto para crescer, faça upgrade e pague somente pelo que você usar além dos abonos grátis. Temos quatro tipos de contas diferentes dentre as quais é possível escolher: Lite, Pagamento por uso, Assinatura e avaliação. É possível usar qualquer um dos tipos de contas para começar a usar o {{site.data.keyword.Bluemix_notm}} - basta escolher aquele que se ajuste melhor às suas necessidades.
{:shortdesc}
...
assinatura. Entre em contato com o representante de conta designado da IBM ou com as [Vendas do {{site.data.keyword.Bluemix_notm}} ![Ícone de link externo](../icons/launch-glyph.svg)](http://ibm.biz/bluemixsupport){: new_window}

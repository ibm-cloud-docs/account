...
Acesse https://console.bluemix.net e clique em **Criar uma conta grátis**. O tipo de conta criado é uma conta Lite, que nunca expira. 
...
Depois de vincular sua conta, você efetua login usando seu IBMid no
[console do {{site.data.keyword.Bluemix}} ![Ícone de link externo](../icons/launch-glyph.svg)](https://console.bluemix.net){: new_window}.

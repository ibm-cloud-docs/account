...
Vous pouvez créer un cas de support si une erreur est générée lorsque vous tentez de créer votre compte. Cliquez sur **Support** dans la barre de menus de la console {{site.data.keyword.Bluemix}}. Cliquez ensuite sur **Créer un cas** dans la section d'aide Vous en voulez plus ? Une fois le cas ouvert, vous recevez une notification par courrier électronique. Suivez les instructions pour toute communication supplémentaire relative au problème.
...
* Pour convertir votre essai de 30 jours en compte Lite, prenez contact avec le [service commercial {{site.data.keyword.Bluemix_notm}} ![Icône de lien externe](../icons/launch-glyph.svg "Icône de lien externe")](https://www.ibm.com/cloud-computing/bluemix/contact-us){: new_window}. Après avoir confirmé l'éligibilité, l'équipe commerciale partage un lien unique que vous pouvez utiliser pour essayer de convertir votre compte. La conversion n'est pas garantie car les comptes Lite ne sont pas totalement compatibles avec les essais de 30 jours.  
* Pour effectuer une mise à niveau d'un compte Lite vers un compte Paiement à la carte, sélectionnez **Gérer > Compte** puis **Paramètres de compte**.
* Pour effectuer une mise à niveau d'un compte Lite vers un compte Abonnement, sélectionnez **Gérer > Compte** puis **Paramètres de compte**.
* Pour convertir votre compte Paiement à la carte en compte Abonnement, prenez contact avec le [service commercial {{site.data.keyword.Bluemix_notm}} ![Icône de lien externe](../icons/launch-glyph.svg "Icône de lien externe")](https://www.ibm.com/cloud-computing/bluemix/contact-us){: new_window}.
...
Non, mais vous pouvez changer les propriétaires des ressources. Pour en savoir plus sur le changement de propriétaire, voir [Transfert de la propriété d'une ressource privée](/docs/account/owners.html#how-to-change-the-owner-of-a-catalog-resource).

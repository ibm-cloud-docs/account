...
Vous pouvez mettre à jour la méthode de paiement associée à votre compte en sélectionnant [Paiements](https://{DomainName}/billing/payments) dans la console. Sous Ajouter méthode de paiement, entrez les informations de facturation correspondant à votre nouvelle carte puis cliquez sur **Ajouter une carte de crédit**.

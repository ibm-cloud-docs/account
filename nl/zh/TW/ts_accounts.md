...
若要存取更多位置，請升級至計費帳戶。移至**管理 > 計費及用量**，然後選取**付款**。
{: tsResolve}
...
這可能是因為您使用「精簡」帳戶，此帳戶僅支援在一個組織中進行開發。
{: tsCauses}

若要建立新的組織，請升級至計費帳戶。移至**管理 > 計費及用量**，然後選取**升級**。
{: tsResolve}
...
您可以選取其中一個計費服務方案（可在計費帳戶中取得）來建立其他服務實例。若要從主控台升級至計費帳戶戶，請移至**管理 > 計費及用量**，然後選取**升級**。
{: tsResolve}
...
如果您使用的是「精簡」帳戶，則可以升級至計費帳戶來取得更多記憶體。移至**管理 > 計費及用量**，然後選取**升級**。
{: tsResolve}

...
{{site.data.keyword.Bluemix_notm}} 有三种不同的帐户类型：轻量、现买现付和预订。您注册后，随即会获得免费的轻量帐户。“现买现付”和“预订”是计费帐户选项，每个选项提供有不同的功能。请比较每个帐户并选择最适合您需要的帐户类型。
{:shortdesc}
...
请查看轻量帐户中提供的关键功能的以下列表：
   ...
   * 超过 10 天没有开发活动，应用程序将进入休眠。您可以开始处理新的应用程序，而不必担心超过内存配额限制。
   * 超过 30 天没有开发活动，将删除轻量套餐的服务实例。这样，就不必在创建新实例之前管理删除不活动的实例。

### 升级轻量帐户
{: #upgrade-lite-account}

您可以升级到现买现付帐户或预订帐户。有关更多信息，请参阅[升级帐户](/docs/account/account_settings.html#upgrading-account)。

升级到现买现付帐户后，您将获得 200 美元的促销信用值，该信用值会自动应用于您的帐户。200 美元信用值的有效期为 30 天，而且会自动应用于您的发票。该信用值不能用于第三方产品。
...
此外，使用现买现付帐户，您可以订购可选项，例如高级或高端支持选项。有关更多信息，请联系 [{{site.data.keyword.Bluemix_notm}} 销售人员 ](https://www.ibm.com/cloud-computing/bluemix/contact-us){: new_window} ![外部链接图标](../icons/launch-glyph.svg)。
...
使用预订帐户，可以创建多个资源组，以便轻松管理配额并查看一组资源的计费使用情况。每月有最低组合消费，达到该最低消费可享受相应的预订折扣。对于超出预订总额的任何使用情况，将按非折扣费率计费。要查看预订，请转至**管理 > 计费和使用情况**，然后选择**预订**。 

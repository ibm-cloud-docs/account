...
使用预订帐户，可以创建多个资源组，以便轻松管理配额并查看一组资源的计费使用情况。每月有最低组合消费，达到该最低消费可享受相应的预订折扣。对于超出预订总额的任何使用情况，将按非折扣费率计费。

如果您有预订帐户，那么可以创建 [IBM Cloud 目录](https://console.bluemix.net/catalog/)中提供的大多数服务，但某些服务可能使用特定的价格套餐，要求您单独购买。

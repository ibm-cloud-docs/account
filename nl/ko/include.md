...
[{{site.data.keyword.Bluemix}} 명령행 인터페이스(CLI)](/docs/cli/reference/ibmcloud/bx_cli.html#ibmcloud_commands_settings)를 사용하여 개인용 리소스의 소유권을 이전할 수 있습니다. 다음 명령을 실행하십시오.

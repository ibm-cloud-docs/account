...
종량과금제 또는 구독 계정의 경우, 가장 빠른 계정 취소 방법은 [실시간 대화](https://{DomainName}/unifiedsupport/supportcenter)를 통해 또는 1-866-325-0045 번호로 전화한 후 내선 3번을 선택하여 당사에 요청하는 것입니다. 또는 지원 케이스를 열 수도 있습니다.
...
계정이 잘못 비활성화되었다고 생각되는 경우에는 1-866-325-0045 번호로 전화하여 내선 3번을 선택하십시오. 

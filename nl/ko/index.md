...
사용자는 세 가지 {{site.data.keyword.Bluemix}} 계정 유형(라이트, 종량과금제, 구독) 중 하나를 선택할 수 있습니다. 어느 계정 유형을 사용해도 {{site.data.keyword.Bluemix_notm}}에서 시작할 수 있습니다. 필요에 따라 유형을 선택하십시오.
{:shortdesc}
...
각각의 리소스 그룹은 무료입니다. Cloud Foundry 앱 및 IAM에서 관리하는 서비스 간에 연결을 작성할 때는 할당량으로 계수되는 별명(서비스 인스턴스임)을 작성하십시오. [별명의 개념](/docs/resources/connecting_apps.html#what_is_alias)을 참조하십시오.
{: tip}

### 사용 가능한 기능

라이트 계정에 사용 가능한 다음 주요 기능 목록을 확인하십시오.
...
확장이 준비되면 라이트 계정을 종량과금제 또는 구독 계정으로 업그레이드할 수 있습니다. 

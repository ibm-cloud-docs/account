...
Vaya a https://console.bluemix.net y pulse **Crear cuenta gratuita** para crear una cuenta Lite que nunca caduca. 

Consulte [Cuenta Lite](/docs/account/index.html#liteaccount) para obtener más detalles sobre las características que incluye.

## ¿Qué es Cloud Foundry?
{: #cloud-foundry}

Cloud Foundry es una plataforma como servicio (PaaS) de código abierto disponible a través de {{site.data.keyword.Bluemix_notm}} Public para crear y desplegar aplicaciones en la nube. Las organizaciones y espacios de Cloud Foundry se utilizan dentro de una cuenta de {{site.data.keyword.Bluemix_notm}} para organizar y trabajar con los recursos y apps disponibles dentro de regiones específicas. 
...
Para conmutar entre cuentas, vaya al icono **{{site.data.keyword.avatar}}** ![Icono de avatar](../icons/i-avatar-icon.svg), pulse el menú **Cuenta** y seleccione otra cuenta. 

## ¿Puedo conmutar entre propietarios de cuentas? 
{: #switch-account-owners}

No puede conmutar el propietario de una cuenta, pero puedo cambiar propietarios de recursos. Para obtener más información sobre conmutar la propiedad, consulte [Cambio de la propiedad de recursos privados](/docs/account/owners.html#how-to-change-the-owner-of-a-catalog-resource).

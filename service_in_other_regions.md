...
{: shortdesc}
  ...
  * Create a user-provided service as a bridge.
	...
	To use a service instance that exists in another region, complete the following steps:
      ...
      1. To switch to the region where the service instance exists, click the **Menu icon  ![Menu icon](../icons/icon_hamburger.svg)** > **My resources**. Then, expand the **LOCATION** menu and select the region.
      ...
      3. Switch to the region where you want to use the service instance. lick the **Menu icon  ![Menu icon](../icons/icon_hamburger.svg)** > **My resources**. Then, expand the **LOCATION** menu and select the region where you want to use the service instance.

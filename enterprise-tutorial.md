...
6. (Optional) Enable **Enterprise-managed IAM** to centrally manage access and security settings in the account group.
6. Click **Create**.
...
For information about applying subscriptions to an enterprise, see [Applying subscription codes](/docs/billing-usage?topic=billing-usage-subscription_code).
...
If you enabled Enterprise-managed IAM for your account groups, learn more about [Creating secure accounts in an enterprise](/docs/secure-enterprise?topic=secure-enterprise-enterprise-iam-settings-tutorial).

...
You need the [administrator role on the catalog management service](/docs/iam?topic=iam-account-services#catalog-management-account-management) to complete this task.
...
To authorize users to work with the preset configurations in your private catalogs, assign them the [viewer role on the catalog management service](/docs/iam?topic=iam-account-services#catalog-management-account-management).

...
| Service Configuration Reader | The ability to read services configuration for Governance management. |
{: row-headers}
{: caption="Table 25. Service roles - Direct Link" caption-side="top"}
...
{: caption="Table 25. Service actions - Direct Link" caption-side="top"}
{: #actions-table25}
{: tab-title="Actions"}
{: tab-group="directlink"}
{: class="simple-tab-table"}
...
| Operator | As an operator, you can perform platform actions required to configure and operate service instances, such as viewing a service's dashboard. |
{: row-headers}
{: caption="Table 76. Platform roles - Raxak Protect" caption-side="top"}
...
{: caption="Table 76. Service actions - Raxak Protect" caption-side="top"}
{: #actions-table76}
{: tab-title="Actions"}
{: tab-group="raxak-protect"}
{: class="simple-tab-table"}
...
| Viewer | As a viewer, you can view service instances, but you can't modify them. |
{: row-headers}
{: caption="Table 77. Platform roles - Role management" caption-side="top"}
...
{: caption="Table 77. Service actions - Role management" caption-side="top"}
{: #actions-table77}
{: tab-title="Actions"}
{: tab-group="iam-access-management"}
{: class="simple-tab-table"}
...
| Viewer | As a viewer, you can view service instances, but you can't modify them. |
{: row-headers}
{: caption="Table 78. Platform roles - Satellite" caption-side="top"}
...
| Writer | As a writer, you have permissions beyond the reader role, including creating and editing service-specific resources. |
{: row-headers}
{: caption="Table 78. Service roles - Satellite" caption-side="top"}
...
{: caption="Table 78. Service actions - Satellite" caption-side="top"}
{: #actions-table78}
{: tab-title="Actions"}
{: tab-group="satellite"}
{: class="simple-tab-table"}
...
| Viewer | As a viewer, you can view service instances, but you can't modify them. |
{: row-headers}
{: caption="Table 79. Platform roles - Schematics" caption-side="top"}
...
| Writer | As a writer, you have permissions beyond the reader role, including creating and editing service-specific resources. |
{: row-headers}
{: caption="Table 79. Service roles - Schematics" caption-side="top"}
...
{: caption="Table 79. Service actions - Schematics" caption-side="top"}
{: #actions-table79}
{: tab-title="Actions"}
{: tab-group="schematics"}
{: class="simple-tab-table"}
...
| Operator | As an operator, you can perform platform actions required to configure and operate service instances, such as viewing a service's dashboard. |
{: row-headers}
{: caption="Table 80. Platform roles - Secrets Manager" caption-side="top"}
...
{: row-headers}
{: caption="Table 80. Service roles - Secrets Manager" caption-side="top"}
...
{: caption="Table 80. Service actions - Secrets Manager" caption-side="top"}
{: #actions-table80}
{: tab-title="Actions"}
{: tab-group="secrets-manager"}
{: class="simple-tab-table"}
...
| Operator | As an operator, you can perform platform actions required to configure and operate service instances, such as viewing a service's dashboard. |
{: row-headers}
{: caption="Table 81. Platform roles - Security Advisor" caption-side="top"}
...
| Writer | As a writer, you have permissions beyond the reader role, including creating and editing service-specific resources. |
{: row-headers}
{: caption="Table 81. Service roles - Security Advisor" caption-side="top"}
...
{: caption="Table 81. Service actions - Security Advisor" caption-side="top"}
{: #actions-table81}
{: tab-title="Actions"}
{: tab-group="security-advisor"}
{: class="simple-tab-table"}
...
| Viewer | As a viewer, you can view service instances, but you can't modify them. |
{: row-headers}
{: caption="Table 82. Platform roles - Security and Compliance Center" caption-side="top"}
...
{: row-headers}
{: caption="Table 82. Service roles - Security and Compliance Center" caption-side="top"}
...
{: caption="Table 82. Service actions - Security and Compliance Center" caption-side="top"}
{: #actions-table82}
{: tab-title="Actions"}
{: tab-group="compliance"}
{: class="simple-tab-table"}
...
| Viewer | As a viewer, you can view service instances, but you can't modify them. |
{: row-headers}
{: caption="Table 83. Platform roles - Security Group for VPC" caption-side="top"}
...
{: caption="Table 83. Service actions - Security Group for VPC" caption-side="top"}
{: #actions-table83}
{: tab-title="Actions"}
{: tab-group="is.security-group"}
{: class="simple-tab-table"}
...
| Operator | As an operator, you can perform platform actions required to configure and operate service instances, such as viewing a service's dashboard. |
{: row-headers}
{: caption="Table 84. Platform roles - Skytap On IBM Cloud" caption-side="top"}
...
{: caption="Table 84. Service actions - Skytap On IBM Cloud" caption-side="top"}
{: #actions-table84}
{: tab-title="Actions"}
{: tab-group="skytap"}
{: class="simple-tab-table"}
...
| Operator | As an operator, you can perform platform actions required to configure and operate service instances, such as viewing a service's dashboard. |
{: row-headers}
{: caption="Table 85. Platform roles - Speech to Text" caption-side="top"}
...
| Writer | As a writer, you have permissions beyond the reader role, including creating and editing service-specific resources. |
{: row-headers}
{: caption="Table 85. Service roles - Speech to Text" caption-side="top"}
...
{: caption="Table 85. Service actions - Speech to Text" caption-side="top"}
{: #actions-table85}
{: tab-title="Actions"}
{: tab-group="speech-to-text"}
{: class="simple-tab-table"}
...
| Writer | As a writer, you have permissions beyond the reader role, including creating and editing service-specific resources. |
{: row-headers}
{: caption="Table 86. Service roles - SQL Query" caption-side="top"}
...
{: caption="Table 86. Service actions - SQL Query" caption-side="top"}
{: #actions-table86}
{: tab-title="Actions"}
{: tab-group="sql-query"}
{: class="simple-tab-table"}
...
| Viewer | As a viewer, you can view service instances, but you can't modify them. |
{: row-headers}
{: caption="Table 87. Platform roles - SSH Key for VPC" caption-side="top"}
...
{: caption="Table 87. Service actions - SSH Key for VPC" caption-side="top"}
{: #actions-table87}
{: tab-title="Actions"}
{: tab-group="is.key"}
{: class="simple-tab-table"}
...
| Writer | Writer |
{: row-headers}
{: caption="Table 88. Service roles - Streaming Analytics" caption-side="top"}
...
{: caption="Table 88. Service actions - Streaming Analytics" caption-side="top"}
{: #actions-table88}
{: tab-title="Actions"}
{: tab-group="streaming-analytics"}
{: class="simple-tab-table"}
...
| Viewer | As a viewer, you can view service instances, but you can't modify them. |
{: row-headers}
{: caption="Table 89. Platform roles - Subnet" caption-side="top"}
...
{: caption="Table 89. Service actions - Subnet" caption-side="top"}
{: #actions-table89}
{: tab-title="Actions"}
{: tab-group="is.subnet"}
{: class="simple-tab-table"}
...
{: row-headers}
{: caption="Table 90. Platform roles - Support Center" caption-side="top"}
...
{: caption="Table 90. Service actions - Support Center" caption-side="top"}
{: #actions-table90}
{: tab-title="Actions"}
{: tab-group="support"}
{: class="simple-tab-table"}
...
| Operator | Operator |
{: row-headers}
{: caption="Table 91. Platform roles - Text to Speech" caption-side="top"}
...
| Writer | Writer |
{: row-headers}
{: caption="Table 91. Service roles - Text to Speech" caption-side="top"}
...
{: caption="Table 91. Service actions - Text to Speech" caption-side="top"}
{: #actions-table91}
{: tab-title="Actions"}
{: tab-group="text-to-speech"}
{: class="simple-tab-table"}
...
| Operator | Operator |
{: row-headers}
{: caption="Table 92. Platform roles - Tone Analyzer" caption-side="top"}
...
| Writer | Writer |
{: row-headers}
{: caption="Table 92. Service roles - Tone Analyzer" caption-side="top"}
...
{: caption="Table 92. Service actions - Tone Analyzer" caption-side="top"}
{: #actions-table92}
{: tab-title="Actions"}
{: tab-group="tone-analyzer"}
{: class="simple-tab-table"}
...
| Viewer | As a viewer, you can view service instances, but you can't modify them. |
{: row-headers}
{: caption="Table 93. Platform roles - Toolchain" caption-side="top"}
...
{: caption="Table 93. Service actions - Toolchain" caption-side="top"}
{: #actions-table93}
{: tab-title="Actions"}
{: tab-group="toolchain"}
{: class="simple-tab-table"}
...
| Service Configuration Reader | The ability to read services configuration for Governance management. |
{: row-headers}
{: caption="Table 95. Service roles - Transit Gateway" caption-side="top"}
...
| Viewer | As a viewer, you can view service instances, but you can't modify them. |
{: row-headers}
{: caption="Table 104. Platform roles - VPC+ Cloud Migration" caption-side="top"}
...
| Service Configuration Reader | The ability to read services configuration for Governance management. |
{: row-headers}
{: caption="Table 104. Service roles - VPC+ Cloud Migration" caption-side="top"}
...
{: caption="Table 104. Service actions - VPC+ Cloud Migration" caption-side="top"}
{: #actions-table104}
{: tab-title="Actions"}
{: tab-group="migrationtool-from-wanclds"}
{: class="simple-tab-table"}
...
| Viewer | As a viewer, you can view service instances, but you can't modify them. |
{: row-headers}
{: caption="Table 106. Platform roles - Watson Assistant" caption-side="top"}
...
| Writer | As a writer, you have permissions beyond the reader role, including creating and editing service-specific resources. |
{: row-headers}
{: caption="Table 106. Service roles - Watson Assistant" caption-side="top"}
...
{: caption="Table 106. Service actions - Watson Assistant" caption-side="top"}
{: #actions-table106}
{: tab-title="Actions"}
{: tab-group="conversation"}
{: class="simple-tab-table"}
...
| Writer | As a writer, you have permissions beyond the reader role, including creating and editing service-specific resources. |
{: row-headers}
{: caption="Table 107. Service roles - Watson Discovery" caption-side="top"}
...
{: caption="Table 107. Service actions - Watson Discovery" caption-side="top"}
{: #actions-table107}
{: tab-title="Actions"}
{: tab-group="discovery"}
{: class="simple-tab-table"}
...
| Administrator | Administrator |
{: row-headers}
{: caption="Table 108. Platform roles - Watson Knowledge Catalog" caption-side="top"}
...
| Writer | Writer |
{: row-headers}
{: caption="Table 108. Service roles - Watson Knowledge Catalog" caption-side="top"}
...
{: caption="Table 108. Service actions - Watson Knowledge Catalog" caption-side="top"}
{: #actions-table108}
{: tab-title="Actions"}
{: tab-group="datacatalog"}
{: class="simple-tab-table"}
...
| Viewer | As a viewer, you can view service instances, but you can't modify them. |
{: row-headers}
{: caption="Table 109. Platform roles - Watson OpenScale" caption-side="top"}
...
{: caption="Table 109. Service actions - Watson OpenScale" caption-side="top"}
{: #actions-table109}
{: tab-title="Actions"}
{: tab-group="aiopenscale"}
{: class="simple-tab-table"}
...
| Operator | As an operator, you can perform platform actions required to configure and operate service instances, such as viewing a service's dashboard. |
{: row-headers}
{: caption="Table 111. Platform roles - WebSphere Application Server" caption-side="top"}
...
{: caption="Table 111. Service actions - WebSphere Application Server" caption-side="top"}
{: #actions-table111}
{: tab-title="Actions"}
{: tab-group="websphereappsvr"}
{: class="simple-tab-table"}

...
| Operator | Operator |
{: row-headers}
{: caption="Table 15. Platform roles - CloudAMQP" caption-side="top"}
...
{: caption="Table 15. Service actions - CloudAMQP" caption-side="top"}
{: #actions-table15}
{: tab-title="Actions"}
{: tab-group="cldamqp"}
{: class="simple-tab-table"}
...
| Viewer | As a viewer, you can view service instances, but you can't modify them. |
{: row-headers}
{: caption="Table 22. Platform roles - Db2" caption-side="top"}
...
| Manager | As a manager, you have permissions beyond the writer role to complete privileged actions as defined by the service. In addition, you can create and edit service-specific resources. |
{: row-headers}
{: caption="Table 22. Service roles - Db2" caption-side="top"}
...
{: caption="Table 22. Service actions - Db2" caption-side="top"}
{: #actions-table22}
{: tab-title="Actions"}
{: tab-group="dashdb-for-transactions"}
{: class="simple-tab-table"}
...
| Writer | As a writer, you have permissions beyond the reader role, including creating and editing service-specific resources. |
{: row-headers}
{: caption="Table 27. Service roles - Discovery" caption-side="top"}
...
{: caption="Table 27. Service actions - Discovery" caption-side="top"}
{: #actions-table27}
{: tab-title="Actions"}
{: tab-group="discovery"}
{: class="simple-tab-table"}
...
| Operator | Operator |
{: row-headers}
{: caption="Table 29. Platform roles - ElephantSQL" caption-side="top"}
...
{: caption="Table 29. Service actions - ElephantSQL" caption-side="top"}
{: #actions-table29}
{: tab-title="Actions"}
{: tab-group="esql"}
{: class="simple-tab-table"}
...
| Administrator | As an administrator, you can perform all platform actions based on the resource this role is being assigned, including assigning access policies to other users. |
{: row-headers}
{: caption="Table 44. Platform roles - IBM Cloud Activity Tracker with LogDNA" caption-side="top"}
...
{: row-headers}
{: caption="Table 44. Service roles - IBM Cloud Activity Tracker with LogDNA" caption-side="top"}
...
{: caption="Table 44. Service actions - IBM Cloud Activity Tracker with LogDNA" caption-side="top"}
{: #actions-table44}
{: tab-title="Actions"}
{: tab-group="logdnaat"}
{: class="simple-tab-table"}
...
| Administrator | As an administrator, you can perform all platform actions based on the resource this role is being assigned, including assigning access policies to other users. |
{: row-headers}
{: caption="Table 46. Platform roles - IBM Cloud Monitoring with Sysdig" caption-side="top"}
...
| Writer | As a writer, you have permissions beyond the reader role, including creating and editing service-specific resources. |
{: row-headers}
{: caption="Table 46. Service roles - IBM Cloud Monitoring with Sysdig" caption-side="top"}
...
{: caption="Table 46. Service actions - IBM Cloud Monitoring with Sysdig" caption-side="top"}
{: #actions-table46}
{: tab-title="Actions"}
{: tab-group="sysdig-monitor"}
{: class="simple-tab-table"}
...
| Viewer | As a viewer, you can view service instances, but you can't modify them. |
{: row-headers}
{: caption="Table 47. Platform roles - IBM Cloud Satellite" caption-side="top"}
...
| Writer | As a writer, you have permissions beyond the reader role, including creating and editing service-specific resources. |
{: row-headers}
{: caption="Table 47. Service roles - IBM Cloud Satellite" caption-side="top"}
...
{: caption="Table 47. Service actions - IBM Cloud Satellite" caption-side="top"}
{: #actions-table47}
{: tab-title="Actions"}
{: tab-group="satellite"}
{: class="simple-tab-table"}
...
| Administrator | As an administrator, you can perform all platform actions based on the resource this role is being assigned, including assigning access policies to other users. |
{: row-headers}
{: caption="Table 50. Platform roles - IBM Log Analysis with LogDNA" caption-side="top"}
...
| Standard Member | As a member, you can configure views, dashboards and alerts, export data, search, filter, and view all data. |
{: row-headers}
{: caption="Table 50. Service roles - IBM Log Analysis with LogDNA" caption-side="top"}
...
{: caption="Table 50. Service actions - IBM Log Analysis with LogDNA" caption-side="top"}
{: #actions-table50}
{: tab-title="Actions"}
{: tab-group="logdna"}
{: class="simple-tab-table"}
...
| Viewer | As a viewer, you can view service instances, but you can't modify them. |
{: row-headers}
{: caption="Table 62. Platform roles - Master Data Management" caption-side="top"}
...
| Writer | As a writer, you have permissions beyond the reader role, including creating and editing service-specific resources. |
{: row-headers}
{: caption="Table 62. Service roles - Master Data Management" caption-side="top"}
...
{: caption="Table 62. Service actions - Master Data Management" caption-side="top"}
{: #actions-table62}
{: tab-title="Actions"}
{: tab-group="mdm-oc"}
{: class="simple-tab-table"}
...
| Viewer | Viewer |
{: row-headers}
{: caption="Table 64. Platform roles - Monitoring" caption-side="top"}
...
{: caption="Table 64. Service actions - Monitoring" caption-side="top"}
{: #actions-table64}
{: tab-title="Actions"}
{: tab-group="monitoring"}
{: class="simple-tab-table"}
...
| Viewer | As a viewer, you can view service instances, but you can't modify them. |
{: row-headers}
{: caption="Table 65. Platform roles - MQ" caption-side="top"}
...
| Writer | As a writer, you have permissions beyond the reader role, including creating and editing service-specific resources. |
{: row-headers}
{: caption="Table 65. Service roles - MQ" caption-side="top"}
...
{: caption="Table 65. Service actions - MQ" caption-side="top"}
{: #actions-table65}
{: tab-title="Actions"}
{: tab-group="mqcloud"}
{: class="simple-tab-table"}
...
| Viewer | Viewer |
{: row-headers}
{: caption="Table 66. Platform roles - Natural Language Classifier" caption-side="top"}
...
| Writer | Writer |
{: row-headers}
{: caption="Table 66. Service roles - Natural Language Classifier" caption-side="top"}
...
{: caption="Table 66. Service actions - Natural Language Classifier" caption-side="top"}
{: #actions-table66}
{: tab-title="Actions"}
{: tab-group="natural-language-classifier"}
{: class="simple-tab-table"}
...
| Operator | Operator |
{: row-headers}
{: caption="Table 67. Platform roles - Natural Language Understanding" caption-side="top"}
...
| Writer | Writer |
{: row-headers}
{: caption="Table 67. Service roles - Natural Language Understanding" caption-side="top"}
...
{: caption="Table 67. Service actions - Natural Language Understanding" caption-side="top"}
{: #actions-table67}
{: tab-title="Actions"}
{: tab-group="natural-language-understanding"}
{: class="simple-tab-table"}
...
| Viewer | As a viewer, you can view service instances, but you can't modify them. |
{: row-headers}
{: caption="Table 68. Platform roles - Network ACL" caption-side="top"}
...
{: caption="Table 68. Service actions - Network ACL" caption-side="top"}
{: #actions-table68}
{: tab-title="Actions"}
{: tab-group="is.network-acl"}
{: class="simple-tab-table"}
...
| Viewer | As a viewer, you can view service instances, but you can't modify them. |
{: row-headers}
{: caption="Table 77. Platform roles - Schematics" caption-side="top"}
...
| Writer | As a writer, you have permissions beyond the reader role, including creating and editing service-specific resources. |
{: row-headers}
{: caption="Table 77. Service roles - Schematics" caption-side="top"}
...
{: caption="Table 77. Service actions - Schematics" caption-side="top"}
{: #actions-table77}
{: tab-title="Actions"}
{: tab-group="schematics"}
{: class="simple-tab-table"}
...
| Operator | As an operator, you can perform platform actions required to configure and operate service instances, such as viewing a service's dashboard. |
{: row-headers}
{: caption="Table 78. Platform roles - Secrets Manager" caption-side="top"}
...
| Writer | As a writer, you have permissions beyond the reader role, including creating and editing service-specific resources. |
{: row-headers}
{: caption="Table 78. Service roles - Secrets Manager" caption-side="top"}
...
{: caption="Table 78. Service actions - Secrets Manager" caption-side="top"}
{: #actions-table78}
{: tab-title="Actions"}
{: tab-group="secrets-manager"}
{: class="simple-tab-table"}
...
| Operator | As an operator, you can perform platform actions required to configure and operate service instances, such as viewing a service's dashboard. |
{: row-headers}
{: caption="Table 79. Platform roles - Security Advisor" caption-side="top"}
...
| Writer | As a writer, you have permissions beyond the reader role, including creating and editing service-specific resources. |
{: row-headers}
{: caption="Table 79. Service roles - Security Advisor" caption-side="top"}
...
| Viewer | As a viewer, you can view service instances, but you can't modify them. |
{: row-headers}
{: caption="Table 80. Platform roles - Security and Compliance Center" caption-side="top"}
...
{: row-headers}
{: caption="Table 80. Service roles - Security and Compliance Center" caption-side="top"}
...
{: caption="Table 80. Service actions - Security and Compliance Center" caption-side="top"}
{: #actions-table80}
{: tab-title="Actions"}
{: tab-group="compliance"}
{: class="simple-tab-table"}
...
| Viewer | As a viewer, you can view service instances, but you can't modify them. |
{: row-headers}
{: caption="Table 81. Platform roles - Security Group for VPC" caption-side="top"}
...
{: caption="Table 81. Service actions - Security Group for VPC" caption-side="top"}
{: #actions-table81}
{: tab-title="Actions"}
{: tab-group="is.security-group"}
{: class="simple-tab-table"}
...
| Operator | As an operator, you can perform platform actions required to configure and operate service instances, such as viewing a service's dashboard. |
{: row-headers}
{: caption="Table 82. Platform roles - Skytap On IBM Cloud" caption-side="top"}
...
{: caption="Table 82. Service actions - Skytap On IBM Cloud" caption-side="top"}
{: #actions-table82}
{: tab-title="Actions"}
{: tab-group="skytap"}
{: class="simple-tab-table"}
...
| Operator | As an operator, you can perform platform actions required to configure and operate service instances, such as viewing a service's dashboard. |
{: row-headers}
{: caption="Table 83. Platform roles - Speech to Text" caption-side="top"}
...
| Writer | As a writer, you have permissions beyond the reader role, including creating and editing service-specific resources. |
{: row-headers}
{: caption="Table 83. Service roles - Speech to Text" caption-side="top"}
...
{: caption="Table 83. Service actions - Speech to Text" caption-side="top"}
{: #actions-table83}
{: tab-title="Actions"}
{: tab-group="speech-to-text"}
{: class="simple-tab-table"}
...
| Writer | As a writer, you have permissions beyond the reader role, including creating and editing service-specific resources. |
{: row-headers}
{: caption="Table 84. Service roles - SQL Query" caption-side="top"}
...
{: caption="Table 84. Service actions - SQL Query" caption-side="top"}
{: #actions-table84}
{: tab-title="Actions"}
{: tab-group="sql-query"}
{: class="simple-tab-table"}
...
| Viewer | As a viewer, you can view service instances, but you can't modify them. |
{: row-headers}
{: caption="Table 85. Platform roles - SSH Key for VPC" caption-side="top"}
...
{: caption="Table 85. Service actions - SSH Key for VPC" caption-side="top"}
{: #actions-table85}
{: tab-title="Actions"}
{: tab-group="is.key"}
{: class="simple-tab-table"}
...
| Writer | Writer |
{: row-headers}
{: caption="Table 86. Service roles - Streaming Analytics" caption-side="top"}
...
{: caption="Table 86. Service actions - Streaming Analytics" caption-side="top"}
{: #actions-table86}
{: tab-title="Actions"}
{: tab-group="streaming-analytics"}
{: class="simple-tab-table"}
...
| Viewer | As a viewer, you can view service instances, but you can't modify them. |
{: row-headers}
{: caption="Table 87. Platform roles - Subnet" caption-side="top"}
...
{: caption="Table 87. Service actions - Subnet" caption-side="top"}
{: #actions-table87}
{: tab-title="Actions"}
{: tab-group="is.subnet"}
{: class="simple-tab-table"}
...
{: row-headers}
{: caption="Table 88. Platform roles - Support Center" caption-side="top"}
...
{: caption="Table 88. Service actions - Support Center" caption-side="top"}
{: #actions-table88}
{: tab-title="Actions"}
{: tab-group="support"}
{: class="simple-tab-table"}
...
| Operator | Operator |
{: row-headers}
{: caption="Table 89. Platform roles - Text to Speech" caption-side="top"}
...
| Writer | Writer |
{: row-headers}
{: caption="Table 89. Service roles - Text to Speech" caption-side="top"}
...
{: caption="Table 89. Service actions - Text to Speech" caption-side="top"}
{: #actions-table89}
{: tab-title="Actions"}
{: tab-group="text-to-speech"}
{: class="simple-tab-table"}
...
| Operator | Operator |
{: row-headers}
{: caption="Table 90. Platform roles - Tone Analyzer" caption-side="top"}
...
| Writer | Writer |
{: row-headers}
{: caption="Table 90. Service roles - Tone Analyzer" caption-side="top"}
...
{: caption="Table 90. Service actions - Tone Analyzer" caption-side="top"}
{: #actions-table90}
{: tab-title="Actions"}
{: tab-group="tone-analyzer"}
{: class="simple-tab-table"}
...
| Viewer | As a viewer, you can view service instances, but you can't modify them. |
{: row-headers}
{: caption="Table 91. Platform roles - Toolchain" caption-side="top"}
...
{: caption="Table 91. Service actions - Toolchain" caption-side="top"}
{: #actions-table91}
{: tab-title="Actions"}
{: tab-group="toolchain"}
{: class="simple-tab-table"}
...
{: row-headers}
{: caption="Table 94. Platform roles - User Management" caption-side="top"}
...
{: caption="Table 94. Service actions - User Management" caption-side="top"}
{: #actions-table94}
{: tab-title="Actions"}
{: tab-group="user-management"}
{: class="simple-tab-table"}
...
| Viewer | As a viewer, you can view service instances, but you can't modify them. |
{: row-headers}
{: caption="Table 95. Platform roles - Virtual Private Cloud" caption-side="top"}
...
{: caption="Table 95. Service actions - Virtual Private Cloud" caption-side="top"}
{: #actions-table95}
{: tab-title="Actions"}
{: tab-group="is.vpc"}
{: class="simple-tab-table"}
...
{: row-headers}
{: caption="Table 96. Platform roles - Virtual Private Endpoint for VPC" caption-side="top"}
...
{: caption="Table 96. Service actions - Virtual Private Endpoint for VPC" caption-side="top"}
{: #actions-table96}
{: tab-title="Actions"}
{: tab-group="is.endpoint-gateway"}
{: class="simple-tab-table"}
...
| Viewer | As a viewer, you can view service instances, but you can't modify them. |
{: row-headers}
{: caption="Table 97. Platform roles - Virtual Server for VPC" caption-side="top"}
...
{: row-headers}
{: caption="Table 97. Service roles - Virtual Server for VPC" caption-side="top"}
...
{: caption="Table 97. Service actions - Virtual Server for VPC" caption-side="top"}
{: #actions-table97}
{: tab-title="Actions"}
{: tab-group="is.instance"}
{: class="simple-tab-table"}
...
| Writer | Writer |
{: row-headers}
{: caption="Table 98. Service roles - Visual Recognition" caption-side="top"}
...
{: caption="Table 98. Service actions - Visual Recognition" caption-side="top"}
{: #actions-table98}
{: tab-title="Actions"}
{: tab-group="watson-vision-combined"}
{: class="simple-tab-table"}
...
| Viewer | As a viewer, you can view service instances, but you can't modify them. |
{: row-headers}
{: caption="Table 99. Platform roles - VMware Solutions" caption-side="top"}
...
{: caption="Table 99. Service actions - VMware Solutions" caption-side="top"}
{: #actions-table99}
{: tab-title="Actions"}
{: tab-group="vmware-solutions"}
{: class="simple-tab-table"}
...
| Operator | As an operator, you can perform platform actions required to configure and operate service instances, such as viewing a service's dashboard. |
{: row-headers}
{: caption="Table 100. Platform roles - Voice Agent with Watson" caption-side="top"}
...
| Writer | As a writer, you have permissions beyond the reader role, including creating and editing service-specific resources. |
{: row-headers}
{: caption="Table 100. Service roles - Voice Agent with Watson" caption-side="top"}
...
{: caption="Table 100. Service actions - Voice Agent with Watson" caption-side="top"}
{: #actions-table100}
{: tab-title="Actions"}
{: tab-group="voiceagent"}
{: class="simple-tab-table"}
...
| Viewer | As a viewer, you can view service instances, but you can't modify them. |
{: row-headers}
{: caption="Table 102. Platform roles - VPC+ Cloud Migration" caption-side="top"}
...
| Service Configuration Reader | The ability to read services configuration for Governance management. |
{: row-headers}
{: caption="Table 102. Service roles - VPC+ Cloud Migration" caption-side="top"}
...
{: caption="Table 102. Service actions - VPC+ Cloud Migration" caption-side="top"}
{: #actions-table102}
{: tab-title="Actions"}
{: tab-group="migrationtool-from-wanclds"}
{: class="simple-tab-table"}
...
| Viewer | As a viewer, you can view service instances, but you can't modify them. |
{: row-headers}
{: caption="Table 104. Platform roles - Watson Assistant" caption-side="top"}
...
| Writer | As a writer, you have permissions beyond the reader role, including creating and editing service-specific resources. |
{: row-headers}
{: caption="Table 104. Service roles - Watson Assistant" caption-side="top"}
...
{: caption="Table 104. Service actions - Watson Assistant" caption-side="top"}
{: #actions-table104}
{: tab-title="Actions"}
{: tab-group="conversation"}
{: class="simple-tab-table"}
...
| Administrator | Administrator |
{: row-headers}
{: caption="Table 105. Platform roles - Watson Knowledge Catalog" caption-side="top"}
...
| Writer | Writer |
{: row-headers}
{: caption="Table 105. Service roles - Watson Knowledge Catalog" caption-side="top"}
...
{: caption="Table 105. Service actions - Watson Knowledge Catalog" caption-side="top"}
{: #actions-table105}
{: tab-title="Actions"}
{: tab-group="datacatalog"}
{: class="simple-tab-table"}
...
| Viewer | As a viewer, you can view service instances, but you can't modify them. |
{: row-headers}
{: caption="Table 106. Platform roles - Watson OpenScale" caption-side="top"}
...
{: caption="Table 106. Service actions - Watson OpenScale" caption-side="top"}
{: #actions-table106}
{: tab-title="Actions"}
{: tab-group="aiopenscale"}
{: class="simple-tab-table"}
...
| Operator | As an operator, you can perform platform actions required to configure and operate service instances, such as viewing a service's dashboard. |
{: row-headers}
{: caption="Table 108. Platform roles - WebSphere Application Server" caption-side="top"}
...
{: caption="Table 108. Service actions - WebSphere Application Server" caption-side="top"}
{: #actions-table108}
{: tab-title="Actions"}
{: tab-group="websphereappsvr"}
{: class="simple-tab-table"}

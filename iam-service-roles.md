...
| Viewer | As a viewer, you can view service instances, but you can't modify them. |
{: row-headers}
{: caption="Table 20. Platform roles - DataStage" caption-side="top"}
...
| Service Configuration Reader | The ability to read services configuration for Governance management. |
{: row-headers}
{: caption="Table 20. Service roles - DataStage" caption-side="top"}
...
{: caption="Table 20. Service actions - DataStage" caption-side="top"}
{: #actions-table20}
{: tab-title="Actions"}
{: tab-group="datastage"}
{: class="simple-tab-table"}
...
| Viewer | As a viewer, you can view service instances, but you can't modify them. |
{: row-headers}
{: caption="Table 23. Platform roles - Dedicated Host for VPC" caption-side="top"}
...
{: caption="Table 23. Service actions - Dedicated Host for VPC" caption-side="top"}
{: #actions-table23}
{: tab-title="Actions"}
{: tab-group="is.dedicated-host"}
{: class="simple-tab-table"}
...
| Service Configuration Reader | The ability to read services configuration for Governance management. |
{: row-headers}
{: caption="Table 24. Service roles - Direct Link" caption-side="top"}
...
{: caption="Table 24. Service actions - Direct Link" caption-side="top"}
{: #actions-table24}
{: tab-title="Actions"}
{: tab-group="directlink"}
{: class="simple-tab-table"}
...
| Viewer | As a viewer, you can view service instances, but you can't modify them. |
{: row-headers}
{: caption="Table 25. Platform roles - Direct Link Connect" caption-side="top"}
...
{: caption="Table 25. Service actions - Direct Link Connect" caption-side="top"}
{: #actions-table25}
{: tab-title="Actions"}
{: tab-group="directlink.connect"}
{: class="simple-tab-table"}
...
| Viewer | As a viewer, you can view service instances, but you can't modify them. |
{: row-headers}
{: caption="Table 26. Platform roles - Direct Link Dedicated (2.0)" caption-side="top"}
...
{: caption="Table 26. Service actions - Direct Link Dedicated (2.0)" caption-side="top"}
{: #actions-table26}
{: tab-title="Actions"}
{: tab-group="directlink.dedicated"}
{: class="simple-tab-table"}
...
| Viewer | As a viewer, you can view service instances, but you can't modify them. |
{: row-headers}
{: caption="Table 27. Platform roles - Dizzion DaaS" caption-side="top"}
...
| Service Configuration Reader | The ability to read services configuration for Governance management. |
{: row-headers}
{: caption="Table 27. Service roles - Dizzion DaaS" caption-side="top"}
...
{: caption="Table 27. Service actions - Dizzion DaaS" caption-side="top"}
{: #actions-table27}
{: tab-title="Actions"}
{: tab-group="dizziondaas"}
{: class="simple-tab-table"}
...
| Operator | As an operator, you can perform platform actions required to configure and operate service instances, such as viewing a service's dashboard. |
{: row-headers}
{: caption="Table 28. Platform roles - DNS Services" caption-side="top"}
...
| Writer | As a writer, you have permissions beyond the reader role, including creating and editing service-specific resources. |
{: row-headers}
{: caption="Table 28. Service roles - DNS Services" caption-side="top"}
...
{: caption="Table 28. Service actions - DNS Services" caption-side="top"}
{: #actions-table28}
{: tab-title="Actions"}
{: tab-group="dns-svcs"}
{: class="simple-tab-table"}
...
| Administrator | As an administrator, you can perform all platform actions based on the resource this role is being assigned, including assigning access policies to other users. |
{: row-headers}
{: caption="Table 43. Platform roles - IBM Cloud Activity Tracker" caption-side="top"}
...
{: row-headers}
{: caption="Table 43. Service roles - IBM Cloud Activity Tracker" caption-side="top"}
...
{: caption="Table 43. Service actions - IBM Cloud Activity Tracker" caption-side="top"}
{: #actions-table43}
{: tab-title="Actions"}
{: tab-group="logdnaat"}
{: class="simple-tab-table"}
...
| Administrator | As an administrator, you can perform all platform actions based on the resource this role is being assigned, including assigning access policies to other users. |
{: row-headers}
{: caption="Table 45. Platform roles - IBM Cloud Monitoring" caption-side="top"}
...
| Writer | As a writer, you have permissions beyond the reader role, including creating and editing service-specific resources. |
{: row-headers}
{: caption="Table 45. Service roles - IBM Cloud Monitoring" caption-side="top"}
...
{: caption="Table 45. Service actions - IBM Cloud Monitoring" caption-side="top"}
{: #actions-table45}
{: tab-title="Actions"}
{: tab-group="sysdig-monitor"}
{: class="simple-tab-table"}
...
| Administrator | As an administrator, you can perform all platform actions based on the resource this role is being assigned, including assigning access policies to other users. |
{: row-headers}
{: caption="Table 46. Platform roles - IBM Cloud Shell" caption-side="top"}
...
| Writer | Writer |
{: row-headers}
{: caption="Table 47. Service roles - IBM Cognos Dashboard Embedded" caption-side="top"}
...
{: caption="Table 47. Service actions - IBM Cognos Dashboard Embedded" caption-side="top"}
{: #actions-table47}
{: tab-title="Actions"}
{: tab-group="dynamic-dashboard-embedded"}
{: class="simple-tab-table"}
...
| Administrator | As an administrator, you can perform all platform actions based on the resource this role is being assigned, including assigning access policies to other users. |
{: row-headers}
{: caption="Table 48. Platform roles - IBM Log Analysis" caption-side="top"}
...
| Standard Member | As a member, you can configure views, dashboards and alerts, export data, search, filter, and view all data. |
{: row-headers}
{: caption="Table 48. Service roles - IBM Log Analysis" caption-side="top"}
...
{: caption="Table 48. Service actions - IBM Log Analysis" caption-side="top"}
{: #actions-table48}
{: tab-title="Actions"}
{: tab-group="logdna"}
{: class="simple-tab-table"}
...
| Viewer | As a viewer, you can view service instances, but you can't modify them. |
{: row-headers}
{: caption="Table 49. Platform roles - IBM Match 360 with Watson" caption-side="top"}
...
| Writer | As a writer, you have permissions beyond the reader role, including creating and editing service-specific resources. |
{: row-headers}
{: caption="Table 49. Service roles - IBM Match 360 with Watson" caption-side="top"}
...
{: caption="Table 49. Service actions - IBM Match 360 with Watson" caption-side="top"}
{: #actions-table49}
{: tab-title="Actions"}
{: tab-group="mdm-oc"}
{: class="simple-tab-table"}
...
| Viewer | As a viewer, you can view service instances, but you can't modify them. |
{: row-headers}
{: caption="Table 50. Platform roles - Identity and Access Management" caption-side="top"}
...
| Service Configuration Reader | The ability to read services configuration for Governance management. |
{: row-headers}
{: caption="Table 50. Service roles - Identity and Access Management" caption-side="top"}
...
{: caption="Table 50. Service actions - Identity and Access Management" caption-side="top"}
{: #actions-table50}
{: tab-title="Actions"}
{: tab-group="iam-svcs"}
{: class="simple-tab-table"}
...
| Viewer | As a viewer, you can view service instances, but you can't modify them. |
{: row-headers}
{: caption="Table 51. Platform roles - Image Service for VPC" caption-side="top"}
...
{: caption="Table 51. Service actions - Image Service for VPC" caption-side="top"}
{: #actions-table51}
{: tab-title="Actions"}
{: tab-group="is.image"}
{: class="simple-tab-table"}
...
| Operator | As an operator, you can perform platform actions required to configure and operate service instances, such as viewing a service's dashboard. |
{: row-headers}
{: caption="Table 52. Platform roles - Internet of Things Platform" caption-side="top"}
...
{: caption="Table 52. Service actions - Internet of Things Platform" caption-side="top"}
{: #actions-table52}
{: tab-title="Actions"}
{: tab-group="iotf-service"}
{: class="simple-tab-table"}
...
| Writer | As a writer, you have permissions beyond the reader role, including creating and editing service-specific resources. |
{: row-headers}
{: caption="Table 53. Service roles - Internet Services" caption-side="top"}
...
{: caption="Table 53. Service actions - Internet Services" caption-side="top"}
{: #actions-table53}
{: tab-title="Actions"}
{: tab-group="internet-svcs"}
{: class="simple-tab-table"}
...
| Viewer | As a viewer, you can view service instances, but you can't modify them. |
{: row-headers}
{: caption="Table 55. Platform roles - Knowledge Studio" caption-side="top"}
...
| Writer | As a writer, you have permissions beyond the reader role, including creating and editing service-specific resources. |
{: row-headers}
{: caption="Table 55. Service roles - Knowledge Studio" caption-side="top"}
...
{: caption="Table 55. Service actions - Knowledge Studio" caption-side="top"}
{: #actions-table55}
{: tab-title="Actions"}
{: tab-group="knowledge-studio"}
{: class="simple-tab-table"}
...
| Viewer | As a viewer, you can view service instances, but you can't modify them. |
{: row-headers}
{: caption="Table 56. Platform roles - Kubernetes Service" caption-side="top"}
...
| Writer | As a writer, you have permissions beyond the reader role, including creating and editing service-specific resources. |
{: row-headers}
{: caption="Table 56. Service roles - Kubernetes Service" caption-side="top"}
...
{: caption="Table 56. Service actions - Kubernetes Service" caption-side="top"}
{: #actions-table56}
{: tab-title="Actions"}
{: tab-group="containers-kubernetes"}
{: class="simple-tab-table"}
...
| Writer | As a writer, you have permissions beyond the reader role, including creating and editing service-specific resources. |
{: row-headers}
{: caption="Table 57. Service roles - Language Translator" caption-side="top"}
...
{: caption="Table 57. Service actions - Language Translator" caption-side="top"}
{: #actions-table57}
{: tab-title="Actions"}
{: tab-group="language-translator"}
{: class="simple-tab-table"}
...
| Viewer | As a viewer, you can view service instances, but you can't modify them. |
{: row-headers}
{: caption="Table 59. Platform roles - Load Balancer for VPC" caption-side="top"}
...
{: caption="Table 59. Service actions - Load Balancer for VPC" caption-side="top"}
{: #actions-table59}
{: tab-title="Actions"}
{: tab-group="is.load-balancer"}
{: class="simple-tab-table"}
...
| Editor | As an editor, you can perform all platform actions except for managing the account and assigning access policies. |
{: row-headers}
{: caption="Table 60. Platform roles - Machine Learning" caption-side="top"}
...
{: row-headers}
{: caption="Table 60. Service roles - Machine Learning" caption-side="top"}
...
{: caption="Table 60. Service actions - Machine Learning" caption-side="top"}
{: #actions-table60}
{: tab-title="Actions"}
{: tab-group="pm-20"}
{: class="simple-tab-table"}
...
| Operator | As an operator, you can perform platform actions required to configure and operate service instances, such as viewing a service's dashboard. |
{: row-headers}
{: caption="Table 61. Platform roles - Mass Data Migration" caption-side="top"}
...
| Writer | As a writer, you have permissions beyond the reader role, including creating and editing service-specific resources. |
{: row-headers}
{: caption="Table 61. Service roles - Mass Data Migration" caption-side="top"}
...
{: caption="Table 61. Service actions - Mass Data Migration" caption-side="top"}
{: #actions-table61}
{: tab-title="Actions"}
{: tab-group="mass-data-migration"}
{: class="simple-tab-table"}
...
| Viewer | As a viewer, you can view service instances, but you can't modify them. |
{: row-headers}
{: caption="Table 63. Platform roles - Monitoring" caption-side="top"}
...
{: caption="Table 63. Service actions - Monitoring" caption-side="top"}
{: #actions-table63}
{: tab-title="Actions"}
{: tab-group="monitoring"}
{: class="simple-tab-table"}
...
| Viewer | As a viewer, you can view service instances, but you can't modify them. |
{: row-headers}
{: caption="Table 64. Platform roles - MQ" caption-side="top"}
...
| Writer | As a writer, you have permissions beyond the reader role, including creating and editing service-specific resources. |
{: row-headers}
{: caption="Table 64. Service roles - MQ" caption-side="top"}
...
{: caption="Table 64. Service actions - MQ" caption-side="top"}
{: #actions-table64}
{: tab-title="Actions"}
{: tab-group="mqcloud"}
{: class="simple-tab-table"}
...
| Viewer | Viewer |
{: row-headers}
{: caption="Table 65. Platform roles - Natural Language Classifier" caption-side="top"}
...
| Writer | Writer |
{: row-headers}
{: caption="Table 65. Service roles - Natural Language Classifier" caption-side="top"}
...
{: caption="Table 65. Service actions - Natural Language Classifier" caption-side="top"}
{: #actions-table65}
{: tab-title="Actions"}
{: tab-group="natural-language-classifier"}
{: class="simple-tab-table"}
...
| Operator | As an operator, you can perform platform actions required to configure and operate service instances, such as viewing a service's dashboard. |
{: row-headers}
{: caption="Table 66. Platform roles - Natural Language Understanding" caption-side="top"}
...
| Writer | As a writer, you have permissions beyond the reader role, including creating and editing service-specific resources. |
{: row-headers}
{: caption="Table 66. Service roles - Natural Language Understanding" caption-side="top"}
...
{: caption="Table 66. Service actions - Natural Language Understanding" caption-side="top"}
{: #actions-table66}
{: tab-title="Actions"}
{: tab-group="natural-language-understanding"}
{: class="simple-tab-table"}
...
| Viewer | As a viewer, you can view service instances, but you can't modify them. |
{: row-headers}
{: caption="Table 67. Platform roles - Network ACL" caption-side="top"}
...
{: caption="Table 67. Service actions - Network ACL" caption-side="top"}
{: #actions-table67}
{: tab-title="Actions"}
{: tab-group="is.network-acl"}
{: class="simple-tab-table"}
...
| Viewer | As a viewer, you can view service instances, but you can't modify them. |
{: row-headers}
{: caption="Table 68. Platform roles - NeuVector Container Security Platform" caption-side="top"}
...
| Service Configuration Reader | The ability to read services configuration for Governance management. |
{: row-headers}
{: caption="Table 68. Service roles - NeuVector Container Security Platform" caption-side="top"}
...
{: caption="Table 68. Service actions - NeuVector Container Security Platform" caption-side="top"}
{: #actions-table68}
{: tab-title="Actions"}
{: tab-group="neuvector-container-security"}
{: class="simple-tab-table"}
...
| Operator | Operator |
{: row-headers}
{: caption="Table 69. Platform roles - Personality Insights" caption-side="top"}
...
| Writer | Writer |
{: row-headers}
{: caption="Table 69. Service roles - Personality Insights" caption-side="top"}
...
{: caption="Table 69. Service actions - Personality Insights" caption-side="top"}
{: #actions-table69}
{: tab-title="Actions"}
{: tab-group="personality-insights"}
{: class="simple-tab-table"}
...
| Operator | As an operator, you can perform platform actions required to configure and operate service instances, such as viewing a service's dashboard. |
{: row-headers}
{: caption="Table 70. Platform roles - Portworx Enterprise" caption-side="top"}
...
{: caption="Table 70. Service actions - Portworx Enterprise" caption-side="top"}
{: #actions-table70}
{: tab-title="Actions"}
{: tab-group="portworx"}
{: class="simple-tab-table"}
...
| Reader | As a reader, you can perform read-only actions within a service such as viewing service-specific resources. |
{: row-headers}
{: caption="Table 71. Service roles - Power Systems Virtual Server" caption-side="top"}
...
{: caption="Table 71. Service actions - Power Systems Virtual Server" caption-side="top"}
{: #actions-table71}
{: tab-title="Actions"}
{: tab-group="power-iaas"}
{: class="simple-tab-table"}
...
| Operator | Operator |
{: row-headers}
{: caption="Table 72. Platform roles - PowerAI" caption-side="top"}
...
{: caption="Table 72. Service actions - PowerAI" caption-side="top"}
{: #actions-table72}
{: tab-title="Actions"}
{: tab-group="power-ai"}
{: class="simple-tab-table"}
...
| Viewer | As a viewer, you can view service instances, but you can't modify them. |
{: row-headers}
{: caption="Table 73. Platform roles - Public Gateway" caption-side="top"}
...
{: caption="Table 73. Service actions - Public Gateway" caption-side="top"}
{: #actions-table73}
{: tab-title="Actions"}
{: tab-group="is.public-gateway"}
{: class="simple-tab-table"}
...
| Editor | As an editor, you can perform all platform actions except for managing the account and assigning access policies. |
{: row-headers}
{: caption="Table 74. Platform roles - Push Notifications" caption-side="top"}
...
| Writer | As a writer, you have permissions beyond the reader role, including creating and editing service-specific resources. |
{: row-headers}
{: caption="Table 74. Service roles - Push Notifications" caption-side="top"}
...
{: caption="Table 74. Service actions - Push Notifications" caption-side="top"}
{: #actions-table74}
{: tab-title="Actions"}
{: tab-group="imfpush"}
{: class="simple-tab-table"}
...
| Operator | As an operator, you can perform platform actions required to configure and operate service instances, such as viewing a service's dashboard. |
{: row-headers}
{: caption="Table 75. Platform roles - Raxak Protect" caption-side="top"}
...
{: caption="Table 75. Service actions - Raxak Protect" caption-side="top"}
{: #actions-table75}
{: tab-title="Actions"}
{: tab-group="raxak-protect"}
{: class="simple-tab-table"}
...
| Viewer | As a viewer, you can view service instances, but you can't modify them. |
{: row-headers}
{: caption="Table 76. Platform roles - Role management" caption-side="top"}
...
{: caption="Table 76. Service actions - Role management" caption-side="top"}
{: #actions-table76}
{: tab-title="Actions"}
{: tab-group="iam-access-management"}
{: class="simple-tab-table"}
...
| Viewer | As a viewer, you can view service instances, but you can't modify them. |
{: row-headers}
{: caption="Table 77. Platform roles - Satellite" caption-side="top"}
...
| Writer | As a writer, you have permissions beyond the reader role, including creating and editing service-specific resources. |
{: row-headers}
{: caption="Table 77. Service roles - Satellite" caption-side="top"}
...
{: caption="Table 77. Service actions - Satellite" caption-side="top"}
{: #actions-table77}
{: tab-title="Actions"}
{: tab-group="satellite"}
{: class="simple-tab-table"}
...
| Viewer | As a viewer, you can view service instances, but you can't modify them. |
{: row-headers}
{: caption="Table 78. Platform roles - Schematics" caption-side="top"}
...
| Writer | As a writer, you have permissions beyond the reader role, including creating and editing service-specific resources. |
{: row-headers}
{: caption="Table 78. Service roles - Schematics" caption-side="top"}
...
{: caption="Table 78. Service actions - Schematics" caption-side="top"}
{: #actions-table78}
{: tab-title="Actions"}
{: tab-group="schematics"}
{: class="simple-tab-table"}
...
| Operator | As an operator, you can perform platform actions required to configure and operate service instances, such as viewing a service's dashboard. |
{: row-headers}
{: caption="Table 79. Platform roles - Secrets Manager" caption-side="top"}
...
{: row-headers}
{: caption="Table 79. Service roles - Secrets Manager" caption-side="top"}
...
{: caption="Table 79. Service actions - Secrets Manager" caption-side="top"}
{: #actions-table79}
{: tab-title="Actions"}
{: tab-group="secrets-manager"}
{: class="simple-tab-table"}
...
| Operator | As an operator, you can perform platform actions required to configure and operate service instances, such as viewing a service's dashboard. |
{: row-headers}
{: caption="Table 80. Platform roles - Security Advisor" caption-side="top"}
...
| Writer | As a writer, you have permissions beyond the reader role, including creating and editing service-specific resources. |
{: row-headers}
{: caption="Table 80. Service roles - Security Advisor" caption-side="top"}
...
{: caption="Table 80. Service actions - Security Advisor" caption-side="top"}
{: #actions-table80}
{: tab-title="Actions"}
{: tab-group="security-advisor"}
{: class="simple-tab-table"}
...
| Viewer | As a viewer, you can view service instances, but you can't modify them. |
{: row-headers}
{: caption="Table 81. Platform roles - Security and Compliance Center" caption-side="top"}
...
{: row-headers}
{: caption="Table 81. Service roles - Security and Compliance Center" caption-side="top"}
...
{: caption="Table 81. Service actions - Security and Compliance Center" caption-side="top"}
{: #actions-table81}
{: tab-title="Actions"}
{: tab-group="compliance"}
{: class="simple-tab-table"}
...
| Viewer | As a viewer, you can view service instances, but you can't modify them. |
{: row-headers}
{: caption="Table 82. Platform roles - Security Group for VPC" caption-side="top"}
...
{: caption="Table 82. Service actions - Security Group for VPC" caption-side="top"}
{: #actions-table82}
{: tab-title="Actions"}
{: tab-group="is.security-group"}
{: class="simple-tab-table"}
...
| Operator | As an operator, you can perform platform actions required to configure and operate service instances, such as viewing a service's dashboard. |
{: row-headers}
{: caption="Table 83. Platform roles - Skytap On IBM Cloud" caption-side="top"}
...
{: caption="Table 83. Service actions - Skytap On IBM Cloud" caption-side="top"}
{: #actions-table83}
{: tab-title="Actions"}
{: tab-group="skytap"}
{: class="simple-tab-table"}
...
| Operator | As an operator, you can perform platform actions required to configure and operate service instances, such as viewing a service's dashboard. |
{: row-headers}
{: caption="Table 84. Platform roles - Speech to Text" caption-side="top"}
...
| Writer | As a writer, you have permissions beyond the reader role, including creating and editing service-specific resources. |
{: row-headers}
{: caption="Table 84. Service roles - Speech to Text" caption-side="top"}
...
{: caption="Table 84. Service actions - Speech to Text" caption-side="top"}
{: #actions-table84}
{: tab-title="Actions"}
{: tab-group="speech-to-text"}
{: class="simple-tab-table"}
...
| Writer | As a writer, you have permissions beyond the reader role, including creating and editing service-specific resources. |
{: row-headers}
{: caption="Table 85. Service roles - SQL Query" caption-side="top"}
...
{: caption="Table 85. Service actions - SQL Query" caption-side="top"}
{: #actions-table85}
{: tab-title="Actions"}
{: tab-group="sql-query"}
{: class="simple-tab-table"}
...
| Viewer | As a viewer, you can view service instances, but you can't modify them. |
{: row-headers}
{: caption="Table 86. Platform roles - SSH Key for VPC" caption-side="top"}
...
{: caption="Table 86. Service actions - SSH Key for VPC" caption-side="top"}
{: #actions-table86}
{: tab-title="Actions"}
{: tab-group="is.key"}
{: class="simple-tab-table"}
...
| Writer | Writer |
{: row-headers}
{: caption="Table 87. Service roles - Streaming Analytics" caption-side="top"}
...
{: caption="Table 87. Service actions - Streaming Analytics" caption-side="top"}
{: #actions-table87}
{: tab-title="Actions"}
{: tab-group="streaming-analytics"}
{: class="simple-tab-table"}
...
| Viewer | As a viewer, you can view service instances, but you can't modify them. |
{: row-headers}
{: caption="Table 88. Platform roles - Subnet" caption-side="top"}
...
{: caption="Table 88. Service actions - Subnet" caption-side="top"}
{: #actions-table88}
{: tab-title="Actions"}
{: tab-group="is.subnet"}
{: class="simple-tab-table"}
...
{: row-headers}
{: caption="Table 89. Platform roles - Support Center" caption-side="top"}
...
{: caption="Table 89. Service actions - Support Center" caption-side="top"}
{: #actions-table89}
{: tab-title="Actions"}
{: tab-group="support"}
{: class="simple-tab-table"}
...
| Operator | Operator |
{: row-headers}
{: caption="Table 90. Platform roles - Text to Speech" caption-side="top"}
...
| Writer | Writer |
{: row-headers}
{: caption="Table 90. Service roles - Text to Speech" caption-side="top"}
...
{: caption="Table 90. Service actions - Text to Speech" caption-side="top"}
{: #actions-table90}
{: tab-title="Actions"}
{: tab-group="text-to-speech"}
{: class="simple-tab-table"}
...
| Operator | Operator |
{: row-headers}
{: caption="Table 91. Platform roles - Tone Analyzer" caption-side="top"}
...
| Writer | Writer |
{: row-headers}
{: caption="Table 91. Service roles - Tone Analyzer" caption-side="top"}
...
{: caption="Table 91. Service actions - Tone Analyzer" caption-side="top"}
{: #actions-table91}
{: tab-title="Actions"}
{: tab-group="tone-analyzer"}
{: class="simple-tab-table"}
...
| Viewer | As a viewer, you can view service instances, but you can't modify them. |
{: row-headers}
{: caption="Table 92. Platform roles - Toolchain" caption-side="top"}
...
{: caption="Table 92. Service actions - Toolchain" caption-side="top"}
{: #actions-table92}
{: tab-title="Actions"}
{: tab-group="toolchain"}
{: class="simple-tab-table"}
...
| Service Configuration Reader | The ability to read services configuration for Governance management. |
{: row-headers}
{: caption="Table 94. Service roles - Transit Gateway" caption-side="top"}
...
| `transit.transit.manage` | Transit service manager | Manager |
| `transit.config.read` | Configuration Information Point API Access | Service Configuration Reader |
{: caption="Table 94. Service actions - Transit Gateway" caption-side="top"}
{: #actions-table94}
{: tab-title="Actions"}
{: tab-group="transit"}
{: class="simple-tab-table"}
...
{: row-headers}
{: caption="Table 95. Platform roles - User Management" caption-side="top"}
...
{: caption="Table 95. Service actions - User Management" caption-side="top"}
{: #actions-table95}
{: tab-title="Actions"}
{: tab-group="user-management"}
{: class="simple-tab-table"}
...
| Viewer | As a viewer, you can view service instances, but you can't modify them. |
{: row-headers}
{: caption="Table 96. Platform roles - Virtual Private Cloud" caption-side="top"}
...
{: caption="Table 96. Service actions - Virtual Private Cloud" caption-side="top"}
{: #actions-table96}
{: tab-title="Actions"}
{: tab-group="is.vpc"}
{: class="simple-tab-table"}
...
{: row-headers}
{: caption="Table 97. Platform roles - Virtual Private Endpoint for VPC" caption-side="top"}
...
{: caption="Table 97. Service actions - Virtual Private Endpoint for VPC" caption-side="top"}
{: #actions-table97}
{: tab-title="Actions"}
{: tab-group="is.endpoint-gateway"}
{: class="simple-tab-table"}
...
| Viewer | As a viewer, you can view service instances, but you can't modify them. |
{: row-headers}
{: caption="Table 98. Platform roles - Virtual Server for VPC" caption-side="top"}
...
{: row-headers}
{: caption="Table 98. Service roles - Virtual Server for VPC" caption-side="top"}
...
{: caption="Table 98. Service actions - Virtual Server for VPC" caption-side="top"}
{: #actions-table98}
{: tab-title="Actions"}
{: tab-group="is.instance"}
{: class="simple-tab-table"}
...
| Writer | Writer |
{: row-headers}
{: caption="Table 99. Service roles - Visual Recognition" caption-side="top"}
...
{: caption="Table 99. Service actions - Visual Recognition" caption-side="top"}
{: #actions-table99}
{: tab-title="Actions"}
{: tab-group="watson-vision-combined"}
{: class="simple-tab-table"}
...
| Viewer | As a viewer, you can view service instances, but you can't modify them. |
{: row-headers}
{: caption="Table 100. Platform roles - VMware Solutions" caption-side="top"}
...
{: caption="Table 100. Service actions - VMware Solutions" caption-side="top"}
{: #actions-table100}
{: tab-title="Actions"}
{: tab-group="vmware-solutions"}
{: class="simple-tab-table"}
...
| Operator | As an operator, you can perform platform actions required to configure and operate service instances, such as viewing a service's dashboard. |
{: row-headers}
{: caption="Table 101. Platform roles - Voice Agent with Watson" caption-side="top"}
...
| Writer | As a writer, you have permissions beyond the reader role, including creating and editing service-specific resources. |
{: row-headers}
{: caption="Table 101. Service roles - Voice Agent with Watson" caption-side="top"}
...
{: caption="Table 101. Service actions - Voice Agent with Watson" caption-side="top"}
{: #actions-table101}
{: tab-title="Actions"}
{: tab-group="voiceagent"}
{: class="simple-tab-table"}
...
| Viewer | As a viewer, you can view service instances, but you can't modify them. |
{: row-headers}
{: caption="Table 103. Platform roles - VPC+ Cloud Migration" caption-side="top"}
...
| Service Configuration Reader | The ability to read services configuration for Governance management. |
{: row-headers}
{: caption="Table 103. Service roles - VPC+ Cloud Migration" caption-side="top"}
...
{: caption="Table 103. Service actions - VPC+ Cloud Migration" caption-side="top"}
{: #actions-table103}
{: tab-title="Actions"}
{: tab-group="migrationtool-from-wanclds"}
{: class="simple-tab-table"}
...
| Viewer | As a viewer, you can view service instances, but you can't modify them. |
{: row-headers}
{: caption="Table 105. Platform roles - Watson Assistant" caption-side="top"}
...
| Writer | As a writer, you have permissions beyond the reader role, including creating and editing service-specific resources. |
{: row-headers}
{: caption="Table 105. Service roles - Watson Assistant" caption-side="top"}
...
{: caption="Table 105. Service actions - Watson Assistant" caption-side="top"}
{: #actions-table105}
{: tab-title="Actions"}
{: tab-group="conversation"}
{: class="simple-tab-table"}
...
| Writer | As a writer, you have permissions beyond the reader role, including creating and editing service-specific resources. |
{: row-headers}
{: caption="Table 106. Service roles - Watson Discovery" caption-side="top"}
...
{: caption="Table 106. Service actions - Watson Discovery" caption-side="top"}
{: #actions-table106}
{: tab-title="Actions"}
{: tab-group="discovery"}
{: class="simple-tab-table"}
...
| Administrator | Administrator |
{: row-headers}
{: caption="Table 107. Platform roles - Watson Knowledge Catalog" caption-side="top"}
...
| Writer | Writer |
{: row-headers}
{: caption="Table 107. Service roles - Watson Knowledge Catalog" caption-side="top"}
...
{: caption="Table 107. Service actions - Watson Knowledge Catalog" caption-side="top"}
{: #actions-table107}
{: tab-title="Actions"}
{: tab-group="datacatalog"}
{: class="simple-tab-table"}
...
| Viewer | As a viewer, you can view service instances, but you can't modify them. |
{: row-headers}
{: caption="Table 108. Platform roles - Watson OpenScale" caption-side="top"}
...
{: caption="Table 108. Service actions - Watson OpenScale" caption-side="top"}
{: #actions-table108}
{: tab-title="Actions"}
{: tab-group="aiopenscale"}
{: class="simple-tab-table"}
...
| Operator | As an operator, you can perform platform actions required to configure and operate service instances, such as viewing a service's dashboard. |
{: row-headers}
{: caption="Table 110. Platform roles - WebSphere Application Server" caption-side="top"}
...
{: caption="Table 110. Service actions - WebSphere Application Server" caption-side="top"}
{: #actions-table110}
{: tab-title="Actions"}
{: tab-group="websphereappsvr"}
{: class="simple-tab-table"}

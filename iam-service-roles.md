...
| Action | Description | Roles |
| ----- | :----- | :----- |
| `POST /v4/:platform/deployments/:deployment_id/external_backup` |  | Administrator, Editor, Operator |
| `PATCH /v4/:platform/deployments/:deployment_id/ext_restore` |  | Administrator, Editor, Operator |
| `POST /v4/:platform/deployments/:deployment_id/ext_restore` |  | Administrator, Editor, Operator |
| `POST /v4/:platform/deployments/:deployment_id/ext_restore_rollforward` |  | Administrator, Editor, Operator |
| `GET /v4/:platform/deployments/:deployment_id/external_restore_status` |  | Administrator, Editor, Operator, Viewer |
| `GET /v4/:platform/deployments/:deployment_id/external_restore_status/:external_restore_status_id` |  | Administrator, Editor, Operator, Viewer |

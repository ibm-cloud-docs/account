...
| Operator | As an operator, you can perform platform actions required to configure and operate service instances, such as viewing a service's dashboard. |
{: row-headers}
{: caption="Table 17. Platform roles - Code Engine" caption-side="top"}
...
| Writer | As a writer, you have permissions beyond the reader role, including creating and editing service-specific resources. |
{: row-headers}
{: caption="Table 17. Service roles - Code Engine" caption-side="top"}
...
{: caption="Table 17. Service actions - Code Engine" caption-side="top"}
{: #actions-table17}
{: tab-title="Actions"}
{: tab-group="codeengine"}
{: class="simple-tab-table"}
...
| Operator | As an operator, you can perform platform actions required to configure and operate service instances, such as viewing a service's dashboard. |
{: row-headers}
{: caption="Table 18. Platform roles - Compare and Comply" caption-side="top"}
...
| Writer | As a writer, you have permissions beyond the reader role, including creating and editing service-specific resources. |
{: row-headers}
{: caption="Table 18. Service roles - Compare and Comply" caption-side="top"}
...
{: caption="Table 18. Service actions - Compare and Comply" caption-side="top"}
{: #actions-table18}
{: tab-title="Actions"}
{: tab-group="compare-comply"}
{: class="simple-tab-table"}
...
| Viewer | As a viewer, you can view service instances, but you can't modify them. |
{: row-headers}
{: caption="Table 19. Platform roles - Consult with IBM Garage" caption-side="top"}
...
| Writer | As a writer, you have permissions beyond the reader role, including creating and editing service-specific resources. |
{: row-headers}
{: caption="Table 19. Service roles - Consult with IBM Garage" caption-side="top"}
...
{: caption="Table 19. Service actions - Consult with IBM Garage" caption-side="top"}
{: #actions-table19}
{: tab-title="Actions"}
{: tab-group="consult-with-icg-wes"}
{: class="simple-tab-table"}
...
| Administrator | As an administrator, you can perform all platform actions based on the resource this role is being assigned, including assigning access policies to other users. |
{: row-headers}
{: caption="Table 20. Platform roles - Container Registry" caption-side="top"}
...
| Writer | As a writer, you have permissions beyond the reader role, including creating and editing service-specific resources. |
{: row-headers}
{: caption="Table 20. Service roles - Container Registry" caption-side="top"}
...
{: caption="Table 20. Service actions - Container Registry" caption-side="top"}
{: #actions-table20}
{: tab-title="Actions"}
{: tab-group="container-registry"}
{: class="simple-tab-table"}
...
{: row-headers}
{: caption="Table 21. Platform roles - Continuous Delivery" caption-side="top"}
...
| Writer | As a writer, you have permissions beyond the reader role, including creating and editing service-specific resources. |
{: row-headers}
{: caption="Table 21. Service roles - Continuous Delivery" caption-side="top"}
...
{: caption="Table 21. Service actions - Continuous Delivery" caption-side="top"}
{: #actions-table21}
{: tab-title="Actions"}
{: tab-group="continuous-delivery"}
{: class="simple-tab-table"}
...
| Viewer | As a viewer, you can view service instances, but you can't modify them. |
{: row-headers}
{: caption="Table 22. Platform roles - Data Virtualization" caption-side="top"}
...
{: row-headers}
{: caption="Table 22. Service roles - Data Virtualization" caption-side="top"}
...
{: caption="Table 22. Service actions - Data Virtualization" caption-side="top"}
{: #actions-table22}
{: tab-title="Actions"}
{: tab-group="data-virtualization"}
{: class="simple-tab-table"}
...
| Operator | As an operator, you can perform platform actions required to configure and operate service instances, such as viewing a service's dashboard. |
{: row-headers}
{: caption="Table 23. Platform roles - DataStage" caption-side="top"}
...
| Reader | As a reader, you can perform read-only actions within a service such as viewing service-specific resources. |
{: row-headers}
{: caption="Table 23. Service roles - DataStage" caption-side="top"}
...
{: caption="Table 23. Service actions - DataStage" caption-side="top"}
{: #actions-table23}
{: tab-title="Actions"}
{: tab-group="datastage"}
{: class="simple-tab-table"}
...
| Viewer | As a viewer, you can view service instances, but you can't modify them. |
{: row-headers}
{: caption="Table 24. Platform roles - Db2" caption-side="top"}
...
| Manager | As a manager, you have permissions beyond the writer role to complete privileged actions as defined by the service. In addition, you can create and edit service-specific resources. |
{: row-headers}
{: caption="Table 24. Service roles - Db2" caption-side="top"}
...
{: caption="Table 24. Service actions - Db2" caption-side="top"}
{: #actions-table24}
{: tab-title="Actions"}
{: tab-group="dashdb-for-transactions"}
{: class="simple-tab-table"}
...
| Writer | As a writer, you have permissions beyond the reader role, including creating and editing service-specific resources. |
{: row-headers}
{: caption="Table 25. Service roles - Db2 Warehouse" caption-side="top"}
...
{: caption="Table 25. Service actions - Db2 Warehouse" caption-side="top"}
{: #actions-table25}
{: tab-title="Actions"}
{: tab-group="dashdb"}
{: class="simple-tab-table"}
...
| Viewer | As a viewer, you can view service instances, but you can't modify them. |
{: row-headers}
{: caption="Table 26. Platform roles - Dedicated Host for VPC" caption-side="top"}
...
{: caption="Table 26. Service actions - Dedicated Host for VPC" caption-side="top"}
{: #actions-table26}
{: tab-title="Actions"}
{: tab-group="is.dedicated-host"}
{: class="simple-tab-table"}
...
| Viewer | As a viewer, you can view service instances, but you can't modify them. |
{: row-headers}
{: caption="Table 27. Platform roles - Direct Link Connect" caption-side="top"}
...
{: caption="Table 27. Service actions - Direct Link Connect" caption-side="top"}
{: #actions-table27}
{: tab-title="Actions"}
{: tab-group="directlink.connect"}
{: class="simple-tab-table"}
...
| Viewer | As a viewer, you can view service instances, but you can't modify them. |
{: row-headers}
{: caption="Table 28. Platform roles - Direct Link Dedicated (2.0)" caption-side="top"}
...
{: caption="Table 28. Service actions - Direct Link Dedicated (2.0)" caption-side="top"}
{: #actions-table28}
{: tab-title="Actions"}
{: tab-group="directlink.dedicated"}
{: class="simple-tab-table"}
...
| Viewer | As a viewer, you can view service instances, but you can't modify them. |
{: row-headers}
{: caption="Table 29. Platform roles - Dizzion DaaS" caption-side="top"}
...
| Service Configuration Reader | The ability to read services configuration for Governance management. |
{: row-headers}
{: caption="Table 29. Service roles - Dizzion DaaS" caption-side="top"}
...
{: caption="Table 29. Service actions - Dizzion DaaS" caption-side="top"}
{: #actions-table29}
{: tab-title="Actions"}
{: tab-group="dizziondaas"}
{: class="simple-tab-table"}
...
| Operator | As an operator, you can perform platform actions required to configure and operate service instances, such as viewing a service's dashboard. |
{: row-headers}
{: caption="Table 30. Platform roles - DNS Services" caption-side="top"}
...
| Writer | As a writer, you have permissions beyond the reader role, including creating and editing service-specific resources. |
{: row-headers}
{: caption="Table 30. Service roles - DNS Services" caption-side="top"}
...
{: caption="Table 30. Service actions - DNS Services" caption-side="top"}
{: #actions-table30}
{: tab-title="Actions"}
{: tab-group="dns-svcs"}
{: class="simple-tab-table"}
...
{: row-headers}
{: caption="Table 31. Platform roles - Enterprise" caption-side="top"}
...
{: row-headers}
{: caption="Table 31. Service roles - Enterprise" caption-side="top"}
...
{: caption="Table 31. Service actions - Enterprise" caption-side="top"}
{: #actions-table31}
{: tab-title="Actions"}
{: tab-group="enterprise"}
{: class="simple-tab-table"}
...
| Writer | As a writer, you have permissions beyond the reader role, including creating and editing service-specific resources. |
{: row-headers}
{: caption="Table 32. Service roles - Event Streams" caption-side="top"}
...
{: caption="Table 32. Service actions - Event Streams" caption-side="top"}
{: #actions-table32}
{: tab-title="Actions"}
{: tab-group="messagehub"}
{: class="simple-tab-table"}
...
| Viewer | As a viewer, you can view service instances, but you can't modify them. |
{: row-headers}
{: caption="Table 33. Platform roles - Floating IP for VPC" caption-side="top"}
...
{: caption="Table 33. Service actions - Floating IP for VPC" caption-side="top"}
{: #actions-table33}
{: tab-title="Actions"}
{: tab-group="is.floating-ip"}
{: class="simple-tab-table"}
...
| Viewer | As a viewer, you can view service instances, but you can't modify them. |
{: row-headers}
{: caption="Table 34. Platform roles - Flow Logs for VPC" caption-side="top"}
...
{: caption="Table 34. Service actions - Flow Logs for VPC" caption-side="top"}
{: #actions-table34}
{: tab-title="Actions"}
{: tab-group="is.flow-log-collector"}
{: class="simple-tab-table"}
...
| Writer | As a writer, you have permissions beyond the reader role, including creating and editing service-specific resources. |
{: row-headers}
{: caption="Table 35. Service roles - Functions" caption-side="top"}
...
{: caption="Table 35. Service actions - Functions" caption-side="top"}
{: #actions-table35}
{: tab-title="Actions"}
{: tab-group="functions"}
{: class="simple-tab-table"}
...
{: row-headers}
{: caption="Table 36. Platform roles - Global Resource Catalog" caption-side="top"}
...
{: caption="Table 36. Service actions - Global Resource Catalog" caption-side="top"}
{: #actions-table36}
{: tab-title="Actions"}
{: tab-group="globalcatalog"}
{: class="simple-tab-table"}
...
| Operator | As an operator, you can perform platform actions required to configure and operate service instances, such as viewing a service's dashboard. |
{: row-headers}
{: caption="Table 37. Platform roles - Globalization Pipeline" caption-side="top"}
...
| Writer | As a writer, you have permissions beyond the reader role, including creating and editing service-specific resources. |
{: row-headers}
{: caption="Table 37. Service roles - Globalization Pipeline" caption-side="top"}
...
{: caption="Table 37. Service actions - Globalization Pipeline" caption-side="top"}
{: #actions-table37}
{: tab-title="Actions"}
{: tab-group="g11n-pipeline"}
{: class="simple-tab-table"}
...
| Operator | Operator |
{: row-headers}
{: caption="Table 38. Platform roles - HPCaaS from Rescale" caption-side="top"}
...
{: caption="Table 38. Service actions - HPCaaS from Rescale" caption-side="top"}
{: #actions-table38}
{: tab-title="Actions"}
{: tab-group="hpcaas-from-rescale-prod"}
{: class="simple-tab-table"}
...
| Viewer | As a viewer, you can view service instances, but you can't modify them. |
{: row-headers}
{: caption="Table 39. Platform roles - Hyper Protect Crypto Services" caption-side="top"}
...
| Writer | As a writer, you have permissions beyond the reader role, including creating and editing service-specific resources. |
{: row-headers}
{: caption="Table 39. Service roles - Hyper Protect Crypto Services" caption-side="top"}
...
{: caption="Table 39. Service actions - Hyper Protect Crypto Services" caption-side="top"}
{: #actions-table39}
{: tab-title="Actions"}
{: tab-group="hs-crypto"}
{: class="simple-tab-table"}
...
| Writer | As a writer, you have permissions beyond the reader role, including creating and editing service-specific resources. |
{: row-headers}
{: caption="Table 40. Service roles - Hyper Protect DBaaS for MongoDB" caption-side="top"}
...
{: caption="Table 40. Service actions - Hyper Protect DBaaS for MongoDB" caption-side="top"}
{: #actions-table40}
{: tab-title="Actions"}
{: tab-group="hyperp-dbaas-mongodb"}
{: class="simple-tab-table"}
...
| Writer | As a writer, you have permissions beyond the reader role, including creating and editing service-specific resources. |
{: row-headers}
{: caption="Table 41. Service roles - Hyper Protect DBaaS for PostgreSQL" caption-side="top"}
...
{: caption="Table 41. Service actions - Hyper Protect DBaaS for PostgreSQL" caption-side="top"}
{: #actions-table41}
{: tab-title="Actions"}
{: tab-group="hyperp-dbaas-postgresql"}
{: class="simple-tab-table"}
...
| Operator | As an operator, you can perform platform actions required to configure and operate service instances, such as viewing a service's dashboard. |
{: row-headers}
{: caption="Table 42. Platform roles - Hyper Protect Virtual Server" caption-side="top"}
...
| Writer | As a writer, you have permissions beyond the reader role, including creating and editing service-specific resources. |
{: row-headers}
{: caption="Table 42. Service roles - Hyper Protect Virtual Server" caption-side="top"}
...
{: caption="Table 42. Service actions - Hyper Protect Virtual Server" caption-side="top"}
{: #actions-table42}
{: tab-title="Actions"}
{: tab-group="hpvs"}
{: class="simple-tab-table"}
...
{: row-headers}
{: caption="Table 43. Platform roles - IAM Access Groups Service" caption-side="top"}
...
| Service Configuration Reader | The ability to read services configuration for Governance management. |
{: row-headers}
{: caption="Table 43. Service roles - IAM Access Groups Service" caption-side="top"}
...
{: caption="Table 43. Service actions - IAM Access Groups Service" caption-side="top"}
{: #actions-table43}
{: tab-title="Actions"}
{: tab-group="iam-groups"}
{: class="simple-tab-table"}
...
{: row-headers}
{: caption="Table 44. Platform roles - IAM Identity Service" caption-side="top"}
...
{: row-headers}
{: caption="Table 44. Service roles - IAM Identity Service" caption-side="top"}
...
{: caption="Table 44. Service actions - IAM Identity Service" caption-side="top"}
{: #actions-table44}
{: tab-title="Actions"}
{: tab-group="iam-identity"}
{: class="simple-tab-table"}
...
| Administrator | As an administrator, you can perform all platform actions based on the resource this role is being assigned, including assigning access policies to other users. |
{: row-headers}
{: caption="Table 45. Platform roles - IBM Cloud Activity Tracker" caption-side="top"}
...
{: row-headers}
{: caption="Table 45. Service roles - IBM Cloud Activity Tracker" caption-side="top"}
...
{: caption="Table 45. Service actions - IBM Cloud Activity Tracker" caption-side="top"}
{: #actions-table45}
{: tab-title="Actions"}
{: tab-group="logdnaat"}
{: class="simple-tab-table"}
...
| Operator | As an operator, you can perform platform actions required to configure and operate service instances, such as viewing a service's dashboard. |
{: row-headers}
{: caption="Table 46. Platform roles - IBM Cloud Data Shield" caption-side="top"}
...
{: caption="Table 46. Service actions - IBM Cloud Data Shield" caption-side="top"}
{: #actions-table46}
{: tab-title="Actions"}
{: tab-group="data-shield"}
{: class="simple-tab-table"}
...
| Administrator | As an administrator, you can perform all platform actions based on the resource this role is being assigned, including assigning access policies to other users. |
{: row-headers}
{: caption="Table 47. Platform roles - IBM Cloud Monitoring" caption-side="top"}
...
| Writer | As a writer, you have permissions beyond the reader role, including creating and editing service-specific resources. |
{: row-headers}
{: caption="Table 47. Service roles - IBM Cloud Monitoring" caption-side="top"}
...
{: caption="Table 47. Service actions - IBM Cloud Monitoring" caption-side="top"}
{: #actions-table47}
{: tab-title="Actions"}
{: tab-group="sysdig-monitor"}
{: class="simple-tab-table"}
...
| Administrator | As an administrator, you can perform all platform actions based on the resource this role is being assigned, including assigning access policies to other users. |
{: row-headers}
{: caption="Table 49. Platform roles - IBM Cloud Shell" caption-side="top"}
...
| Service Configuration Reader | The ability to read services configuration for Governance management. |
{: row-headers}
{: caption="Table 49. Service roles - IBM Cloud Shell" caption-side="top"}
...
{: caption="Table 49. Service actions - IBM Cloud Shell" caption-side="top"}
{: #actions-table49}
{: tab-title="Actions"}
{: tab-group="cloudshell"}
{: class="simple-tab-table"}
...
| Writer | Writer |
{: row-headers}
{: caption="Table 50. Service roles - IBM Cognos Dashboard Embedded" caption-side="top"}
...
{: caption="Table 50. Service actions - IBM Cognos Dashboard Embedded" caption-side="top"}
{: #actions-table50}
{: tab-title="Actions"}
{: tab-group="dynamic-dashboard-embedded"}
{: class="simple-tab-table"}
...
| Administrator | As an administrator, you can perform all platform actions based on the resource this role is being assigned, including assigning access policies to other users. |
{: row-headers}
{: caption="Table 51. Platform roles - IBM Log Analysis" caption-side="top"}
...
| Standard Member | As a member, you can configure views, dashboards and alerts, export data, search, filter, and view all data. |
{: row-headers}
{: caption="Table 51. Service roles - IBM Log Analysis" caption-side="top"}
...
{: caption="Table 51. Service actions - IBM Log Analysis" caption-side="top"}
{: #actions-table51}
{: tab-title="Actions"}
{: tab-group="logdna"}
{: class="simple-tab-table"}
...
| Viewer | As a viewer, you can view service instances, but you can't modify them. |
{: row-headers}
{: caption="Table 52. Platform roles - IBM Match 360 with Watson" caption-side="top"}
...
| Writer | As a writer, you have permissions beyond the reader role, including creating and editing service-specific resources. |
{: row-headers}
{: caption="Table 52. Service roles - IBM Match 360 with Watson" caption-side="top"}
...
{: caption="Table 52. Service actions - IBM Match 360 with Watson" caption-side="top"}
{: #actions-table52}
{: tab-title="Actions"}
{: tab-group="mdm-oc"}
{: class="simple-tab-table"}
...
| Viewer | As a viewer, you can view service instances, but you can't modify them. |
{: row-headers}
{: caption="Table 53. Platform roles - Identity and Access Management" caption-side="top"}
...
| Service Configuration Reader | The ability to read services configuration for Governance management. |
{: row-headers}
{: caption="Table 53. Service roles - Identity and Access Management" caption-side="top"}
...
{: caption="Table 53. Service actions - Identity and Access Management" caption-side="top"}
{: #actions-table53}
{: tab-title="Actions"}
{: tab-group="iam-svcs"}
{: class="simple-tab-table"}
...
| Viewer | As a viewer, you can view service instances, but you can't modify them. |
{: row-headers}
{: caption="Table 54. Platform roles - Image Service for VPC" caption-side="top"}
...
{: caption="Table 54. Service actions - Image Service for VPC" caption-side="top"}
{: #actions-table54}
{: tab-title="Actions"}
{: tab-group="is.image"}
{: class="simple-tab-table"}
...
| Operator | As an operator, you can perform platform actions required to configure and operate service instances, such as viewing a service's dashboard. |
{: row-headers}
{: caption="Table 55. Platform roles - Internet of Things Platform" caption-side="top"}
...
{: caption="Table 55. Service actions - Internet of Things Platform" caption-side="top"}
{: #actions-table55}
{: tab-title="Actions"}
{: tab-group="iotf-service"}
{: class="simple-tab-table"}
...
| Writer | As a writer, you have permissions beyond the reader role, including creating and editing service-specific resources. |
{: row-headers}
{: caption="Table 56. Service roles - Internet Services" caption-side="top"}
...
{: caption="Table 56. Service actions - Internet Services" caption-side="top"}
{: #actions-table56}
{: tab-title="Actions"}
{: tab-group="internet-svcs"}
{: class="simple-tab-table"}
...
| Writer | As a writer, you have permissions beyond the reader role, including creating and editing service-specific resources. |
{: row-headers}
{: caption="Table 57. Service roles - Key Protect" caption-side="top"}
...
{: caption="Table 57. Service actions - Key Protect" caption-side="top"}
{: #actions-table57}
{: tab-title="Actions"}
{: tab-group="kms"}
{: class="simple-tab-table"}
...
| Viewer | As a viewer, you can view service instances, but you can't modify them. |
{: row-headers}
{: caption="Table 58. Platform roles - Knowledge Studio" caption-side="top"}
...
| Writer | As a writer, you have permissions beyond the reader role, including creating and editing service-specific resources. |
{: row-headers}
{: caption="Table 58. Service roles - Knowledge Studio" caption-side="top"}
...
{: caption="Table 58. Service actions - Knowledge Studio" caption-side="top"}
{: #actions-table58}
{: tab-title="Actions"}
{: tab-group="knowledge-studio"}
{: class="simple-tab-table"}
...
| Viewer | As a viewer, you can view service instances, but you can't modify them. |
{: row-headers}
{: caption="Table 59. Platform roles - Kubernetes Service" caption-side="top"}
...
| Writer | As a writer, you have permissions beyond the reader role, including creating and editing service-specific resources. |
{: row-headers}
{: caption="Table 59. Service roles - Kubernetes Service" caption-side="top"}
...
{: caption="Table 59. Service actions - Kubernetes Service" caption-side="top"}
{: #actions-table59}
{: tab-title="Actions"}
{: tab-group="containers-kubernetes"}
{: class="simple-tab-table"}
...
| Writer | As a writer, you have permissions beyond the reader role, including creating and editing service-specific resources. |
{: row-headers}
{: caption="Table 60. Service roles - Language Translator" caption-side="top"}
...
{: caption="Table 60. Service actions - Language Translator" caption-side="top"}
{: #actions-table60}
{: tab-title="Actions"}
{: tab-group="language-translator"}
{: class="simple-tab-table"}
...
| Editor | As an editor, you can perform all platform actions except for managing the account and assigning access policies. |
{: row-headers}
{: caption="Table 61. Platform roles - License and Entitlement" caption-side="top"}
...
{: caption="Table 61. Service actions - License and Entitlement" caption-side="top"}
{: #actions-table61}
{: tab-title="Actions"}
{: tab-group="entitlement"}
{: class="simple-tab-table"}
...
| Viewer | As a viewer, you can view service instances, but you can't modify them. |
{: row-headers}
{: caption="Table 62. Platform roles - Load Balancer for VPC" caption-side="top"}
...
| Service Configuration Reader | The ability to read services configuration for Governance management. |
{: row-headers}
{: caption="Table 62. Service roles - Load Balancer for VPC" caption-side="top"}
...
{: caption="Table 62. Service actions - Load Balancer for VPC" caption-side="top"}
{: #actions-table62}
{: tab-title="Actions"}
{: tab-group="is.load-balancer"}
{: class="simple-tab-table"}
...
| Editor | As an editor, you can perform all platform actions except for managing the account and assigning access policies. |
{: row-headers}
{: caption="Table 63. Platform roles - Machine Learning" caption-side="top"}
...
{: row-headers}
{: caption="Table 63. Service roles - Machine Learning" caption-side="top"}
...
{: caption="Table 63. Service actions - Machine Learning" caption-side="top"}
{: #actions-table63}
{: tab-title="Actions"}
{: tab-group="pm-20"}
{: class="simple-tab-table"}
...
| Operator | As an operator, you can perform platform actions required to configure and operate service instances, such as viewing a service's dashboard. |
{: row-headers}
{: caption="Table 64. Platform roles - Mass Data Migration" caption-side="top"}
...
| Writer | As a writer, you have permissions beyond the reader role, including creating and editing service-specific resources. |
{: row-headers}
{: caption="Table 64. Service roles - Mass Data Migration" caption-side="top"}
...
{: caption="Table 64. Service actions - Mass Data Migration" caption-side="top"}
{: #actions-table64}
{: tab-title="Actions"}
{: tab-group="mass-data-migration"}
{: class="simple-tab-table"}
...
| Viewer | As a viewer, you can view service instances, but you can't modify them. |
{: row-headers}
{: caption="Table 66. Platform roles - Monitoring" caption-side="top"}
...
{: caption="Table 66. Service actions - Monitoring" caption-side="top"}
{: #actions-table66}
{: tab-title="Actions"}
{: tab-group="monitoring"}
{: class="simple-tab-table"}
...
| Viewer | As a viewer, you can view service instances, but you can't modify them. |
{: row-headers}
{: caption="Table 67. Platform roles - MQ" caption-side="top"}
...
| Writer | As a writer, you have permissions beyond the reader role, including creating and editing service-specific resources. |
{: row-headers}
{: caption="Table 67. Service roles - MQ" caption-side="top"}
...
{: caption="Table 67. Service actions - MQ" caption-side="top"}
{: #actions-table67}
{: tab-title="Actions"}
{: tab-group="mqcloud"}
{: class="simple-tab-table"}
...
| Viewer | Viewer |
{: row-headers}
{: caption="Table 68. Platform roles - Natural Language Classifier" caption-side="top"}
...
| Writer | Writer |
{: row-headers}
{: caption="Table 68. Service roles - Natural Language Classifier" caption-side="top"}
...
{: caption="Table 68. Service actions - Natural Language Classifier" caption-side="top"}
{: #actions-table68}
{: tab-title="Actions"}
{: tab-group="natural-language-classifier"}
{: class="simple-tab-table"}

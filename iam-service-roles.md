...
| Viewer | As a viewer, you can view service instances, but you can't modify them. |
{: row-headers}
{: caption="Table 20. Platform roles - IBM watsonx Code Assistant" caption-side="top"}
{: tab-title="Platform roles"}
...
{: caption="Table 20. Service actions - IBM watsonx Code Assistant" caption-side="top"}
{: tab-title="Actions"}
{: tab-group="code-assistant"}
{: class="simple-tab-table"}
{: summary="Use the tab buttons to change the context of the table. This table provides the available actions for the service, descriptions of each, and the roles that each action are mapped to."}
...
| Viewer | As a viewer, you can view service instances, but you can't modify them. |
{: row-headers}
{: caption="Table 22. Platform roles - Cognos Dashboard" caption-side="top"}
{: tab-title="Platform roles"}
...
| Writer | As a writer, you have permissions beyond the reader role, including creating and editing service-specific resources. |
{: row-headers}
{: caption="Table 22. Service roles - Cognos Dashboard" caption-side="top"}
{: tab-title="Service roles"}
{: tab-group="cognos-dashboard"}
{: class="simple-tab-table"}
{: summary="Use the tab buttons to change the context of the table. This table has row and column headers. The row headers provide the service role name and the column headers identify the specific information available about each role."}
...
{: caption="Table 22. Service actions - Cognos Dashboard" caption-side="top"}
{: tab-title="Actions"}
{: tab-group="cognos-dashboard"}
{: class="simple-tab-table"}
{: summary="Use the tab buttons to change the context of the table. This table provides the available actions for the service, descriptions of each, and the roles that each action are mapped to."}

...
| Viewer | As a viewer, you can view service instances, but you can't modify them. |
{: row-headers}
{: caption="Table 27. Platform roles - Converlistics" caption-side="top"}
...
{: caption="Table 27. Service actions - Converlistics" caption-side="top"}
{: #actions-table27}
{: tab-title="Actions"}
{: tab-group="converlistics"}
{: class="simple-tab-table"}
...
| Viewer | As a viewer, you can view service instances, but you can't modify them. |
{: row-headers}
{: caption="Table 28. Platform roles - Watson Assistant" caption-side="top"}
...
| Writer | As a writer, you have permissions beyond the reader role, including creating and editing service-specific resources. |
{: row-headers}
{: caption="Table 28. Service roles - Watson Assistant" caption-side="top"}
...
{: caption="Table 28. Service actions - Watson Assistant" caption-side="top"}
{: #actions-table28}
{: tab-title="Actions"}
{: tab-group="conversation"}
{: class="simple-tab-table"}
...
| Editor | As an editor, you can perform all platform actions except for managing the account and assigning access policies. |
{: row-headers}
{: caption="Table 29. Platform roles - IBM Cloud Pak for Data" caption-side="top"}
...
| Manage governance artifacts | Manage governance artifacts |
| Manager | As a manager, you have permissions beyond the writer role to complete privileged actions as defined by the service. In addition, you can create and edit service-specific resources. |
| Reporting Administrator | Reporting Administrator |
{: row-headers}
{: caption="Table 29. Service roles - IBM Cloud Pak for Data" caption-side="top"}
...
| `cp4d.glossary.admin` | Manage governance artifacts | Manage governance artifacts |
{: caption="Table 29. Service actions - IBM Cloud Pak for Data" caption-side="top"}
{: #actions-table29}
{: tab-title="Actions"}
{: tab-group="cp4d"}
{: class="simple-tab-table"}
...
| Viewer | As a viewer, you can view service instances, but you can't modify them. |
{: row-headers}
{: caption="Table 31. Platform roles - Db2 on Cloud" caption-side="top"}
...
| Manager | As a manager, you have permissions beyond the writer role to complete privileged actions as defined by the service. In addition, you can create and edit service-specific resources. |
{: row-headers}
{: caption="Table 31. Service roles - Db2 on Cloud" caption-side="top"}
...
| Viewer | As a viewer, you can view service instances, but you can't modify them. |
{: row-headers}
{: caption="Table 32. Platform roles - IBM Data Replication on Cloud" caption-side="top"}
...
| Writer | As a writer, you have permissions beyond the reader role, including creating and editing service-specific resources. |
{: row-headers}
{: caption="Table 32. Service roles - IBM Data Replication on Cloud" caption-side="top"}
...
{: caption="Table 32. Service actions - IBM Data Replication on Cloud" caption-side="top"}
{: #actions-table32}
{: tab-title="Actions"}
{: tab-group="data-replication"}
{: class="simple-tab-table"}
...
| Editor | As an editor, you can perform all platform actions except for managing the account and assigning access policies. |
{: row-headers}
{: caption="Table 78. Platform roles - Push Notifications" caption-side="top"}
...
| Writer | As a writer, you have permissions beyond the reader role, including creating and editing service-specific resources. |
{: row-headers}
{: caption="Table 78. Service roles - Push Notifications" caption-side="top"}
...
{: caption="Table 78. Service actions - Push Notifications" caption-side="top"}
{: #actions-table78}
{: tab-title="Actions"}
{: tab-group="imfpush"}
{: class="simple-tab-table"}
...
| Viewer | As a viewer, you can view service instances, but you can't modify them. |
{: row-headers}
{: caption="Table 99. Platform roles - Block Storage for VPC" caption-side="top"}
...
{: caption="Table 99. Service actions - Block Storage for VPC" caption-side="top"}
{: #actions-table99}
{: tab-title="Actions"}
{: tab-group="is.volume"}
{: class="simple-tab-table"}
...
| Viewer | As a viewer, you can view service instances, but you can't modify them. |
{: row-headers}
{: caption="Table 101. Platform roles - VPN for VPC" caption-side="top"}
...
{: caption="Table 101. Service actions - VPN for VPC" caption-side="top"}
{: #actions-table101}
{: tab-title="Actions"}
{: tab-group="is.vpn"}
{: class="simple-tab-table"}
...
| Viewer | As a viewer, you can view service instances, but you can't modify them. |
{: row-headers}
{: caption="Table 102. Platform roles - VPN Server for VPC" caption-side="top"}
...
{: row-headers}
{: caption="Table 102. Service roles - VPN Server for VPC" caption-side="top"}
...
{: caption="Table 102. Service actions - VPN Server for VPC" caption-side="top"}
{: #actions-table102}
{: tab-title="Actions"}
{: tab-group="is.vpn-server"}
{: class="simple-tab-table"}
...
| Writer | As a writer, you have permissions beyond the reader role, including creating and editing service-specific resources. |
{: row-headers}
{: caption="Table 103. Service roles - IBM Key Protect" caption-side="top"}
...
{: caption="Table 103. Service actions - IBM Key Protect" caption-side="top"}
{: #actions-table103}
{: tab-title="Actions"}
{: tab-group="kms"}
{: class="simple-tab-table"}
...
| Viewer | As a viewer, you can view service instances, but you can't modify them. |
{: row-headers}
{: caption="Table 104. Platform roles - Knowledge Studio" caption-side="top"}
...
| Writer | As a writer, you have permissions beyond the reader role, including creating and editing service-specific resources. |
{: row-headers}
{: caption="Table 104. Service roles - Knowledge Studio" caption-side="top"}
...
{: caption="Table 104. Service actions - Knowledge Studio" caption-side="top"}
{: #actions-table104}
{: tab-title="Actions"}
{: tab-group="knowledge-studio"}
{: class="simple-tab-table"}
...
| Writer | As a writer, you have permissions beyond the reader role, including creating and editing service-specific resources. |
{: row-headers}
{: caption="Table 105. Service roles - Language Translator" caption-side="top"}
...
{: caption="Table 105. Service actions - Language Translator" caption-side="top"}
{: #actions-table105}
{: tab-title="Actions"}
{: tab-group="language-translator"}
{: class="simple-tab-table"}
...
| Administrator | As an administrator, you can perform all platform actions based on the resource this role is being assigned, including assigning access policies to other users. |
{: row-headers}
{: caption="Table 106. Platform roles - IBM Log Analysis with LogDNA" caption-side="top"}
...
{: row-headers}
{: caption="Table 106. Service roles - IBM Log Analysis with LogDNA" caption-side="top"}
...
{: caption="Table 106. Service actions - IBM Log Analysis with LogDNA" caption-side="top"}
{: #actions-table106}
{: tab-title="Actions"}
{: tab-group="logdna"}
{: class="simple-tab-table"}
...
| Administrator | As an administrator, you can perform all platform actions based on the resource this role is being assigned, including assigning access policies to other users. |
{: row-headers}
{: caption="Table 107. Platform roles - IBM Cloud Activity Tracker with LogDNA" caption-side="top"}
...
| Standard member | As a member, you can configure views, dashboards and alerts, export data, search, filter, and view all data. |
{: row-headers}
{: caption="Table 107. Service roles - IBM Cloud Activity Tracker with LogDNA" caption-side="top"}
...
{: caption="Table 107. Service actions - IBM Cloud Activity Tracker with LogDNA" caption-side="top"}
{: #actions-table107}
{: tab-title="Actions"}
{: tab-group="logdnaat"}
{: class="simple-tab-table"}
...
| Viewer | As a viewer, you can view service instances, but you can't modify them. |
{: row-headers}
{: caption="Table 108. Platform roles - Managed Solutions" caption-side="top"}
...
| Writer | As a writer, you have permissions beyond the reader role, including creating and editing service-specific resources. |
{: row-headers}
{: caption="Table 108. Service roles - Managed Solutions" caption-side="top"}
...
{: caption="Table 108. Service actions - Managed Solutions" caption-side="top"}
{: #actions-table108}
{: tab-title="Actions"}
{: tab-group="managed-solutions"}
{: class="simple-tab-table"}
...
| Viewer | As a viewer, you can view service instances, but you can't modify them. |
{: row-headers}
{: caption="Table 113. Platform roles - Minio" caption-side="top"}
...
{: caption="Table 113. Service actions - Minio" caption-side="top"}
{: #actions-table113}
{: tab-title="Actions"}
{: tab-group="minio"}
{: class="simple-tab-table"}
...
| Viewer | As a viewer, you can view service instances, but you can't modify them. |
{: row-headers}
{: caption="Table 115. Platform roles - IBM Cloud Monitoring Service" caption-side="top"}
...
{: caption="Table 115. Service actions - IBM Cloud Monitoring Service" caption-side="top"}
{: #actions-table115}
{: tab-title="Actions"}
{: tab-group="monitoring"}
{: class="simple-tab-table"}
...
| Viewer | As a viewer, you can view service instances, but you can't modify them. |
{: row-headers}
{: caption="Table 116. Platform roles - IBM MQ" caption-side="top"}
...
| Writer | As a writer, you have permissions beyond the reader role, including creating and editing service-specific resources. |
{: row-headers}
{: caption="Table 116. Service roles - IBM MQ" caption-side="top"}
...
{: caption="Table 116. Service actions - IBM MQ" caption-side="top"}
{: #actions-table116}
{: tab-title="Actions"}
{: tab-group="mqcloud"}
{: class="simple-tab-table"}
...
| Viewer | As a viewer, you can view service instances, but you can't modify them. |
{: row-headers}
{: caption="Table 118. Platform roles - NeuralSeek" caption-side="top"}
...
{: caption="Table 118. Service actions - NeuralSeek" caption-side="top"}
{: #actions-table118}
{: tab-title="Actions"}
{: tab-group="neuralseek"}
{: class="simple-tab-table"}
...
| Viewer | As a viewer, you can view service instances, but you can't modify them. |
{: row-headers}
{: caption="Table 119. Platform roles - Partner Center" caption-side="top"}
...
{: caption="Table 119. Service actions - Partner Center" caption-side="top"}
{: #actions-table119}
{: tab-title="Actions"}
{: tab-group="partner-portal"}
{: class="simple-tab-table"}
...
| Operator | null |
{: row-headers}
{: caption="Table 120. Platform roles - Personality Insights" caption-side="top"}
...
| Writer | null |
{: row-headers}
{: caption="Table 120. Service roles - Personality Insights" caption-side="top"}
...
{: caption="Table 120. Service actions - Personality Insights" caption-side="top"}
{: #actions-table120}
{: tab-title="Actions"}
{: tab-group="personality-insights"}
{: class="simple-tab-table"}
...
| Viewer | As a viewer, you can view service instances, but you can't modify them. |
{: row-headers}
{: caption="Table 121. Platform roles - Planning Analytics" caption-side="top"}
...
{: row-headers}
{: caption="Table 121. Service roles - Planning Analytics" caption-side="top"}
...
{: caption="Table 121. Service actions - Planning Analytics" caption-side="top"}
{: #actions-table121}
{: tab-title="Actions"}
{: tab-group="planning-analytics"}
{: class="simple-tab-table"}
...
| Editor | As an editor, you can perform all platform actions except for managing the account and assigning access policies. |
{: row-headers}
{: caption="Table 122. Platform roles - Watson Machine Learning" caption-side="top"}
...
{: row-headers}
{: caption="Table 122. Service roles - Watson Machine Learning" caption-side="top"}
...
{: caption="Table 122. Service actions - Watson Machine Learning" caption-side="top"}
{: #actions-table122}
{: tab-title="Actions"}
{: tab-group="pm-20"}
{: class="simple-tab-table"}
...
| Operator | As an operator, you can perform platform actions required to configure and operate service instances, such as viewing a service's dashboard. |
{: row-headers}
{: caption="Table 123. Platform roles - Portworx Enterprise" caption-side="top"}
...
{: caption="Table 123. Service actions - Portworx Enterprise" caption-side="top"}
{: #actions-table123}
{: tab-title="Actions"}
{: tab-group="portworx"}
{: class="simple-tab-table"}
...
| Operator | As an operator, you can perform platform actions required to configure and operate service instances, such as viewing a service's dashboard. |
{: row-headers}
{: caption="Table 124. Platform roles - Portworx Test" caption-side="top"}
...
{: caption="Table 124. Service actions - Portworx Test" caption-side="top"}
{: #actions-table124}
{: tab-title="Actions"}
{: tab-group="portworx-test"}
{: class="simple-tab-table"}
...
| Operator | null |
{: row-headers}
{: caption="Table 125. Platform roles - PowerAI" caption-side="top"}
...
{: caption="Table 125. Service actions - PowerAI" caption-side="top"}
{: #actions-table125}
{: tab-title="Actions"}
{: tab-group="power-ai"}
{: class="simple-tab-table"}
...
| Reader | As a reader, you can perform read-only actions within a service such as viewing service-specific resources. |
{: row-headers}
{: caption="Table 126. Service roles - Power Systems Virtual Server" caption-side="top"}
...
{: caption="Table 126. Service actions - Power Systems Virtual Server" caption-side="top"}
{: #actions-table126}
{: tab-title="Actions"}
{: tab-group="power-iaas"}
{: class="simple-tab-table"}
...
| Viewer | As a viewer, you can view service instances, but you can't modify them. |
{: row-headers}
{: caption="Table 127. Platform roles - HDM Workload Migrator" caption-side="top"}
...
{: caption="Table 127. Service actions - HDM Workload Migrator" caption-side="top"}
{: #actions-table127}
{: tab-title="Actions"}
{: tab-group="primaryio-hdm-workload-migrator"}
{: class="simple-tab-table"}
...
| Operator | As an operator, you can perform platform actions required to configure and operate service instances, such as viewing a service's dashboard. |
{: row-headers}
{: caption="Table 128. Platform roles - Privileged Access Gateway" caption-side="top"}
...
| Writer | As a writer, you have permissions beyond the reader role, including creating and editing service-specific resources. |
{: row-headers}
{: caption="Table 128. Service roles - Privileged Access Gateway" caption-side="top"}
...
| Operator | As an operator, you can perform platform actions required to configure and operate service instances, such as viewing a service's dashboard. |
{: row-headers}
{: caption="Table 129. Platform roles - Product Lifecycle" caption-side="top"}
...
{: row-headers}
{: caption="Table 129. Service roles - Product Lifecycle" caption-side="top"}
...
{: caption="Table 129. Service actions - Product Lifecycle" caption-side="top"}
{: #actions-table129}
{: tab-title="Actions"}
{: tab-group="product-lifecycle"}
{: class="simple-tab-table"}
...
| Viewer | As a viewer, you can view service instances, but you can't modify them. |
{: row-headers}
{: caption="Table 130. Platform roles - PX-Backup By Portworx" caption-side="top"}
...
{: caption="Table 130. Service actions - PX-Backup By Portworx" caption-side="top"}
{: #actions-table130}
{: tab-title="Actions"}
{: tab-group="px-backup"}
{: class="simple-tab-table"}
...
| Writer | As a writer, you have permissions beyond the reader role, including creating and editing service-specific resources. |
{: row-headers}
{: caption="Table 131. Service roles - Quantum Services" caption-side="top"}
...
{: caption="Table 131. Service actions - Quantum Services" caption-side="top"}
{: #actions-table131}
{: tab-title="Actions"}
{: tab-group="quantum-computing"}
{: class="simple-tab-table"}
...
| Operator | As an operator, you can perform platform actions required to configure and operate service instances, such as viewing a service's dashboard. |
{: row-headers}
{: caption="Table 132. Platform roles - Raxak Protect" caption-side="top"}
...
{: caption="Table 132. Service actions - Raxak Protect" caption-side="top"}
{: #actions-table132}
{: tab-title="Actions"}
{: tab-group="raxak-protect"}
{: class="simple-tab-table"}
...
| Viewer | As a viewer, you can view service instances, but you can't modify them. |
{: row-headers}
{: caption="Table 133. Platform roles - Robin CNS" caption-side="top"}
...
{: caption="Table 133. Service actions - Robin CNS" caption-side="top"}
{: #actions-table133}
{: tab-title="Actions"}
{: tab-group="robin-storage"}
{: class="simple-tab-table"}
...
| Viewer | As a viewer, you can view service instances, but you can't modify them. |
{: row-headers}
{: caption="Table 134. Platform roles - IBM Cloud Satellite" caption-side="top"}
...
| Writer | As a writer, you have permissions beyond the reader role, including creating and editing service-specific resources. |
{: row-headers}
{: caption="Table 134. Service roles - IBM Cloud Satellite" caption-side="top"}
...
{: caption="Table 134. Service actions - IBM Cloud Satellite" caption-side="top"}
{: #actions-table134}
{: tab-title="Actions"}
{: tab-group="satellite"}
{: class="simple-tab-table"}
...
| Operator | As an operator, you can perform platform actions required to configure and operate service instances, such as viewing a service's dashboard. |
{: row-headers}
{: caption="Table 135. Platform roles - Satellite Infrastructure Services " caption-side="top"}
...
{: row-headers}
{: caption="Table 135. Service roles - Satellite Infrastructure Services " caption-side="top"}
...
{: caption="Table 135. Service actions - Satellite Infrastructure Services " caption-side="top"}
{: #actions-table135}
{: tab-title="Actions"}
{: tab-group="satellite-iaas"}
{: class="simple-tab-table"}
...
| Viewer | As a viewer, you can view service instances, but you can't modify them. |
{: row-headers}
{: caption="Table 136. Platform roles - Schematics" caption-side="top"}
...
| Writer | As a writer, you have permissions beyond the reader role, including creating and editing service-specific resources. |
{: row-headers}
{: caption="Table 136. Service roles - Schematics" caption-side="top"}
...
{: caption="Table 136. Service actions - Schematics" caption-side="top"}
{: #actions-table136}
{: tab-title="Actions"}
{: tab-group="schematics"}
{: class="simple-tab-table"}
...
| Operator | As an operator, you can perform platform actions required to configure and operate service instances, such as viewing a service's dashboard. |
{: row-headers}
{: caption="Table 137. Platform roles - Secrets Manager" caption-side="top"}
...
{: row-headers}
{: caption="Table 137. Service roles - Secrets Manager" caption-side="top"}
...
{: caption="Table 137. Service actions - Secrets Manager" caption-side="top"}
{: #actions-table137}
{: tab-title="Actions"}
{: tab-group="secrets-manager"}
{: class="simple-tab-table"}
...
| Operator | As an operator, you can perform platform actions required to configure and operate service instances, such as viewing a service's dashboard. |
{: row-headers}
{: caption="Table 138. Platform roles - Simulated Instruments Analytics API" caption-side="top"}
...
| Reader | As a reader, you can perform read-only actions within a service such as viewing service-specific resources. |
{: row-headers}
{: caption="Table 138. Service roles - Simulated Instruments Analytics API" caption-side="top"}
...
{: caption="Table 138. Service actions - Simulated Instruments Analytics API" caption-side="top"}
{: #actions-table138}
{: tab-title="Actions"}
{: tab-group="sia"}
{: class="simple-tab-table"}
...
| Operator | As an operator, you can perform platform actions required to configure and operate service instances, such as viewing a service's dashboard. |
{: row-headers}
{: caption="Table 139. Platform roles - Skytap On IBM Cloud" caption-side="top"}
...
{: caption="Table 139. Service actions - Skytap On IBM Cloud" caption-side="top"}
{: #actions-table139}
{: tab-title="Actions"}
{: tab-group="skytap"}
{: class="simple-tab-table"}
...
| Operator | As an operator, you can perform platform actions required to configure and operate service instances, such as viewing a service's dashboard. |
{: row-headers}
{: caption="Table 140. Platform roles - Speech to Text" caption-side="top"}
...
| Writer | As a writer, you have permissions beyond the reader role, including creating and editing service-specific resources. |
{: row-headers}
{: caption="Table 140. Service roles - Speech to Text" caption-side="top"}
...
{: caption="Table 140. Service actions - Speech to Text" caption-side="top"}
{: #actions-table140}
{: tab-title="Actions"}
{: tab-group="speech-to-text"}
{: class="simple-tab-table"}
...
| Writer | As a writer, you have permissions beyond the reader role, including creating and editing service-specific resources. |
{: row-headers}
{: caption="Table 141. Service roles - sql-query" caption-side="top"}
...
{: caption="Table 141. Service actions - sql-query" caption-side="top"}
{: #actions-table141}
{: tab-title="Actions"}
{: tab-group="sql-query"}
{: class="simple-tab-table"}
...
| null | null |
{: row-headers}
{: caption="Table 142. Service roles - streaming-analytics" caption-side="top"}
...
{: caption="Table 142. Service actions - streaming-analytics" caption-side="top"}
{: #actions-table142}
{: tab-title="Actions"}
{: tab-group="streaming-analytics"}
{: class="simple-tab-table"}
...
{: row-headers}
{: caption="Table 143. Platform roles - Support Center" caption-side="top"}
...
{: caption="Table 143. Service actions - Support Center" caption-side="top"}
{: #actions-table143}
{: tab-title="Actions"}
{: tab-group="support"}
{: class="simple-tab-table"}
...
{: row-headers}
{: caption="Table 144. Platform roles - IBM Cloud Monitoring with Sysdig" caption-side="top"}
...
{: row-headers}
{: caption="Table 144. Service roles - IBM Cloud Monitoring with Sysdig" caption-side="top"}
...
{: caption="Table 144. Service actions - IBM Cloud Monitoring with Sysdig" caption-side="top"}
{: #actions-table144}
{: tab-title="Actions"}
{: tab-group="sysdig-monitor"}
{: class="simple-tab-table"}
...
| Operator | As an operator, you can perform platform actions required to configure and operate service instances, such as viewing a service's dashboard. |
{: row-headers}
{: caption="Table 145. Platform roles - Text to Speech" caption-side="top"}
...
| Writer | As a writer, you have permissions beyond the reader role, including creating and editing service-specific resources. |
{: row-headers}
{: caption="Table 145. Service roles - Text to Speech" caption-side="top"}
...
{: caption="Table 145. Service actions - Text to Speech" caption-side="top"}
{: #actions-table145}
{: tab-title="Actions"}
{: tab-group="text-to-speech"}
{: class="simple-tab-table"}
...
| Operator | null |
{: row-headers}
{: caption="Table 146. Platform roles - Tone Analyzer" caption-side="top"}
...
| Writer | null |
{: row-headers}
{: caption="Table 146. Service roles - Tone Analyzer" caption-side="top"}
...
{: caption="Table 146. Service actions - Tone Analyzer" caption-side="top"}
{: #actions-table146}
{: tab-title="Actions"}
{: tab-group="tone-analyzer"}
{: class="simple-tab-table"}
...
| Viewer | As a viewer, you can view service instances, but you can't modify them. |
{: row-headers}
{: caption="Table 147. Platform roles - Toolchain" caption-side="top"}
...
{: caption="Table 147. Service actions - Toolchain" caption-side="top"}
{: #actions-table147}
{: tab-title="Actions"}
{: tab-group="toolchain"}
{: class="simple-tab-table"}
...
| Manager | As a manager, you have permissions beyond the writer role to complete privileged actions as defined by the service. In addition, you can create and edit service-specific resources. |
{: row-headers}
{: caption="Table 148. Service roles - Transit Gateway" caption-side="top"}
...
{: caption="Table 148. Service actions - Transit Gateway" caption-side="top"}
{: #actions-table148}
{: tab-title="Actions"}
{: tab-group="transit"}
{: class="simple-tab-table"}
...
| Viewer | As a viewer, you can view service instances, but you can't modify them. |
{: row-headers}
{: caption="Table 149. Platform roles - Transit Gateway" caption-side="top"}
...
{: caption="Table 149. Service actions - Transit Gateway" caption-side="top"}
{: #actions-table149}
{: tab-title="Actions"}
{: tab-group="transit.gateway"}
{: class="simple-tab-table"}
...
{: row-headers}
{: caption="Table 150. Platform roles - IBM Cloud Platform User Management Service" caption-side="top"}
...
{: caption="Table 150. Service actions - IBM Cloud Platform User Management Service" caption-side="top"}
{: #actions-table150}
{: tab-title="Actions"}
{: tab-group="user-management"}
{: class="simple-tab-table"}
...
| Viewer | As a viewer, you can view service instances, but you can't modify them. |
{: row-headers}
{: caption="Table 152. Platform roles - VMware Solutions" caption-side="top"}
...
| Writer | As a writer, you have permissions beyond the reader role, including creating and editing service-specific resources. |
{: row-headers}
{: caption="Table 152. Service roles - VMware Solutions" caption-side="top"}
...
{: caption="Table 152. Service actions - VMware Solutions" caption-side="top"}
{: #actions-table152}
{: tab-title="Actions"}
{: tab-group="vmware-solutions"}
{: class="simple-tab-table"}
...
| Viewer | As a viewer, you can view service instances, but you can't modify them. |
{: row-headers}
{: caption="Table 153. Platform roles - VMware Cloud Director" caption-side="top"}
...
| Writer | As a writer, you have permissions beyond the reader role, including creating and editing service-specific resources. |
{: row-headers}
{: caption="Table 153. Service roles - VMware Cloud Director" caption-side="top"}
...
{: caption="Table 153. Service actions - VMware Cloud Director" caption-side="top"}
{: #actions-table153}
{: tab-title="Actions"}
{: tab-group="vmware.directorsite"}
{: class="simple-tab-table"}
...
| Operator | As an operator, you can perform platform actions required to configure and operate service instances, such as viewing a service's dashboard. |
{: row-headers}
{: caption="Table 155. Platform roles - Voice Agent with Watson" caption-side="top"}
...
| Writer | As a writer, you have permissions beyond the reader role, including creating and editing service-specific resources. |
{: row-headers}
{: caption="Table 155. Service roles - Voice Agent with Watson" caption-side="top"}
...
{: caption="Table 155. Service actions - Voice Agent with Watson" caption-side="top"}
{: #actions-table155}
{: tab-title="Actions"}
{: tab-group="voiceagent"}
{: class="simple-tab-table"}
...
| Operator | As an operator, you can perform platform actions required to configure and operate service instances, such as viewing a service's dashboard. |
{: row-headers}
{: caption="Table 156. Platform roles - WebSphere Application Server" caption-side="top"}
...
{: caption="Table 156. Service actions - WebSphere Application Server" caption-side="top"}
{: #actions-table156}
{: tab-title="Actions"}
{: tab-group="websphereappsvr"}
{: class="simple-tab-table"}
...
| Operator | As an operator, you can perform platform actions required to configure and operate service instances, such as viewing a service's dashboard. |
{: row-headers}
{: caption="Table 157. Platform roles - Annotator for Clinical Data" caption-side="top"}
...
| Writer | As a writer, you have permissions beyond the reader role, including creating and editing service-specific resources. |
{: row-headers}
{: caption="Table 157. Service roles - Annotator for Clinical Data" caption-side="top"}
...
{: caption="Table 157. Service actions - Annotator for Clinical Data" caption-side="top"}
{: #actions-table157}
{: tab-title="Actions"}
{: tab-group="wh-acd"}
{: class="simple-tab-table"}

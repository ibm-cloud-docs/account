...
| Viewer | As a viewer, you can view service instances, but you can't modify them. |
{: row-headers}
{: caption="Table 20. Platform roles - Cognos Dashboard" caption-side="top"}
...
| Writer | As a writer, you have permissions beyond the reader role, including creating and editing service-specific resources. |
{: row-headers}
{: caption="Table 20. Service roles - Cognos Dashboard" caption-side="top"}
...
{: caption="Table 20. Service actions - Cognos Dashboard" caption-side="top"}
{: #actions-table20}
{: tab-title="Actions"}
{: tab-group="cognos-dashboard"}
{: class="simple-tab-table"}
...
| Viewer | As a viewer, you can view service instances, but you can't modify them. |
{: row-headers}
{: caption="Table 21. Platform roles - IBM Cloud Compliance and Security Center" caption-side="top"}
...
| Writer | As a writer, you have permissions beyond the reader role, including creating and editing service-specific resources. |
{: row-headers}
{: caption="Table 21. Service roles - IBM Cloud Compliance and Security Center" caption-side="top"}
...
{: caption="Table 21. Service actions - IBM Cloud Compliance and Security Center" caption-side="top"}
{: #actions-table21}
{: tab-title="Actions"}
{: tab-group="compliance"}
{: class="simple-tab-table"}
...
| Viewer | As a viewer, you can view service instances, but you can't modify them. |
{: row-headers}
{: caption="Table 22. Platform roles - Consult with IBM Cloud Garage" caption-side="top"}
...
| Writer | As a writer, you have permissions beyond the reader role, including creating and editing service-specific resources. |
{: row-headers}
{: caption="Table 22. Service roles - Consult with IBM Cloud Garage" caption-side="top"}
...
| Writer | As a writer, you have permissions beyond the reader role, including creating and editing service-specific resources. |
{: row-headers}
{: caption="Table 23. Service roles - Container Registry" caption-side="top"}
...
{: caption="Table 23. Service actions - Container Registry" caption-side="top"}
{: #actions-table23}
{: tab-title="Actions"}
{: tab-group="container-registry"}
{: class="simple-tab-table"}
...
| Viewer | As a viewer, you can view service instances, but you can't modify them. |
{: row-headers}
{: caption="Table 24. Platform roles - Kubernetes Service" caption-side="top"}
...
| Writer | As a writer, you have permissions beyond the reader role, including creating and editing service-specific resources. |
{: row-headers}
{: caption="Table 24. Service roles - Kubernetes Service" caption-side="top"}
...
{: caption="Table 24. Service actions - Kubernetes Service" caption-side="top"}
{: #actions-table24}
{: tab-title="Actions"}
{: tab-group="containers-kubernetes"}
{: class="simple-tab-table"}
...
| Viewer | As a viewer, you can view service instances, but you can't modify them. |
{: row-headers}
{: caption="Table 25. Platform roles - Context-Based Restrictions" caption-side="top"}
...
{: caption="Table 25. Service actions - Context-Based Restrictions" caption-side="top"}
{: #actions-table25}
{: tab-title="Actions"}
{: tab-group="context-based-restrictions"}
{: class="simple-tab-table"}
...
{: row-headers}
{: caption="Table 26. Platform roles - Continuous Delivery" caption-side="top"}
...
| Writer | As a writer, you have permissions beyond the reader role, including creating and editing service-specific resources. |
{: row-headers}
{: caption="Table 26. Service roles - Continuous Delivery" caption-side="top"}
...
{: caption="Table 26. Service actions - Continuous Delivery" caption-side="top"}
{: #actions-table26}
{: tab-title="Actions"}
{: tab-group="continuous-delivery"}
{: class="simple-tab-table"}
...
| Viewer | As a viewer, you can view service instances, but you can't modify them. |
{: row-headers}
{: caption="Table 27. Platform roles - Watson Assistant" caption-side="top"}
...
| Writer | As a writer, you have permissions beyond the reader role, including creating and editing service-specific resources. |
{: row-headers}
{: caption="Table 27. Service roles - Watson Assistant" caption-side="top"}
...
| Editor | As an editor, you can perform all platform actions except for managing the account and assigning access policies. |
{: row-headers}
{: caption="Table 28. Platform roles - IBM Cloud Pak for Data" caption-side="top"}
...
{: row-headers}
{: caption="Table 28. Service roles - IBM Cloud Pak for Data" caption-side="top"}
...
{: caption="Table 28. Service actions - IBM Cloud Pak for Data" caption-side="top"}
{: #actions-table28}
{: tab-title="Actions"}
{: tab-group="cp4d"}
{: class="simple-tab-table"}
...
| Writer | As a writer, you have permissions beyond the reader role, including creating and editing service-specific resources. |
{: row-headers}
{: caption="Table 29. Service roles - Db2 Warehouse" caption-side="top"}
...
{: caption="Table 29. Service actions - Db2 Warehouse" caption-side="top"}
{: #actions-table29}
{: tab-title="Actions"}
{: tab-group="dashdb"}
{: class="simple-tab-table"}
...
| Viewer | As a viewer, you can view service instances, but you can't modify them. |
{: row-headers}
{: caption="Table 30. Platform roles - Db2 on Cloud" caption-side="top"}
...
| Manager | As a manager, you have permissions beyond the writer role to complete privileged actions as defined by the service. In addition, you can create and edit service-specific resources. |
{: row-headers}
{: caption="Table 30. Service roles - Db2 on Cloud" caption-side="top"}
...
{: caption="Table 30. Service actions - Db2 on Cloud" caption-side="top"}
{: #actions-table30}
{: tab-title="Actions"}
{: tab-group="dashdb-for-transactions"}
{: class="simple-tab-table"}
...
| Viewer | As a viewer, you can view service instances, but you can't modify them. |
{: row-headers}
{: caption="Table 31. Platform roles - IBM Data Replication on Cloud" caption-side="top"}
...
| Writer | As a writer, you have permissions beyond the reader role, including creating and editing service-specific resources. |
{: row-headers}
{: caption="Table 31. Service roles - IBM Data Replication on Cloud" caption-side="top"}
...
{: caption="Table 31. Service actions - IBM Data Replication on Cloud" caption-side="top"}
{: #actions-table31}
{: tab-title="Actions"}
{: tab-group="data-replication"}
{: class="simple-tab-table"}
...
| Operator | As an operator, you can perform platform actions required to configure and operate service instances, such as viewing a service's dashboard. |
{: row-headers}
{: caption="Table 33. Platform roles - Data Shield" caption-side="top"}
...
{: caption="Table 33. Service actions - Data Shield" caption-side="top"}
{: #actions-table33}
{: tab-title="Actions"}
{: tab-group="data-shield"}
{: class="simple-tab-table"}
...
| Administrator | null |
{: row-headers}
{: caption="Table 34. Platform roles - Data Store for Memcache" caption-side="top"}
...
| Writer | null |
{: row-headers}
{: caption="Table 34. Service roles - Data Store for Memcache" caption-side="top"}
...
{: caption="Table 34. Service actions - Data Store for Memcache" caption-side="top"}
{: #actions-table34}
{: tab-title="Actions"}
{: tab-group="data-store-for-memcache"}
{: class="simple-tab-table"}
...
| Viewer | As a viewer, you can view service instances, but you can't modify them. |
{: row-headers}
{: caption="Table 35. Platform roles - Data Virtualization" caption-side="top"}
...
{: row-headers}
{: caption="Table 35. Service roles - Data Virtualization" caption-side="top"}
...
| `POST /v4/:platform/deployments/:deployment_id/db_updates` | Create db update | Administrator, Editor, Operator |
| `GET /v4/:platform/deployments/:deployment_id/check_updates` | Check deployment for available updates | Administrator, Editor, Operator, Viewer |
{: caption="Table 35. Service actions - Data Virtualization" caption-side="top"}
{: #actions-table35}
{: tab-title="Actions"}
{: tab-group="data-virtualization"}
{: class="simple-tab-table"}
...
| Viewer | As a viewer, you can view service instances, but you can't modify them. |
{: row-headers}
{: caption="Table 36. Platform roles - Netezza Performance Server" caption-side="top"}
...
| Writer | As a writer, you have permissions beyond the reader role, including creating and editing service-specific resources. |
{: row-headers}
{: caption="Table 36. Service roles - Netezza Performance Server" caption-side="top"}
...
{: caption="Table 36. Service actions - Netezza Performance Server" caption-side="top"}
{: #actions-table36}
{: tab-title="Actions"}
{: tab-group="data-warehouse"}
{: class="simple-tab-table"}
...
{: row-headers}
{: caption="Table 37. Platform roles - Databases for DataStax" caption-side="top"}
...
{: caption="Table 37. Service actions - Databases for DataStax" caption-side="top"}
{: #actions-table37}
{: tab-title="Actions"}
{: tab-group="databases-for-cassandra"}
{: class="simple-tab-table"}
...
| Viewer | As a viewer, you can view database instances but you can't make configuration changes. |
{: row-headers}
{: caption="Table 38. Platform roles - Databases for Elasticsearch" caption-side="top"}
...
| `deployment-capability.read` | Read a capability | Administrator, Editor, Operator, Viewer |
| `capability.read` | Read a capability | Administrator, Editor, Operator, Viewer |
{: caption="Table 38. Service actions - Databases for Elasticsearch" caption-side="top"}
{: #actions-table38}
{: tab-title="Actions"}
{: tab-group="databases-for-elasticsearch"}
{: class="simple-tab-table"}
...
| Viewer | As a viewer, you can view database instances but you can't make configuration changes. |
{: row-headers}
{: caption="Table 39. Platform roles - Databases for EDB" caption-side="top"}
...
| `deployment-capability.read` | Read a capability | Administrator, Editor, Operator, Viewer |
| `capability.read` | Read a capability | Administrator, Editor, Operator, Viewer |
{: caption="Table 39. Service actions - Databases for EDB" caption-side="top"}
{: #actions-table39}
{: tab-title="Actions"}
{: tab-group="databases-for-enterprisedb"}
{: class="simple-tab-table"}
...
| Viewer | As a viewer, you can view database instances but you can't make configuration changes. |
{: row-headers}
{: caption="Table 40. Platform roles - Databases for etcd" caption-side="top"}
...
| `deployment-capability.read` | Read a capability | Administrator, Editor, Operator, Viewer |
| `capability.read` | Read a capability | Administrator, Editor, Operator, Viewer |
{: caption="Table 40. Service actions - Databases for etcd" caption-side="top"}
{: #actions-table40}
{: tab-title="Actions"}
{: tab-group="databases-for-etcd"}
{: class="simple-tab-table"}
...
| Viewer | As a viewer, you can view database instances but you can't make configuration changes. |
{: row-headers}
{: caption="Table 41. Platform roles - Databases for MongoDB" caption-side="top"}
...
| `deployment-capability.read` | Read a capability | Administrator, Editor, Operator, Viewer |
| `capability.read` | Read a capability | Administrator, Editor, Operator, Viewer |
{: caption="Table 41. Service actions - Databases for MongoDB" caption-side="top"}
{: #actions-table41}
{: tab-title="Actions"}
{: tab-group="databases-for-mongodb"}
{: class="simple-tab-table"}
...
| Viewer | As a viewer, you can view database instances but you can't make configuration changes. |
{: row-headers}
{: caption="Table 42. Platform roles - Databases for MySQL" caption-side="top"}
...
| `deployment-capability.read` | Read a capability | Administrator, Editor, Operator, Viewer |
| `capability.read` | Read a capability | Administrator, Editor, Operator, Viewer |
{: caption="Table 42. Service actions - Databases for MySQL" caption-side="top"}
{: #actions-table42}
{: tab-title="Actions"}
{: tab-group="databases-for-mysql"}
{: class="simple-tab-table"}
...
| Viewer | As a viewer, you can view database instances but you can't make configuration changes. |
{: row-headers}
{: caption="Table 43. Platform roles - Databases for PostgreSQL" caption-side="top"}
...
| `deployment-capability.read` | Read a capability | Administrator, Editor, Operator, Viewer |
| `capability.read` | Read a capability | Administrator, Editor, Operator, Viewer |
{: caption="Table 43. Service actions - Databases for PostgreSQL" caption-side="top"}
{: #actions-table43}
{: tab-title="Actions"}
{: tab-group="databases-for-postgresql"}
{: class="simple-tab-table"}
...
| Viewer | As a viewer, you can view database instances but you can't make configuration changes. |
{: row-headers}
{: caption="Table 44. Platform roles - Databases for Redis" caption-side="top"}
...
| `deployment-capability.read` | Read a capability | Administrator, Editor, Operator, Viewer |
| `capability.read` | Read a capability | Administrator, Editor, Operator, Viewer |
{: caption="Table 44. Service actions - Databases for Redis" caption-side="top"}
{: #actions-table44}
{: tab-title="Actions"}
{: tab-group="databases-for-redis"}
{: class="simple-tab-table"}
...
| Administrator | As an administrator, you can perform all platform actions based on the resource this role is being assigned, including assigning access policies to other users. |
{: row-headers}
{: caption="Table 45. Platform roles - IBM Knowledge Catalog for Watson Data and AI" caption-side="top"}
...
| Writer | As a writer, you have permissions beyond the reader role, including creating and editing service-specific resources. |
{: row-headers}
{: caption="Table 45. Service roles - IBM Knowledge Catalog for Watson Data and AI" caption-side="top"}
...
{: caption="Table 45. Service actions - IBM Knowledge Catalog for Watson Data and AI" caption-side="top"}
{: #actions-table45}
{: tab-title="Actions"}
{: tab-group="datacatalog"}
{: class="simple-tab-table"}
...
| Operator | As an operator, you can perform platform actions required to configure and operate service instances, such as viewing a service's dashboard. |
{: row-headers}
{: caption="Table 46. Platform roles - DataStage" caption-side="top"}
...
| Reader | As a reader, you can perform read-only actions within a service such as viewing service-specific resources. |
{: row-headers}
{: caption="Table 46. Service roles - DataStage" caption-side="top"}
...
{: caption="Table 46. Service actions - DataStage" caption-side="top"}
{: #actions-table46}
{: tab-title="Actions"}
{: tab-group="datastage"}
{: class="simple-tab-table"}
...
| Viewer | As a viewer, you can view service instances, but you can't modify them. |
{: row-headers}
{: caption="Table 48. Platform roles - Direct Link Connect" caption-side="top"}
...
{: caption="Table 48. Service actions - Direct Link Connect" caption-side="top"}
{: #actions-table48}
{: tab-title="Actions"}
{: tab-group="directlink.connect"}
{: class="simple-tab-table"}
...
| Viewer | As a viewer, you can view service instances, but you can't modify them. |
{: row-headers}
{: caption="Table 49. Platform roles - Direct Link Dedicated" caption-side="top"}
...
{: caption="Table 49. Service actions - Direct Link Dedicated" caption-side="top"}
{: #actions-table49}
{: tab-title="Actions"}
{: tab-group="directlink.dedicated"}
{: class="simple-tab-table"}
...
| Writer | As a writer, you have permissions beyond the reader role, including creating and editing service-specific resources. |
{: row-headers}
{: caption="Table 50. Service roles - Discovery" caption-side="top"}
...
{: caption="Table 50. Service actions - Discovery" caption-side="top"}
{: #actions-table50}
{: tab-title="Actions"}
{: tab-group="discovery"}
{: class="simple-tab-table"}
...
| Viewer | As a viewer, you can view service instances, but you can't modify them. |
{: row-headers}
{: caption="Table 51. Platform roles - Dizzion DaaS" caption-side="top"}
...
{: caption="Table 51. Service actions - Dizzion DaaS" caption-side="top"}
{: #actions-table51}
{: tab-title="Actions"}
{: tab-group="dizziondaas"}
{: class="simple-tab-table"}
...
| Operator | As an operator, you can perform platform actions required to configure and operate service instances, such as viewing a service's dashboard. |
{: row-headers}
{: caption="Table 52. Platform roles - DNS Services" caption-side="top"}
...
| Writer | As a writer, you have permissions beyond the reader role, including creating and editing service-specific resources. |
{: row-headers}
{: caption="Table 52. Service roles - DNS Services" caption-side="top"}
...
{: caption="Table 52. Service actions - DNS Services" caption-side="top"}
{: #actions-table52}
{: tab-title="Actions"}
{: tab-group="dns-svcs"}
{: class="simple-tab-table"}
...
| null | null |
{: row-headers}
{: caption="Table 53. Service roles - Dynamic Dashboard Embedded" caption-side="top"}
...
{: caption="Table 53. Service actions - Dynamic Dashboard Embedded" caption-side="top"}
{: #actions-table53}
{: tab-title="Actions"}
{: tab-group="dynamic-dashboard-embedded"}
{: class="simple-tab-table"}
...
{: row-headers}
{: caption="Table 55. Platform roles - IBM Cloud Platform Enterprise Service" caption-side="top"}
...
{: row-headers}
{: caption="Table 55. Service roles - IBM Cloud Platform Enterprise Service" caption-side="top"}
...
{: caption="Table 55. Service actions - IBM Cloud Platform Enterprise Service" caption-side="top"}
{: #actions-table55}
{: tab-title="Actions"}
{: tab-group="enterprise"}
{: class="simple-tab-table"}
...
| Viewer | As a viewer, you can view service instances, but you can't modify them. |
{: row-headers}
{: caption="Table 57. Platform roles - Event Notifications" caption-side="top"}
...
| Writer | As a writer, you have permissions beyond the reader role, including creating and editing service-specific resources. |
{: row-headers}
{: caption="Table 57. Service roles - Event Notifications" caption-side="top"}
...
{: caption="Table 57. Service actions - Event Notifications" caption-side="top"}
{: #actions-table57}
{: tab-title="Actions"}
{: tab-group="event-notifications"}
{: class="simple-tab-table"}
...
| Writer | As a writer, you have permissions beyond the reader role, including creating and editing service-specific resources. |
{: row-headers}
{: caption="Table 58. Service roles - IBM Cloud Functions" caption-side="top"}
...
{: caption="Table 58. Service actions - IBM Cloud Functions" caption-side="top"}
{: #actions-table58}
{: tab-title="Actions"}
{: tab-group="functions"}
{: class="simple-tab-table"}
...
| Operator | As an operator, you can perform platform actions required to configure and operate service instances, such as viewing a service's dashboard. |
{: row-headers}
{: caption="Table 59. Platform roles - Globalization Pipeline" caption-side="top"}
...
| Writer | As a writer, you have permissions beyond the reader role, including creating and editing service-specific resources. |
{: row-headers}
{: caption="Table 59. Service roles - Globalization Pipeline" caption-side="top"}
...
{: caption="Table 59. Service actions - Globalization Pipeline" caption-side="top"}
{: #actions-table59}
{: tab-title="Actions"}
{: tab-group="g11n-pipeline"}
{: class="simple-tab-table"}
...
| Administrator | As an administrator, you can perform all platform actions based on the resource this role is being assigned, including assigning access policies to other users. |
{: row-headers}
{: caption="Table 61. Platform roles - GhoST Tagging Service" caption-side="top"}
...
{: caption="Table 61. Service actions - GhoST Tagging Service" caption-side="top"}
{: #actions-table61}
{: tab-title="Actions"}
{: tab-group="ghost-tags"}
{: class="simple-tab-table"}
...
{: row-headers}
{: caption="Table 62. Platform roles - Global Catalog" caption-side="top"}
...
{: caption="Table 62. Service actions - Global Catalog" caption-side="top"}
{: #actions-table62}
{: tab-title="Actions"}
{: tab-group="globalcatalog"}
{: class="simple-tab-table"}
...
| Administrator | As an administrator, you can perform all platform actions based on the resource this role is being assigned, including assigning access policies to other users. |
{: row-headers}
{: caption="Table 63. Platform roles - Personal Catalog" caption-side="top"}
...
{: caption="Table 63. Service actions - Personal Catalog" caption-side="top"}
{: #actions-table63}
{: tab-title="Actions"}
{: tab-group="globalcatalog-collection"}
{: class="simple-tab-table"}
...
| Viewer | As a viewer, you can view service instances, but you can't modify them. |
{: row-headers}
{: caption="Table 64. Platform roles - Instance Management" caption-side="top"}
...
{: caption="Table 64. Service actions - Instance Management" caption-side="top"}
{: #actions-table64}
{: tab-title="Actions"}
{: tab-group="globalcatalog-instance"}
{: class="simple-tab-table"}
...
| Operator | null |
{: row-headers}
{: caption="Table 65. Platform roles - HPCaaS from Rescale" caption-side="top"}
...
{: caption="Table 65. Service actions - HPCaaS from Rescale" caption-side="top"}
{: #actions-table65}
{: tab-title="Actions"}
{: tab-group="hpcaas-from-rescale-prod"}
{: class="simple-tab-table"}
...
| Operator | As an operator, you can perform platform actions required to configure and operate service instances, such as viewing a service's dashboard. |
{: row-headers}
{: caption="Table 66. Platform roles - Hyper Protect Virtual Server" caption-side="top"}
...
| Writer | As a writer, you have permissions beyond the reader role, including creating and editing service-specific resources. |
{: row-headers}
{: caption="Table 66. Service roles - Hyper Protect Virtual Server" caption-side="top"}
...
{: caption="Table 66. Service actions - Hyper Protect Virtual Server" caption-side="top"}
{: #actions-table66}
{: tab-title="Actions"}
{: tab-group="hpvs"}
{: class="simple-tab-table"}
...
| Viewer | As a viewer, you can view service instances, but you can't modify them. |
{: row-headers}
{: caption="Table 67. Platform roles - Hyper Protect Crypto Services" caption-side="top"}
...
| Writer | As a writer, you have permissions beyond the reader role, including creating and editing service-specific resources. |
{: row-headers}
{: caption="Table 67. Service roles - Hyper Protect Crypto Services" caption-side="top"}
...
{: caption="Table 67. Service actions - Hyper Protect Crypto Services" caption-side="top"}
{: #actions-table67}
{: tab-title="Actions"}
{: tab-group="hs-crypto"}
{: class="simple-tab-table"}
...
| Writer | As a writer, you have permissions beyond the reader role, including creating and editing service-specific resources. |
{: row-headers}
{: caption="Table 68. Service roles - Hyper Protect DBaaS for MongoDB " caption-side="top"}
...
{: caption="Table 68. Service actions - Hyper Protect DBaaS for MongoDB " caption-side="top"}
{: #actions-table68}
{: tab-title="Actions"}
{: tab-group="hyperp-dbaas-mongodb"}
{: class="simple-tab-table"}
...
| Writer | As a writer, you have permissions beyond the reader role, including creating and editing service-specific resources. |
{: row-headers}
{: caption="Table 69. Service roles - Hyper Protect DBaaS for PostgreSQL" caption-side="top"}
...
{: caption="Table 69. Service actions - Hyper Protect DBaaS for PostgreSQL" caption-side="top"}
{: #actions-table69}
{: tab-title="Actions"}
{: tab-group="hyperp-dbaas-postgresql"}
{: class="simple-tab-table"}
...
| Viewer | As a viewer, you can view service instances, but you can't modify them. |
{: row-headers}
{: caption="Table 70. Platform roles - IAM Access Management" caption-side="top"}
...
{: caption="Table 70. Service actions - IAM Access Management" caption-side="top"}
{: #actions-table70}
{: tab-title="Actions"}
{: tab-group="iam-access-management"}
{: class="simple-tab-table"}
...
| Viewer | As a viewer, you can view service instances, but you can't modify them. |
{: row-headers}
{: caption="Table 71. Platform roles - Role Management" caption-side="top"}
...
{: row-headers}
{: caption="Table 72. Platform roles - IAM Access Groups" caption-side="top"}
...
{: caption="Table 72. Service actions - IAM Access Groups" caption-side="top"}
{: #actions-table72}
{: tab-title="Actions"}
{: tab-group="iam-groups"}
{: class="simple-tab-table"}
...
{: row-headers}
{: caption="Table 73. Platform roles - IAM Identity Service" caption-side="top"}
...
{: row-headers}
{: caption="Table 73. Service roles - IAM Identity Service" caption-side="top"}
...
{: caption="Table 73. Service actions - IAM Identity Service" caption-side="top"}
{: #actions-table73}
{: tab-title="Actions"}
{: tab-group="iam-identity"}
{: class="simple-tab-table"}
...
| Viewer | As a viewer, you can view service instances, but you can't modify them. |
{: row-headers}
{: caption="Table 74. Platform roles - Identity and Access Management" caption-side="top"}
...
{: caption="Table 74. Service actions - Identity and Access Management" caption-side="top"}
{: #actions-table74}
{: tab-title="Actions"}
{: tab-group="iam-svcs"}
{: class="simple-tab-table"}
...
| Viewer | As a viewer, you can view service instances, but you can't modify them. |
{: row-headers}
{: caption="Table 75. Platform roles - Analytics Engine" caption-side="top"}
...
| Writer | As a writer, you have permissions beyond the reader role, including creating and editing service-specific resources. |
{: row-headers}
{: caption="Table 75. Service roles - Analytics Engine" caption-side="top"}
...
{: caption="Table 75. Service actions - Analytics Engine" caption-side="top"}
{: #actions-table75}
{: tab-title="Actions"}
{: tab-group="ibmanalyticsengine"}
{: class="simple-tab-table"}
...
| Viewer | null |
{: row-headers}
{: caption="Table 76. Platform roles - IBM Cloud Platform" caption-side="top"}
...
{: caption="Table 76. Service actions - IBM Cloud Platform" caption-side="top"}
{: #actions-table76}
{: tab-title="Actions"}
{: tab-group="ibmcloud-platform"}
{: class="simple-tab-table"}
...
| Editor | As an editor, you can perform all platform actions except for managing the account and assigning access policies. |
{: row-headers}
{: caption="Table 77. Platform roles - Push Notifications" caption-side="top"}
...
| Writer | As a writer, you have permissions beyond the reader role, including creating and editing service-specific resources. |
{: row-headers}
{: caption="Table 77. Service roles - Push Notifications" caption-side="top"}
...
{: caption="Table 77. Service actions - Push Notifications" caption-side="top"}
{: #actions-table77}
{: tab-title="Actions"}
{: tab-group="imfpush"}
{: class="simple-tab-table"}
...
| Writer | As a writer, you have permissions beyond the reader role, including creating and editing service-specific resources. |
{: row-headers}
{: caption="Table 78. Service roles - Cloud Internet Services" caption-side="top"}
...
{: caption="Table 78. Service actions - Cloud Internet Services" caption-side="top"}
{: #actions-table78}
{: tab-title="Actions"}
{: tab-group="internet-svcs"}
{: class="simple-tab-table"}
...
| Operator | As an operator, you can perform platform actions required to configure and operate service instances, such as viewing a service's dashboard. |
{: row-headers}
{: caption="Table 79. Platform roles - Internet of Things Platform" caption-side="top"}
...
{: caption="Table 79. Service actions - Internet of Things Platform" caption-side="top"}
{: #actions-table79}
{: tab-title="Actions"}
{: tab-group="iotf-service"}
{: class="simple-tab-table"}
...
{: row-headers}
{: caption="Table 81. Platform roles - Regional Backup as a Service for VPC" caption-side="top"}
...
{: caption="Table 81. Service actions - Regional Backup as a Service for VPC" caption-side="top"}
{: #actions-table81}
{: tab-title="Actions"}
{: tab-group="is.backup-policy"}
{: class="simple-tab-table"}
...
{: row-headers}
{: caption="Table 82. Platform roles - Bare Metal Server for VPC" caption-side="top"}
...
{: row-headers}
{: caption="Table 82. Service roles - Bare Metal Server for VPC" caption-side="top"}
...
| Viewer | As a viewer, you can view service instances, but you can't modify them. |
{: row-headers}
{: caption="Table 83. Platform roles - Dedicated Host for VPC" caption-side="top"}
...
{: caption="Table 83. Service actions - Dedicated Host for VPC" caption-side="top"}
{: #actions-table83}
{: tab-title="Actions"}
{: tab-group="is.dedicated-host"}
{: class="simple-tab-table"}
...
{: row-headers}
{: caption="Table 84. Platform roles - Virtual Private Endpoint for VPC" caption-side="top"}
...
{: caption="Table 84. Service actions - Virtual Private Endpoint for VPC" caption-side="top"}
{: #actions-table84}
{: tab-title="Actions"}
{: tab-group="is.endpoint-gateway"}
{: class="simple-tab-table"}
...
| Viewer | As a viewer, you can view service instances, but you can't modify them. |
{: row-headers}
{: caption="Table 85. Platform roles - Floating IP for VPC" caption-side="top"}
...
{: caption="Table 85. Service actions - Floating IP for VPC" caption-side="top"}
{: #actions-table85}
{: tab-title="Actions"}
{: tab-group="is.floating-ip"}
{: class="simple-tab-table"}
...
| Viewer | As a viewer, you can view service instances, but you can't modify them. |
{: row-headers}
{: caption="Table 86. Platform roles - IBM Cloud Flow Logs for VPC" caption-side="top"}
...
{: caption="Table 86. Service actions - IBM Cloud Flow Logs for VPC" caption-side="top"}
{: #actions-table86}
{: tab-title="Actions"}
{: tab-group="is.flow-log-collector"}
{: class="simple-tab-table"}
...
| Viewer | As a viewer, you can view service instances, but you can't modify them. |
{: row-headers}
{: caption="Table 87. Platform roles - Image Service for VPC" caption-side="top"}
...
| Viewer | As a viewer, you can view service instances, but you can't modify them. |
{: row-headers}
{: caption="Table 88. Platform roles - Virtual Server for VPC" caption-side="top"}
...
{: row-headers}
{: caption="Table 88. Service roles - Virtual Server for VPC" caption-side="top"}
...
{: caption="Table 88. Service actions - Virtual Server for VPC" caption-side="top"}
{: #actions-table88}
{: tab-title="Actions"}
{: tab-group="is.instance"}
{: class="simple-tab-table"}
...
| Viewer | As a viewer, you can view service instances, but you can't modify them. |
{: row-headers}
{: caption="Table 89. Platform roles - Auto Scale for VPC" caption-side="top"}
...
{: caption="Table 89. Service actions - Auto Scale for VPC" caption-side="top"}
{: #actions-table89}
{: tab-title="Actions"}
{: tab-group="is.instance-group"}
{: class="simple-tab-table"}
...
| Viewer | As a viewer, you can view service instances, but you can't modify them. |
{: row-headers}
{: caption="Table 90. Platform roles - SSH Key for VPC" caption-side="top"}
...
{: caption="Table 90. Service actions - SSH Key for VPC" caption-side="top"}
{: #actions-table90}
{: tab-title="Actions"}
{: tab-group="is.key"}
{: class="simple-tab-table"}
...
| Viewer | As a viewer, you can view service instances, but you can't modify them. |
{: row-headers}
{: caption="Table 91. Platform roles - Load Balancer for VPC" caption-side="top"}
...
{: caption="Table 91. Service actions - Load Balancer for VPC" caption-side="top"}
{: #actions-table91}
{: tab-title="Actions"}
{: tab-group="is.load-balancer"}
{: class="simple-tab-table"}
...
| Viewer | As a viewer, you can view service instances, but you can't modify them. |
{: row-headers}
{: caption="Table 92. Platform roles - Network ACL" caption-side="top"}
...
{: caption="Table 92. Service actions - Network ACL" caption-side="top"}
{: #actions-table92}
{: tab-title="Actions"}
{: tab-group="is.network-acl"}
{: class="simple-tab-table"}
...
| Viewer | As a viewer, you can view service instances, but you can't modify them. |
{: row-headers}
{: caption="Table 93. Platform roles - Placement Groups for VPC" caption-side="top"}
...
{: caption="Table 93. Service actions - Placement Groups for VPC" caption-side="top"}
{: #actions-table93}
{: tab-title="Actions"}
{: tab-group="is.placement-group"}
{: class="simple-tab-table"}
...
| Viewer | As a viewer, you can view service instances, but you can't modify them. |
{: row-headers}
{: caption="Table 94. Platform roles - Public Gateway" caption-side="top"}
...
{: caption="Table 94. Service actions - Public Gateway" caption-side="top"}
{: #actions-table94}
{: tab-title="Actions"}
{: tab-group="is.public-gateway"}
{: class="simple-tab-table"}
...
| Viewer | As a viewer, you can view service instances, but you can't modify them. |
{: row-headers}
{: caption="Table 95. Platform roles - Security Group for VPC" caption-side="top"}
...
{: caption="Table 95. Service actions - Security Group for VPC" caption-side="top"}
{: #actions-table95}
{: tab-title="Actions"}
{: tab-group="is.security-group"}
{: class="simple-tab-table"}
...
{: row-headers}
{: caption="Table 96. Platform roles - Block Storage Snapshots for VPC" caption-side="top"}
...
{: caption="Table 96. Service actions - Block Storage Snapshots for VPC" caption-side="top"}
{: #actions-table96}
{: tab-title="Actions"}
{: tab-group="is.snapshot"}
{: class="simple-tab-table"}
...
| Viewer | As a viewer, you can view service instances, but you can't modify them. |
{: row-headers}
{: caption="Table 97. Platform roles - Subnet" caption-side="top"}
...
{: caption="Table 97. Service actions - Subnet" caption-side="top"}
{: #actions-table97}
{: tab-title="Actions"}
{: tab-group="is.subnet"}
{: class="simple-tab-table"}
...
| Viewer | As a viewer, you can view service instances, but you can't modify them. |
{: row-headers}
{: caption="Table 98. Platform roles - Block Storage for VPC" caption-side="top"}
...
{: caption="Table 98. Service actions - Block Storage for VPC" caption-side="top"}
{: #actions-table98}
{: tab-title="Actions"}
{: tab-group="is.volume"}
{: class="simple-tab-table"}
...
| Viewer | As a viewer, you can view service instances, but you can't modify them. |
{: row-headers}
{: caption="Table 99. Platform roles - Virtual Private Cloud" caption-side="top"}
...
{: caption="Table 99. Service actions - Virtual Private Cloud" caption-side="top"}
{: #actions-table99}
{: tab-title="Actions"}
{: tab-group="is.vpc"}
{: class="simple-tab-table"}
...
| Viewer | As a viewer, you can view service instances, but you can't modify them. |
{: row-headers}
{: caption="Table 101. Platform roles - VPN Server for VPC" caption-side="top"}
...
{: row-headers}
{: caption="Table 101. Service roles - VPN Server for VPC" caption-side="top"}
...
{: caption="Table 101. Service actions - VPN Server for VPC" caption-side="top"}
{: #actions-table101}
{: tab-title="Actions"}
{: tab-group="is.vpn-server"}
{: class="simple-tab-table"}
...
| Writer | As a writer, you have permissions beyond the reader role, including creating and editing service-specific resources. |
{: row-headers}
{: caption="Table 102. Service roles - IBM Key Protect" caption-side="top"}
...
{: caption="Table 102. Service actions - IBM Key Protect" caption-side="top"}
{: #actions-table102}
{: tab-title="Actions"}
{: tab-group="kms"}
{: class="simple-tab-table"}
...
| Viewer | As a viewer, you can view service instances, but you can't modify them. |
{: row-headers}
{: caption="Table 103. Platform roles - Knowledge Studio" caption-side="top"}
...
| Writer | As a writer, you have permissions beyond the reader role, including creating and editing service-specific resources. |
{: row-headers}
{: caption="Table 103. Service roles - Knowledge Studio" caption-side="top"}
...
{: caption="Table 103. Service actions - Knowledge Studio" caption-side="top"}
{: #actions-table103}
{: tab-title="Actions"}
{: tab-group="knowledge-studio"}
{: class="simple-tab-table"}
...
| Writer | As a writer, you have permissions beyond the reader role, including creating and editing service-specific resources. |
{: row-headers}
{: caption="Table 104. Service roles - Language Translator" caption-side="top"}
...
{: caption="Table 104. Service actions - Language Translator" caption-side="top"}
{: #actions-table104}
{: tab-title="Actions"}
{: tab-group="language-translator"}
{: class="simple-tab-table"}
...
| Administrator | As an administrator, you can perform all platform actions based on the resource this role is being assigned, including assigning access policies to other users. |
{: row-headers}
{: caption="Table 105. Platform roles - IBM Log Analysis with LogDNA" caption-side="top"}
...
{: row-headers}
{: caption="Table 105. Service roles - IBM Log Analysis with LogDNA" caption-side="top"}
...
{: caption="Table 105. Service actions - IBM Log Analysis with LogDNA" caption-side="top"}
{: #actions-table105}
{: tab-title="Actions"}
{: tab-group="logdna"}
{: class="simple-tab-table"}
...
| Administrator | As an administrator, you can perform all platform actions based on the resource this role is being assigned, including assigning access policies to other users. |
{: row-headers}
{: caption="Table 106. Platform roles - IBM Cloud Activity Tracker with LogDNA" caption-side="top"}
...
| Standard member | As a member, you can configure views, dashboards and alerts, export data, search, filter, and view all data. |
{: row-headers}
{: caption="Table 106. Service roles - IBM Cloud Activity Tracker with LogDNA" caption-side="top"}
...
{: caption="Table 106. Service actions - IBM Cloud Activity Tracker with LogDNA" caption-side="top"}
{: #actions-table106}
{: tab-title="Actions"}
{: tab-group="logdnaat"}
{: class="simple-tab-table"}
...
| Viewer | As a viewer, you can view service instances, but you can't modify them. |
{: row-headers}
{: caption="Table 107. Platform roles - Managed Solutions" caption-side="top"}
...
| Writer | As a writer, you have permissions beyond the reader role, including creating and editing service-specific resources. |
{: row-headers}
{: caption="Table 107. Service roles - Managed Solutions" caption-side="top"}
...
{: caption="Table 107. Service actions - Managed Solutions" caption-side="top"}
{: #actions-table107}
{: tab-title="Actions"}
{: tab-group="managed-solutions"}
{: class="simple-tab-table"}
...
| Operator | As an operator, you can perform platform actions required to configure and operate service instances, such as viewing a service's dashboard. |
{: row-headers}
{: caption="Table 108. Platform roles - Mass Data Migration" caption-side="top"}
...
| Writer | As a writer, you have permissions beyond the reader role, including creating and editing service-specific resources. |
{: row-headers}
{: caption="Table 108. Service roles - Mass Data Migration" caption-side="top"}
...
{: caption="Table 108. Service actions - Mass Data Migration" caption-side="top"}
{: #actions-table108}
{: tab-title="Actions"}
{: tab-group="mass-data-migration"}
{: class="simple-tab-table"}
...
| Viewer | As a viewer, you can view service instances, but you can't modify them. |
{: row-headers}
{: caption="Table 109. Platform roles - Master Data Connect" caption-side="top"}
...
| Writer | As a writer, you have permissions beyond the reader role, including creating and editing service-specific resources. |
{: row-headers}
{: caption="Table 109. Service roles - Master Data Connect" caption-side="top"}
...
| Action | Description | Roles |
| ----- | :----- | :----- |
| `mdm-oc.dashboard.view` | View Dashboard | Administrator, Configurator Manager, Configurator Reader, Data Manager, Data Reader, Data Steward, Data Writer, Editor, Entity Viewer, Job Reader, Job Writer, Manager, Matching Manager, Matching Reader, Matching Writer, Model Manager, Model Reader, Model Writer, Operator, Pair Analysis Reader, Pair Analysis Writer, Publisher User, Reader, Viewer, Writer |
...
| `mdm-oc.data.read` | Read access to the Master Data Management Data microservice. | Administrator, Data Manager, Data Reader, Data Steward, Data Writer, Editor, Entity Viewer, Manager, Operator, Publisher User, Reader, Viewer, Writer |
| `mdm-oc.data.write` | Write access to the Master Data Management Data microservice. | Administrator, Data Manager, Data Steward, Data Writer, Manager, Publisher User, Writer |
| `mdm-oc.data.manage` | Manage access to the Master Data Management Data microservice. | Administrator, Data Manager, Manager, Publisher User |
| `mdm-oc.matching.read` | Read access to the Master Data Management Matching microservice. | Administrator, Data Steward, Editor, Entity Viewer, Manager, Matching Reader, Operator, Reader, Viewer, Writer |
| `mdm-oc.matching.write` | Write access to the Master Data Management Matching microservice. | Administrator, Data Steward, Manager, Matching Reader, Matching Writer, Writer |
| `mdm-oc.matching.manage` | Manage access to the Master Data Management Matching microservice. | Administrator, Manager, Matching Manager |
| `mdm-oc.model.read` | Read access to the Master Data Management Model microservice. | Administrator, Data Steward, Editor, Entity Viewer, Manager, Model Manager, Model Reader, Model Writer, Operator, Publisher User, Reader, Viewer, Writer |
| `mdm-oc.model.write` | Write access to the Master Data Management Model microservice. | Administrator, Data Reader, Manager, Model Manager, Model Writer, Publisher User, Writer |
| `mdm-oc.configurator.read` | Read access to the Master Data Management Configurator microservice. | Administrator, Configurator Manager, Configurator Reader, Editor, Manager, Operator, Viewer, Writer |
| `mdm-oc.configurator.manage` | Manage access to the Master Data Management Configurator microservice. | Administrator, Configurator Manager, Manager |
...
| `mdm-oc.pairs-analysis.write` | Write access to the Master Data Management Pair Analysis microservice. | Administrator, Manager, Pair Analysis Writer, Writer |
| `mdm-oc.job.write` | Write access to the Master Data Management Job microservice. | Administrator, Job Writer, Manager, Writer |
| `mdm-oc.job.read` | Read access to the Master Data Management Job microservice. | Administrator, Data Steward, Editor, Entity Viewer, Job Reader, Job Writer, Manager, Operator, Publisher User, Reader, Viewer, Writer |
| `mdm-oc.model.manage` | Manage access to the Master Data Management Model microservice. | Administrator, Manager, Model Manager, Publisher User |
| `mdm-oc.matching.datasteward` | Data Steward access to the Master Data Management. | Data Steward, Manager |
{: caption="Table 109. Service actions - Master Data Connect" caption-side="top"}
{: #actions-table109}
{: tab-title="Actions"}
{: tab-group="mdm-oc"}
{: class="simple-tab-table"}
...
| Writer | As a writer, you have permissions beyond the reader role, including creating and editing service-specific resources. |
{: row-headers}
{: caption="Table 110. Service roles - Event Streams" caption-side="top"}
...
{: caption="Table 110. Service actions - Event Streams" caption-side="top"}
{: #actions-table110}
{: tab-title="Actions"}
{: tab-group="messagehub"}
{: class="simple-tab-table"}
...
| Viewer | As a viewer, you can view database instances but you can't make configuration changes. |
{: row-headers}
{: caption="Table 111. Platform roles - Messages for RabbitMQ" caption-side="top"}
...
| `deployment-capability.read` | Read a capability | Administrator, Editor, Operator, Viewer |
| `capability.read` | Read a capability | Administrator, Editor, Operator, Viewer |
{: caption="Table 111. Service actions - Messages for RabbitMQ" caption-side="top"}
{: #actions-table111}
{: tab-title="Actions"}
{: tab-group="messages-for-rabbitmq"}
{: class="simple-tab-table"}
...
| Viewer | As a viewer, you can view service instances, but you can't modify them. |
{: row-headers}
{: caption="Table 112. Platform roles - Migration Services for IBM Cloud" caption-side="top"}
...
{: caption="Table 112. Service actions - Migration Services for IBM Cloud" caption-side="top"}
{: #actions-table112}
{: tab-title="Actions"}
{: tab-group="migrationtool-from-wanclds"}
{: class="simple-tab-table"}
...
| Viewer | As a viewer, you can view service instances, but you can't modify them. |
{: row-headers}
{: caption="Table 114. Platform roles - IBM Cloud Monitoring Service" caption-side="top"}
...
{: caption="Table 114. Service actions - IBM Cloud Monitoring Service" caption-side="top"}
{: #actions-table114}
{: tab-title="Actions"}
{: tab-group="monitoring"}
{: class="simple-tab-table"}
...
| Viewer | As a viewer, you can view service instances, but you can't modify them. |
{: row-headers}
{: caption="Table 115. Platform roles - IBM MQ" caption-side="top"}
...
| Writer | As a writer, you have permissions beyond the reader role, including creating and editing service-specific resources. |
{: row-headers}
{: caption="Table 115. Service roles - IBM MQ" caption-side="top"}
...
{: caption="Table 115. Service actions - IBM MQ" caption-side="top"}
{: #actions-table115}
{: tab-title="Actions"}
{: tab-group="mqcloud"}
{: class="simple-tab-table"}
...
| Viewer | null |
{: row-headers}
{: caption="Table 116. Platform roles - Natural Language Classifier" caption-side="top"}
...
| Writer | null |
{: row-headers}
{: caption="Table 116. Service roles - Natural Language Classifier" caption-side="top"}
...
{: caption="Table 116. Service actions - Natural Language Classifier" caption-side="top"}
{: #actions-table116}
{: tab-title="Actions"}
{: tab-group="natural-language-classifier"}
{: class="simple-tab-table"}
...
| Operator | As an operator, you can perform platform actions required to configure and operate service instances, such as viewing a service's dashboard. |
{: row-headers}
{: caption="Table 117. Platform roles - Natural Language Understanding" caption-side="top"}
...
| Writer | As a writer, you have permissions beyond the reader role, including creating and editing service-specific resources. |
{: row-headers}
{: caption="Table 117. Service roles - Natural Language Understanding" caption-side="top"}
...
{: caption="Table 117. Service actions - Natural Language Understanding" caption-side="top"}
{: #actions-table117}
{: tab-title="Actions"}
{: tab-group="natural-language-understanding"}
{: class="simple-tab-table"}
...
| Viewer | As a viewer, you can view service instances, but you can't modify them. |
{: row-headers}
{: caption="Table 118. Platform roles - Partner Center" caption-side="top"}
...
{: caption="Table 118. Service actions - Partner Center" caption-side="top"}
{: #actions-table118}
{: tab-title="Actions"}
{: tab-group="partner-portal"}
{: class="simple-tab-table"}
...
| Operator | null |
{: row-headers}
{: caption="Table 119. Platform roles - Personality Insights" caption-side="top"}
...
| Writer | null |
{: row-headers}
{: caption="Table 119. Service roles - Personality Insights" caption-side="top"}
...
{: caption="Table 119. Service actions - Personality Insights" caption-side="top"}
{: #actions-table119}
{: tab-title="Actions"}
{: tab-group="personality-insights"}
{: class="simple-tab-table"}
...
| Editor | As an editor, you can perform all platform actions except for managing the account and assigning access policies. |
{: row-headers}
{: caption="Table 120. Platform roles - Watson Machine Learning" caption-side="top"}
...
{: row-headers}
{: caption="Table 120. Service roles - Watson Machine Learning" caption-side="top"}
...
{: caption="Table 120. Service actions - Watson Machine Learning" caption-side="top"}
{: #actions-table120}
{: tab-title="Actions"}
{: tab-group="pm-20"}
{: class="simple-tab-table"}
...
| Operator | As an operator, you can perform platform actions required to configure and operate service instances, such as viewing a service's dashboard. |
{: row-headers}
{: caption="Table 121. Platform roles - Portworx Enterprise" caption-side="top"}
...
{: caption="Table 121. Service actions - Portworx Enterprise" caption-side="top"}
{: #actions-table121}
{: tab-title="Actions"}
{: tab-group="portworx"}
{: class="simple-tab-table"}
...
| Operator | As an operator, you can perform platform actions required to configure and operate service instances, such as viewing a service's dashboard. |
{: row-headers}
{: caption="Table 122. Platform roles - Portworx Test" caption-side="top"}
...
{: caption="Table 122. Service actions - Portworx Test" caption-side="top"}
{: #actions-table122}
{: tab-title="Actions"}
{: tab-group="portworx-test"}
{: class="simple-tab-table"}
...
| Operator | null |
{: row-headers}
{: caption="Table 123. Platform roles - PowerAI" caption-side="top"}
...
{: caption="Table 123. Service actions - PowerAI" caption-side="top"}
{: #actions-table123}
{: tab-title="Actions"}
{: tab-group="power-ai"}
{: class="simple-tab-table"}
...
| Reader | As a reader, you can perform read-only actions within a service such as viewing service-specific resources. |
{: row-headers}
{: caption="Table 124. Service roles - Power Systems Virtual Server" caption-side="top"}
...
{: caption="Table 124. Service actions - Power Systems Virtual Server" caption-side="top"}
{: #actions-table124}
{: tab-title="Actions"}
{: tab-group="power-iaas"}
{: class="simple-tab-table"}
...
| Viewer | As a viewer, you can view service instances, but you can't modify them. |
{: row-headers}
{: caption="Table 125. Platform roles - HDM Workload Migrator" caption-side="top"}
...
{: caption="Table 125. Service actions - HDM Workload Migrator" caption-side="top"}
{: #actions-table125}
{: tab-title="Actions"}
{: tab-group="primaryio-hdm-workload-migrator"}
{: class="simple-tab-table"}
...
| Operator | As an operator, you can perform platform actions required to configure and operate service instances, such as viewing a service's dashboard. |
{: row-headers}
{: caption="Table 126. Platform roles - Product Lifecycle" caption-side="top"}
...
{: row-headers}
{: caption="Table 126. Service roles - Product Lifecycle" caption-side="top"}
...
| Viewer | As a viewer, you can view service instances, but you can't modify them. |
{: row-headers}
{: caption="Table 127. Platform roles - PX-Backup By Portworx" caption-side="top"}
...
{: caption="Table 127. Service actions - PX-Backup By Portworx" caption-side="top"}
{: #actions-table127}
{: tab-title="Actions"}
{: tab-group="px-backup"}
{: class="simple-tab-table"}
...
| Writer | As a writer, you have permissions beyond the reader role, including creating and editing service-specific resources. |
{: row-headers}
{: caption="Table 128. Service roles - Quantum Services" caption-side="top"}
...
{: caption="Table 128. Service actions - Quantum Services" caption-side="top"}
{: #actions-table128}
{: tab-title="Actions"}
{: tab-group="quantum-computing"}
{: class="simple-tab-table"}
...
| Operator | As an operator, you can perform platform actions required to configure and operate service instances, such as viewing a service's dashboard. |
{: row-headers}
{: caption="Table 129. Platform roles - Raxak Protect" caption-side="top"}
...
{: caption="Table 129. Service actions - Raxak Protect" caption-side="top"}
{: #actions-table129}
{: tab-title="Actions"}
{: tab-group="raxak-protect"}
{: class="simple-tab-table"}
...
| Viewer | As a viewer, you can view service instances, but you can't modify them. |
{: row-headers}
{: caption="Table 130. Platform roles - Robin CNS" caption-side="top"}
...
{: caption="Table 130. Service actions - Robin CNS" caption-side="top"}
{: #actions-table130}
{: tab-title="Actions"}
{: tab-group="robin-storage"}
{: class="simple-tab-table"}
...
| Viewer | As a viewer, you can view service instances, but you can't modify them. |
{: row-headers}
{: caption="Table 131. Platform roles - IBM Cloud Satellite" caption-side="top"}
...
| Writer | As a writer, you have permissions beyond the reader role, including creating and editing service-specific resources. |
{: row-headers}
{: caption="Table 131. Service roles - IBM Cloud Satellite" caption-side="top"}
...
{: caption="Table 131. Service actions - IBM Cloud Satellite" caption-side="top"}
{: #actions-table131}
{: tab-title="Actions"}
{: tab-group="satellite"}
{: class="simple-tab-table"}
...
| Operator | As an operator, you can perform platform actions required to configure and operate service instances, such as viewing a service's dashboard. |
{: row-headers}
{: caption="Table 132. Platform roles - Satellite Infrastructure Services " caption-side="top"}
...
{: row-headers}
{: caption="Table 132. Service roles - Satellite Infrastructure Services " caption-side="top"}
...
{: caption="Table 132. Service actions - Satellite Infrastructure Services " caption-side="top"}
{: #actions-table132}
{: tab-title="Actions"}
{: tab-group="satellite-iaas"}
{: class="simple-tab-table"}
...
| Viewer | As a viewer, you can view service instances, but you can't modify them. |
{: row-headers}
{: caption="Table 133. Platform roles - Schematics" caption-side="top"}
...
| Writer | As a writer, you have permissions beyond the reader role, including creating and editing service-specific resources. |
{: row-headers}
{: caption="Table 133. Service roles - Schematics" caption-side="top"}
...
{: caption="Table 133. Service actions - Schematics" caption-side="top"}
{: #actions-table133}
{: tab-title="Actions"}
{: tab-group="schematics"}
{: class="simple-tab-table"}
...
| Operator | As an operator, you can perform platform actions required to configure and operate service instances, such as viewing a service's dashboard. |
{: row-headers}
{: caption="Table 134. Platform roles - Secrets Manager" caption-side="top"}
...
{: row-headers}
{: caption="Table 134. Service roles - Secrets Manager" caption-side="top"}
...
{: caption="Table 134. Service actions - Secrets Manager" caption-side="top"}
{: #actions-table134}
{: tab-title="Actions"}
{: tab-group="secrets-manager"}
{: class="simple-tab-table"}
...
| Operator | As an operator, you can perform platform actions required to configure and operate service instances, such as viewing a service's dashboard. |
{: row-headers}
{: caption="Table 135. Platform roles - Security Advisor" caption-side="top"}
...
| Writer | As a writer, you have permissions beyond the reader role, including creating and editing service-specific resources. |
{: row-headers}
{: caption="Table 135. Service roles - Security Advisor" caption-side="top"}
...
{: caption="Table 135. Service actions - Security Advisor" caption-side="top"}
{: #actions-table135}
{: tab-title="Actions"}
{: tab-group="security-advisor"}
{: class="simple-tab-table"}
...
| Operator | As an operator, you can perform platform actions required to configure and operate service instances, such as viewing a service's dashboard. |
{: row-headers}
{: caption="Table 136. Platform roles - Simulated Instruments Analytics API" caption-side="top"}
...
| Reader | As a reader, you can perform read-only actions within a service such as viewing service-specific resources. |
{: row-headers}
{: caption="Table 136. Service roles - Simulated Instruments Analytics API" caption-side="top"}
...
{: caption="Table 136. Service actions - Simulated Instruments Analytics API" caption-side="top"}
{: #actions-table136}
{: tab-title="Actions"}
{: tab-group="sia"}
{: class="simple-tab-table"}
...
| Operator | As an operator, you can perform platform actions required to configure and operate service instances, such as viewing a service's dashboard. |
{: row-headers}
{: caption="Table 137. Platform roles - Skytap On IBM Cloud" caption-side="top"}
...
{: caption="Table 137. Service actions - Skytap On IBM Cloud" caption-side="top"}
{: #actions-table137}
{: tab-title="Actions"}
{: tab-group="skytap"}
{: class="simple-tab-table"}
...
| Operator | As an operator, you can perform platform actions required to configure and operate service instances, such as viewing a service's dashboard. |
{: row-headers}
{: caption="Table 138. Platform roles - Speech to Text" caption-side="top"}
...
| Writer | As a writer, you have permissions beyond the reader role, including creating and editing service-specific resources. |
{: row-headers}
{: caption="Table 138. Service roles - Speech to Text" caption-side="top"}
...
{: caption="Table 138. Service actions - Speech to Text" caption-side="top"}
{: #actions-table138}
{: tab-title="Actions"}
{: tab-group="speech-to-text"}
{: class="simple-tab-table"}
...
| Writer | As a writer, you have permissions beyond the reader role, including creating and editing service-specific resources. |
{: row-headers}
{: caption="Table 139. Service roles - sql-query" caption-side="top"}
...
{: caption="Table 139. Service actions - sql-query" caption-side="top"}
{: #actions-table139}
{: tab-title="Actions"}
{: tab-group="sql-query"}
{: class="simple-tab-table"}
...
| null | null |
{: row-headers}
{: caption="Table 140. Service roles - streaming-analytics" caption-side="top"}
...
{: caption="Table 140. Service actions - streaming-analytics" caption-side="top"}
{: #actions-table140}
{: tab-title="Actions"}
{: tab-group="streaming-analytics"}
{: class="simple-tab-table"}
...
{: row-headers}
{: caption="Table 141. Platform roles - Support Center" caption-side="top"}
...
{: caption="Table 141. Service actions - Support Center" caption-side="top"}
{: #actions-table141}
{: tab-title="Actions"}
{: tab-group="support"}
{: class="simple-tab-table"}
...
| Administrator | As an administrator, you can perform all platform actions based on the resource this role is being assigned, including assigning access policies to other users. |
{: row-headers}
{: caption="Table 142. Platform roles - IBM Cloud Monitoring with Sysdig" caption-side="top"}
...
| Writer | As a writer, you have permissions beyond the reader role, including creating and editing service-specific resources. |
{: row-headers}
{: caption="Table 142. Service roles - IBM Cloud Monitoring with Sysdig" caption-side="top"}
...
{: caption="Table 142. Service actions - IBM Cloud Monitoring with Sysdig" caption-side="top"}
{: #actions-table142}
{: tab-title="Actions"}
{: tab-group="sysdig-monitor"}
{: class="simple-tab-table"}
...
| Operator | As an operator, you can perform platform actions required to configure and operate service instances, such as viewing a service's dashboard. |
{: row-headers}
{: caption="Table 143. Platform roles - Text to Speech" caption-side="top"}
...
| Writer | As a writer, you have permissions beyond the reader role, including creating and editing service-specific resources. |
{: row-headers}
{: caption="Table 143. Service roles - Text to Speech" caption-side="top"}
...
{: caption="Table 143. Service actions - Text to Speech" caption-side="top"}
{: #actions-table143}
{: tab-title="Actions"}
{: tab-group="text-to-speech"}
{: class="simple-tab-table"}
...
| Operator | null |
{: row-headers}
{: caption="Table 144. Platform roles - Tone Analyzer" caption-side="top"}
...
| Writer | null |
{: row-headers}
{: caption="Table 144. Service roles - Tone Analyzer" caption-side="top"}
...
{: caption="Table 144. Service actions - Tone Analyzer" caption-side="top"}
{: #actions-table144}
{: tab-title="Actions"}
{: tab-group="tone-analyzer"}
{: class="simple-tab-table"}
...
| Viewer | As a viewer, you can view service instances, but you can't modify them. |
{: row-headers}
{: caption="Table 145. Platform roles - Toolchain" caption-side="top"}
...
{: caption="Table 145. Service actions - Toolchain" caption-side="top"}
{: #actions-table145}
{: tab-title="Actions"}
{: tab-group="toolchain"}
{: class="simple-tab-table"}
...
| Manager | As a manager, you have permissions beyond the writer role to complete privileged actions as defined by the service. In addition, you can create and edit service-specific resources. |
{: row-headers}
{: caption="Table 146. Service roles - Transit Gateway" caption-side="top"}
...
{: caption="Table 146. Service actions - Transit Gateway" caption-side="top"}
{: #actions-table146}
{: tab-title="Actions"}
{: tab-group="transit"}
{: class="simple-tab-table"}
...
| Viewer | As a viewer, you can view service instances, but you can't modify them. |
{: row-headers}
{: caption="Table 147. Platform roles - Transit Gateway" caption-side="top"}
...
{: caption="Table 147. Service actions - Transit Gateway" caption-side="top"}
{: #actions-table147}
{: tab-title="Actions"}
{: tab-group="transit.gateway"}
{: class="simple-tab-table"}
...
{: row-headers}
{: caption="Table 148. Platform roles - IBM Cloud Platform User Management Service" caption-side="top"}
...
{: caption="Table 148. Service actions - IBM Cloud Platform User Management Service" caption-side="top"}
{: #actions-table148}
{: tab-title="Actions"}
{: tab-group="user-management"}
{: class="simple-tab-table"}
...
| Viewer | As a viewer, you can view service instances, but you can't modify them. |
{: row-headers}
{: caption="Table 149. Platform roles - VMware Solutions" caption-side="top"}
...
| Writer | As a writer, you have permissions beyond the reader role, including creating and editing service-specific resources. |
{: row-headers}
{: caption="Table 149. Service roles - VMware Solutions" caption-side="top"}
...
{: caption="Table 149. Service actions - VMware Solutions" caption-side="top"}
{: #actions-table149}
{: tab-title="Actions"}
{: tab-group="vmware-solutions"}
{: class="simple-tab-table"}
...
| Operator | As an operator, you can perform platform actions required to configure and operate service instances, such as viewing a service's dashboard. |
{: row-headers}
{: caption="Table 150. Platform roles - Voice Agent with Watson" caption-side="top"}
...
| Writer | As a writer, you have permissions beyond the reader role, including creating and editing service-specific resources. |
{: row-headers}
{: caption="Table 150. Service roles - Voice Agent with Watson" caption-side="top"}
...
{: caption="Table 150. Service actions - Voice Agent with Watson" caption-side="top"}
{: #actions-table150}
{: tab-title="Actions"}
{: tab-group="voiceagent"}
{: class="simple-tab-table"}
...
| Operator | As an operator, you can perform platform actions required to configure and operate service instances, such as viewing a service's dashboard. |
{: row-headers}
{: caption="Table 151. Platform roles - WebSphere Application Server" caption-side="top"}
...
{: caption="Table 151. Service actions - WebSphere Application Server" caption-side="top"}
{: #actions-table151}
{: tab-title="Actions"}
{: tab-group="websphereappsvr"}
{: class="simple-tab-table"}
...
| Operator | As an operator, you can perform platform actions required to configure and operate service instances, such as viewing a service's dashboard. |
{: row-headers}
{: caption="Table 152. Platform roles - Annotator for Clinical Data" caption-side="top"}
...
| Writer | As a writer, you have permissions beyond the reader role, including creating and editing service-specific resources. |
{: row-headers}
{: caption="Table 152. Service roles - Annotator for Clinical Data" caption-side="top"}
...
{: caption="Table 152. Service actions - Annotator for Clinical Data" caption-side="top"}
{: #actions-table152}
{: tab-title="Actions"}
{: tab-group="wh-acd"}
{: class="simple-tab-table"}

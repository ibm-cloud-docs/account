...
{: row-headers}
{: caption="Table 95. Platform roles - Block Storage Snapshots for VPC" caption-side="top"}
...
{: caption="Table 95. Service actions - Block Storage Snapshots for VPC" caption-side="top"}
{: #actions-table95}
{: tab-title="Actions"}
{: tab-group="is.snapshot"}
{: class="simple-tab-table"}
...
| Viewer | As a viewer, you can view service instances, but you can't modify them. |
{: row-headers}
{: caption="Table 97. Platform roles - Block Storage for VPC" caption-side="top"}
...
{: caption="Table 97. Service actions - Block Storage for VPC" caption-side="top"}
{: #actions-table97}
{: tab-title="Actions"}
{: tab-group="is.volume"}
{: class="simple-tab-table"}
...
| Viewer | As a viewer, you can view service instances, but you can't modify them. |
{: row-headers}
{: caption="Table 98. Platform roles - Virtual Private Cloud" caption-side="top"}
...
{: caption="Table 98. Service actions - Virtual Private Cloud" caption-side="top"}
{: #actions-table98}
{: tab-title="Actions"}
{: tab-group="is.vpc"}
{: class="simple-tab-table"}
...
| Viewer | As a viewer, you can view service instances, but you can't modify them. |
{: row-headers}
{: caption="Table 99. Platform roles - VPN for VPC" caption-side="top"}
...
{: caption="Table 99. Service actions - VPN for VPC" caption-side="top"}
{: #actions-table99}
{: tab-title="Actions"}
{: tab-group="is.vpn"}
{: class="simple-tab-table"}
...
| Viewer | As a viewer, you can view service instances, but you can't modify them. |
{: row-headers}
{: caption="Table 100. Platform roles - VPN Server for VPC" caption-side="top"}
...
{: row-headers}
{: caption="Table 100. Service roles - VPN Server for VPC" caption-side="top"}
...
{: caption="Table 100. Service actions - VPN Server for VPC" caption-side="top"}
{: #actions-table100}
{: tab-title="Actions"}
{: tab-group="is.vpn-server"}
{: class="simple-tab-table"}
...
| Writer | As a writer, you have permissions beyond the reader role, including creating and editing service-specific resources. |
{: row-headers}
{: caption="Table 101. Service roles - IBM Key Protect" caption-side="top"}
...
{: caption="Table 101. Service actions - IBM Key Protect" caption-side="top"}
{: #actions-table101}
{: tab-title="Actions"}
{: tab-group="kms"}
{: class="simple-tab-table"}
...
| Viewer | As a viewer, you can view service instances, but you can't modify them. |
{: row-headers}
{: caption="Table 102. Platform roles - Knowledge Studio" caption-side="top"}
...
| Writer | As a writer, you have permissions beyond the reader role, including creating and editing service-specific resources. |
{: row-headers}
{: caption="Table 102. Service roles - Knowledge Studio" caption-side="top"}
...
{: caption="Table 102. Service actions - Knowledge Studio" caption-side="top"}
{: #actions-table102}
{: tab-title="Actions"}
{: tab-group="knowledge-studio"}
{: class="simple-tab-table"}
...
| Writer | As a writer, you have permissions beyond the reader role, including creating and editing service-specific resources. |
{: row-headers}
{: caption="Table 103. Service roles - Language Translator" caption-side="top"}
...
{: caption="Table 103. Service actions - Language Translator" caption-side="top"}
{: #actions-table103}
{: tab-title="Actions"}
{: tab-group="language-translator"}
{: class="simple-tab-table"}
...
| Administrator | As an administrator, you can perform all platform actions based on the resource this role is being assigned, including assigning access policies to other users. |
{: row-headers}
{: caption="Table 104. Platform roles - IBM Log Analysis with LogDNA" caption-side="top"}
...
{: row-headers}
{: caption="Table 104. Service roles - IBM Log Analysis with LogDNA" caption-side="top"}
...
{: caption="Table 104. Service actions - IBM Log Analysis with LogDNA" caption-side="top"}
{: #actions-table104}
{: tab-title="Actions"}
{: tab-group="logdna"}
{: class="simple-tab-table"}
...
| Administrator | As an administrator, you can perform all platform actions based on the resource this role is being assigned, including assigning access policies to other users. |
{: row-headers}
{: caption="Table 105. Platform roles - IBM Cloud Activity Tracker with LogDNA" caption-side="top"}
...
| Standard member | As a member, you can configure views, dashboards and alerts, export data, search, filter, and view all data. |
{: row-headers}
{: caption="Table 105. Service roles - IBM Cloud Activity Tracker with LogDNA" caption-side="top"}
...
{: caption="Table 105. Service actions - IBM Cloud Activity Tracker with LogDNA" caption-side="top"}
{: #actions-table105}
{: tab-title="Actions"}
{: tab-group="logdnaat"}
{: class="simple-tab-table"}
...
| Viewer | As a viewer, you can view service instances, but you can't modify them. |
{: row-headers}
{: caption="Table 106. Platform roles - Managed Solutions" caption-side="top"}
...
| Writer | As a writer, you have permissions beyond the reader role, including creating and editing service-specific resources. |
{: row-headers}
{: caption="Table 106. Service roles - Managed Solutions" caption-side="top"}
...
{: caption="Table 106. Service actions - Managed Solutions" caption-side="top"}
{: #actions-table106}
{: tab-title="Actions"}
{: tab-group="managed-solutions"}
{: class="simple-tab-table"}
...
| Operator | As an operator, you can perform platform actions required to configure and operate service instances, such as viewing a service's dashboard. |
{: row-headers}
{: caption="Table 107. Platform roles - Mass Data Migration" caption-side="top"}
...
| Writer | As a writer, you have permissions beyond the reader role, including creating and editing service-specific resources. |
{: row-headers}
{: caption="Table 107. Service roles - Mass Data Migration" caption-side="top"}
...
{: caption="Table 107. Service actions - Mass Data Migration" caption-side="top"}
{: #actions-table107}
{: tab-title="Actions"}
{: tab-group="mass-data-migration"}
{: class="simple-tab-table"}
...
| Viewer | As a viewer, you can view service instances, but you can't modify them. |
{: row-headers}
{: caption="Table 108. Platform roles - Master Data Connect" caption-side="top"}
...
| Writer | As a writer, you have permissions beyond the reader role, including creating and editing service-specific resources. |
{: row-headers}
{: caption="Table 108. Service roles - Master Data Connect" caption-side="top"}
...
{: caption="Table 108. Service actions - Master Data Connect" caption-side="top"}
{: #actions-table108}
{: tab-title="Actions"}
{: tab-group="mdm-oc"}
{: class="simple-tab-table"}
...
| Writer | As a writer, you have permissions beyond the reader role, including creating and editing service-specific resources. |
{: row-headers}
{: caption="Table 109. Service roles - Event Streams" caption-side="top"}
...
{: caption="Table 109. Service actions - Event Streams" caption-side="top"}
{: #actions-table109}
{: tab-title="Actions"}
{: tab-group="messagehub"}
{: class="simple-tab-table"}
...
| Viewer | As a viewer, you can view database instances but you can't make configuration changes. |
{: row-headers}
{: caption="Table 110. Platform roles - Messages for RabbitMQ" caption-side="top"}
...
| `deployment-capability.read` | Read a capability | Administrator, Editor, Operator, Viewer |
| `capability.read` | Read a capability | Administrator, Editor, Operator, Viewer |
{: caption="Table 110. Service actions - Messages for RabbitMQ" caption-side="top"}
{: #actions-table110}
{: tab-title="Actions"}
{: tab-group="messages-for-rabbitmq"}
{: class="simple-tab-table"}
...
| Viewer | As a viewer, you can view service instances, but you can't modify them. |
{: row-headers}
{: caption="Table 111. Platform roles - Migration Services for IBM Cloud" caption-side="top"}
...
{: caption="Table 111. Service actions - Migration Services for IBM Cloud" caption-side="top"}
{: #actions-table111}
{: tab-title="Actions"}
{: tab-group="migrationtool-from-wanclds"}
{: class="simple-tab-table"}
...
| Viewer | As a viewer, you can view service instances, but you can't modify them. |
{: row-headers}
{: caption="Table 113. Platform roles - IBM Cloud Monitoring Service" caption-side="top"}
...
{: caption="Table 113. Service actions - IBM Cloud Monitoring Service" caption-side="top"}
{: #actions-table113}
{: tab-title="Actions"}
{: tab-group="monitoring"}
{: class="simple-tab-table"}
...
| Viewer | As a viewer, you can view service instances, but you can't modify them. |
{: row-headers}
{: caption="Table 114. Platform roles - IBM MQ" caption-side="top"}
...
| Writer | As a writer, you have permissions beyond the reader role, including creating and editing service-specific resources. |
{: row-headers}
{: caption="Table 114. Service roles - IBM MQ" caption-side="top"}
...
{: caption="Table 114. Service actions - IBM MQ" caption-side="top"}
{: #actions-table114}
{: tab-title="Actions"}
{: tab-group="mqcloud"}
{: class="simple-tab-table"}
...
| Viewer | null |
{: row-headers}
{: caption="Table 115. Platform roles - Natural Language Classifier" caption-side="top"}
...
| Writer | null |
{: row-headers}
{: caption="Table 115. Service roles - Natural Language Classifier" caption-side="top"}
...
{: caption="Table 115. Service actions - Natural Language Classifier" caption-side="top"}
{: #actions-table115}
{: tab-title="Actions"}
{: tab-group="natural-language-classifier"}
{: class="simple-tab-table"}
...
| Operator | As an operator, you can perform platform actions required to configure and operate service instances, such as viewing a service's dashboard. |
{: row-headers}
{: caption="Table 116. Platform roles - Natural Language Understanding" caption-side="top"}
...
| Writer | As a writer, you have permissions beyond the reader role, including creating and editing service-specific resources. |
{: row-headers}
{: caption="Table 116. Service roles - Natural Language Understanding" caption-side="top"}
...
{: caption="Table 116. Service actions - Natural Language Understanding" caption-side="top"}
{: #actions-table116}
{: tab-title="Actions"}
{: tab-group="natural-language-understanding"}
{: class="simple-tab-table"}
...
| Viewer | As a viewer, you can view service instances, but you can't modify them. |
{: row-headers}
{: caption="Table 117. Platform roles - Partner Center" caption-side="top"}
...
{: caption="Table 117. Service actions - Partner Center" caption-side="top"}
{: #actions-table117}
{: tab-title="Actions"}
{: tab-group="partner-portal"}
{: class="simple-tab-table"}
...
| Operator | null |
{: row-headers}
{: caption="Table 118. Platform roles - Personality Insights" caption-side="top"}
...
| Writer | null |
{: row-headers}
{: caption="Table 118. Service roles - Personality Insights" caption-side="top"}
...
{: caption="Table 118. Service actions - Personality Insights" caption-side="top"}
{: #actions-table118}
{: tab-title="Actions"}
{: tab-group="personality-insights"}
{: class="simple-tab-table"}
...
| Editor | As an editor, you can perform all platform actions except for managing the account and assigning access policies. |
{: row-headers}
{: caption="Table 119. Platform roles - Watson Machine Learning" caption-side="top"}
...
{: row-headers}
{: caption="Table 119. Service roles - Watson Machine Learning" caption-side="top"}
...
{: caption="Table 119. Service actions - Watson Machine Learning" caption-side="top"}
{: #actions-table119}
{: tab-title="Actions"}
{: tab-group="pm-20"}
{: class="simple-tab-table"}
...
| Operator | As an operator, you can perform platform actions required to configure and operate service instances, such as viewing a service's dashboard. |
{: row-headers}
{: caption="Table 120. Platform roles - Portworx Enterprise" caption-side="top"}
...
{: caption="Table 120. Service actions - Portworx Enterprise" caption-side="top"}
{: #actions-table120}
{: tab-title="Actions"}
{: tab-group="portworx"}
{: class="simple-tab-table"}
...
| Operator | As an operator, you can perform platform actions required to configure and operate service instances, such as viewing a service's dashboard. |
{: row-headers}
{: caption="Table 121. Platform roles - Portworx Test" caption-side="top"}
...
{: caption="Table 121. Service actions - Portworx Test" caption-side="top"}
{: #actions-table121}
{: tab-title="Actions"}
{: tab-group="portworx-test"}
{: class="simple-tab-table"}
...
| Operator | null |
{: row-headers}
{: caption="Table 122. Platform roles - PowerAI" caption-side="top"}
...
{: caption="Table 122. Service actions - PowerAI" caption-side="top"}
{: #actions-table122}
{: tab-title="Actions"}
{: tab-group="power-ai"}
{: class="simple-tab-table"}
...
| Reader | As a reader, you can perform read-only actions within a service such as viewing service-specific resources. |
{: row-headers}
{: caption="Table 123. Service roles - Power Systems Virtual Server" caption-side="top"}
...
{: caption="Table 123. Service actions - Power Systems Virtual Server" caption-side="top"}
{: #actions-table123}
{: tab-title="Actions"}
{: tab-group="power-iaas"}
{: class="simple-tab-table"}
...
| Viewer | As a viewer, you can view service instances, but you can't modify them. |
{: row-headers}
{: caption="Table 124. Platform roles - HDM Workload Migrator" caption-side="top"}
...
{: caption="Table 124. Service actions - HDM Workload Migrator" caption-side="top"}
{: #actions-table124}
{: tab-title="Actions"}
{: tab-group="primaryio-hdm-workload-migrator"}
{: class="simple-tab-table"}
...
| Operator | As an operator, you can perform platform actions required to configure and operate service instances, such as viewing a service's dashboard. |
{: row-headers}
{: caption="Table 125. Platform roles - Product Lifecycle" caption-side="top"}
...
{: row-headers}
{: caption="Table 125. Service roles - Product Lifecycle" caption-side="top"}
...
{: caption="Table 125. Service actions - Product Lifecycle" caption-side="top"}
{: #actions-table125}
{: tab-title="Actions"}
{: tab-group="product-lifecycle"}
{: class="simple-tab-table"}
...
| Viewer | As a viewer, you can view service instances, but you can't modify them. |
{: row-headers}
{: caption="Table 126. Platform roles - PX-Backup By Portworx" caption-side="top"}
...
{: caption="Table 126. Service actions - PX-Backup By Portworx" caption-side="top"}
{: #actions-table126}
{: tab-title="Actions"}
{: tab-group="px-backup"}
{: class="simple-tab-table"}
...
| Writer | As a writer, you have permissions beyond the reader role, including creating and editing service-specific resources. |
{: row-headers}
{: caption="Table 127. Service roles - Quantum Services" caption-side="top"}
...
{: caption="Table 127. Service actions - Quantum Services" caption-side="top"}
{: #actions-table127}
{: tab-title="Actions"}
{: tab-group="quantum-computing"}
{: class="simple-tab-table"}
...
| Operator | As an operator, you can perform platform actions required to configure and operate service instances, such as viewing a service's dashboard. |
{: row-headers}
{: caption="Table 128. Platform roles - Raxak Protect" caption-side="top"}
...
{: caption="Table 128. Service actions - Raxak Protect" caption-side="top"}
{: #actions-table128}
{: tab-title="Actions"}
{: tab-group="raxak-protect"}
{: class="simple-tab-table"}
...
| Viewer | As a viewer, you can view service instances, but you can't modify them. |
{: row-headers}
{: caption="Table 129. Platform roles - Robin CNS" caption-side="top"}
...
{: caption="Table 129. Service actions - Robin CNS" caption-side="top"}
{: #actions-table129}
{: tab-title="Actions"}
{: tab-group="robin-storage"}
{: class="simple-tab-table"}
...
| Viewer | As a viewer, you can view service instances, but you can't modify them. |
{: row-headers}
{: caption="Table 130. Platform roles - IBM Cloud Satellite" caption-side="top"}
...
| Operator | As an operator, you can perform platform actions required to configure and operate service instances, such as viewing a service's dashboard. |
{: row-headers}
{: caption="Table 131. Platform roles - Satellite Infrastructure Services " caption-side="top"}
...
{: row-headers}
{: caption="Table 131. Service roles - Satellite Infrastructure Services " caption-side="top"}
...
{: caption="Table 131. Service actions - Satellite Infrastructure Services " caption-side="top"}
{: #actions-table131}
{: tab-title="Actions"}
{: tab-group="satellite-iaas"}
{: class="simple-tab-table"}
...
| Viewer | As a viewer, you can view service instances, but you can't modify them. |
{: row-headers}
{: caption="Table 132. Platform roles - Schematics" caption-side="top"}
...
{: caption="Table 132. Service actions - Schematics" caption-side="top"}
{: #actions-table132}
{: tab-title="Actions"}
{: tab-group="schematics"}
{: class="simple-tab-table"}
...
| Operator | As an operator, you can perform platform actions required to configure and operate service instances, such as viewing a service's dashboard. |
{: row-headers}
{: caption="Table 133. Platform roles - Secrets Manager" caption-side="top"}
...
{: row-headers}
{: caption="Table 133. Service roles - Secrets Manager" caption-side="top"}
...
| Operator | As an operator, you can perform platform actions required to configure and operate service instances, such as viewing a service's dashboard. |
{: row-headers}
{: caption="Table 134. Platform roles - Security Advisor" caption-side="top"}
...
| Writer | As a writer, you have permissions beyond the reader role, including creating and editing service-specific resources. |
{: row-headers}
{: caption="Table 134. Service roles - Security Advisor" caption-side="top"}
...
| Operator | As an operator, you can perform platform actions required to configure and operate service instances, such as viewing a service's dashboard. |
{: row-headers}
{: caption="Table 135. Platform roles - Simulated Instruments Analytics API" caption-side="top"}
...
| Reader | As a reader, you can perform read-only actions within a service such as viewing service-specific resources. |
{: row-headers}
{: caption="Table 135. Service roles - Simulated Instruments Analytics API" caption-side="top"}
...
{: caption="Table 135. Service actions - Simulated Instruments Analytics API" caption-side="top"}
{: #actions-table135}
{: tab-title="Actions"}
{: tab-group="sia"}
{: class="simple-tab-table"}
...
| Operator | As an operator, you can perform platform actions required to configure and operate service instances, such as viewing a service's dashboard. |
{: row-headers}
{: caption="Table 136. Platform roles - Skytap On IBM Cloud" caption-side="top"}
...
{: caption="Table 136. Service actions - Skytap On IBM Cloud" caption-side="top"}
{: #actions-table136}
{: tab-title="Actions"}
{: tab-group="skytap"}
{: class="simple-tab-table"}
...
| Operator | As an operator, you can perform platform actions required to configure and operate service instances, such as viewing a service's dashboard. |
{: row-headers}
{: caption="Table 137. Platform roles - Speech to Text" caption-side="top"}
...
| Writer | As a writer, you have permissions beyond the reader role, including creating and editing service-specific resources. |
{: row-headers}
{: caption="Table 137. Service roles - Speech to Text" caption-side="top"}
...
{: caption="Table 137. Service actions - Speech to Text" caption-side="top"}
{: #actions-table137}
{: tab-title="Actions"}
{: tab-group="speech-to-text"}
{: class="simple-tab-table"}
...
| Writer | As a writer, you have permissions beyond the reader role, including creating and editing service-specific resources. |
{: row-headers}
{: caption="Table 138. Service roles - sql-query" caption-side="top"}
...
{: caption="Table 138. Service actions - sql-query" caption-side="top"}
{: #actions-table138}
{: tab-title="Actions"}
{: tab-group="sql-query"}
{: class="simple-tab-table"}
...
| null | null |
{: row-headers}
{: caption="Table 139. Service roles - streaming-analytics" caption-side="top"}
...
{: caption="Table 139. Service actions - streaming-analytics" caption-side="top"}
{: #actions-table139}
{: tab-title="Actions"}
{: tab-group="streaming-analytics"}
{: class="simple-tab-table"}
...
{: row-headers}
{: caption="Table 140. Platform roles - Support Center" caption-side="top"}
...
{: caption="Table 140. Service actions - Support Center" caption-side="top"}
{: #actions-table140}
{: tab-title="Actions"}
{: tab-group="support"}
{: class="simple-tab-table"}
...
| Administrator | As an administrator, you can perform all platform actions based on the resource this role is being assigned, including assigning access policies to other users. |
{: row-headers}
{: caption="Table 141. Platform roles - IBM Cloud Monitoring with Sysdig" caption-side="top"}
...
| Writer | As a writer, you have permissions beyond the reader role, including creating and editing service-specific resources. |
{: row-headers}
{: caption="Table 141. Service roles - IBM Cloud Monitoring with Sysdig" caption-side="top"}
...
{: caption="Table 141. Service actions - IBM Cloud Monitoring with Sysdig" caption-side="top"}
{: #actions-table141}
{: tab-title="Actions"}
{: tab-group="sysdig-monitor"}
{: class="simple-tab-table"}
...
| Operator | As an operator, you can perform platform actions required to configure and operate service instances, such as viewing a service's dashboard. |
{: row-headers}
{: caption="Table 142. Platform roles - Text to Speech" caption-side="top"}
...
| Writer | As a writer, you have permissions beyond the reader role, including creating and editing service-specific resources. |
{: row-headers}
{: caption="Table 142. Service roles - Text to Speech" caption-side="top"}
...
{: caption="Table 142. Service actions - Text to Speech" caption-side="top"}
{: #actions-table142}
{: tab-title="Actions"}
{: tab-group="text-to-speech"}
{: class="simple-tab-table"}
...
| Operator | null |
{: row-headers}
{: caption="Table 143. Platform roles - Tone Analyzer" caption-side="top"}
...
| Writer | null |
{: row-headers}
{: caption="Table 143. Service roles - Tone Analyzer" caption-side="top"}
...
{: caption="Table 143. Service actions - Tone Analyzer" caption-side="top"}
{: #actions-table143}
{: tab-title="Actions"}
{: tab-group="tone-analyzer"}
{: class="simple-tab-table"}
...
| Viewer | As a viewer, you can view service instances, but you can't modify them. |
{: row-headers}
{: caption="Table 144. Platform roles - Toolchain" caption-side="top"}
...
| Viewer | As a viewer, you can view service instances, but you can't modify them. |
{: row-headers}
{: caption="Table 146. Platform roles - Transit Gateway" caption-side="top"}
...
{: row-headers}
{: caption="Table 147. Platform roles - IBM Cloud Platform User Management Service" caption-side="top"}
...
{: caption="Table 147. Service actions - IBM Cloud Platform User Management Service" caption-side="top"}
{: #actions-table147}
{: tab-title="Actions"}
{: tab-group="user-management"}
{: class="simple-tab-table"}
...
| Viewer | As a viewer, you can view service instances, but you can't modify them. |
{: row-headers}
{: caption="Table 148. Platform roles - VMware Solutions" caption-side="top"}
...
| Operator | As an operator, you can perform platform actions required to configure and operate service instances, such as viewing a service's dashboard. |
{: row-headers}
{: caption="Table 149. Platform roles - Voice Agent with Watson" caption-side="top"}
...
| Writer | As a writer, you have permissions beyond the reader role, including creating and editing service-specific resources. |
{: row-headers}
{: caption="Table 149. Service roles - Voice Agent with Watson" caption-side="top"}
...
{: caption="Table 149. Service actions - Voice Agent with Watson" caption-side="top"}
{: #actions-table149}
{: tab-title="Actions"}
{: tab-group="voiceagent"}
{: class="simple-tab-table"}
...
| Operator | As an operator, you can perform platform actions required to configure and operate service instances, such as viewing a service's dashboard. |
{: row-headers}
{: caption="Table 150. Platform roles - WebSphere Application Server" caption-side="top"}
...
{: caption="Table 150. Service actions - WebSphere Application Server" caption-side="top"}
{: #actions-table150}
{: tab-title="Actions"}
{: tab-group="websphereappsvr"}
{: class="simple-tab-table"}
...
| Operator | As an operator, you can perform platform actions required to configure and operate service instances, such as viewing a service's dashboard. |
{: row-headers}
{: caption="Table 151. Platform roles - Annotator for Clinical Data" caption-side="top"}
...
| Writer | As a writer, you have permissions beyond the reader role, including creating and editing service-specific resources. |
{: row-headers}
{: caption="Table 151. Service roles - Annotator for Clinical Data" caption-side="top"}
...
{: caption="Table 151. Service actions - Annotator for Clinical Data" caption-side="top"}
{: #actions-table151}
{: tab-title="Actions"}
{: tab-group="wh-acd"}
{: class="simple-tab-table"}

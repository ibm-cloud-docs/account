...
| Operator | As an operator, you can perform platform actions required to configure and operate service instances, such as viewing a service's dashboard. |
{: row-headers}
{: caption="Table 73. Platform roles - Portworx Enterprise" caption-side="top"}
...
{: caption="Table 73. Service actions - Portworx Enterprise" caption-side="top"}
{: #actions-table73}
{: tab-title="Actions"}
{: tab-group="portworx"}
{: class="simple-tab-table"}
...
| Reader | As a reader, you can perform read-only actions within a service such as viewing service-specific resources. |
{: row-headers}
{: caption="Table 74. Service roles - Power Systems Virtual Server" caption-side="top"}
...
{: caption="Table 74. Service actions - Power Systems Virtual Server" caption-side="top"}
{: #actions-table74}
{: tab-title="Actions"}
{: tab-group="power-iaas"}
{: class="simple-tab-table"}
...
| Operator | Operator |
{: row-headers}
{: caption="Table 75. Platform roles - PowerAI" caption-side="top"}
...
{: caption="Table 75. Service actions - PowerAI" caption-side="top"}
{: #actions-table75}
{: tab-title="Actions"}
{: tab-group="power-ai"}
{: class="simple-tab-table"}
...
| Viewer | As a viewer, you can view service instances, but you can't modify them. |
{: row-headers}
{: caption="Table 78. Platform roles - PX-Backup for Kubernetes" caption-side="top"}
...
| Service Configuration Reader | The ability to read services configuration for Governance management. |
{: row-headers}
{: caption="Table 78. Service roles - PX-Backup for Kubernetes" caption-side="top"}
...
{: caption="Table 78. Service actions - PX-Backup for Kubernetes" caption-side="top"}
{: #actions-table78}
{: tab-title="Actions"}
{: tab-group="px-backup"}
{: class="simple-tab-table"}
...
| Operator | As an operator, you can perform platform actions required to configure and operate service instances, such as viewing a service's dashboard. |
{: row-headers}
{: caption="Table 79. Platform roles - Raxak Protect" caption-side="top"}
...
{: caption="Table 79. Service actions - Raxak Protect" caption-side="top"}
{: #actions-table79}
{: tab-title="Actions"}
{: tab-group="raxak-protect"}
{: class="simple-tab-table"}
...
| Viewer | As a viewer, you can view service instances, but you can't modify them. |
{: row-headers}
{: caption="Table 80. Platform roles - Role management" caption-side="top"}
...
{: caption="Table 80. Service actions - Role management" caption-side="top"}
{: #actions-table80}
{: tab-title="Actions"}
{: tab-group="iam-access-management"}
{: class="simple-tab-table"}
...
| Viewer | As a viewer, you can view service instances, but you can't modify them. |
{: row-headers}
{: caption="Table 81. Platform roles - Satellite" caption-side="top"}
...
| Writer | As a writer, you have permissions beyond the reader role, including creating and editing service-specific resources. |
{: row-headers}
{: caption="Table 81. Service roles - Satellite" caption-side="top"}
...
{: caption="Table 81. Service actions - Satellite" caption-side="top"}
{: #actions-table81}
{: tab-title="Actions"}
{: tab-group="satellite"}
{: class="simple-tab-table"}
...
| Operator | As an operator, you can perform platform actions required to configure and operate service instances, such as viewing a service's dashboard. |
{: row-headers}
{: caption="Table 82. Platform roles - Satellite Infrastructure Service" caption-side="top"}
...
{: row-headers}
{: caption="Table 82. Service roles - Satellite Infrastructure Service" caption-side="top"}
...
{: caption="Table 82. Service actions - Satellite Infrastructure Service" caption-side="top"}
{: #actions-table82}
{: tab-title="Actions"}
{: tab-group="satellite-iaas"}
{: class="simple-tab-table"}
...
| Viewer | As a viewer, you can view service instances, but you can't modify them. |
{: row-headers}
{: caption="Table 83. Platform roles - Schematics" caption-side="top"}
...
| Writer | As a writer, you have permissions beyond the reader role, including creating and editing service-specific resources. |
{: row-headers}
{: caption="Table 83. Service roles - Schematics" caption-side="top"}
...
{: caption="Table 83. Service actions - Schematics" caption-side="top"}
{: #actions-table83}
{: tab-title="Actions"}
{: tab-group="schematics"}
{: class="simple-tab-table"}
...
| Operator | As an operator, you can perform platform actions required to configure and operate service instances, such as viewing a service's dashboard. |
{: row-headers}
{: caption="Table 84. Platform roles - Secrets Manager" caption-side="top"}
...
{: row-headers}
{: caption="Table 84. Service roles - Secrets Manager" caption-side="top"}
...
{: caption="Table 84. Service actions - Secrets Manager" caption-side="top"}
{: #actions-table84}
{: tab-title="Actions"}
{: tab-group="secrets-manager"}
{: class="simple-tab-table"}
...
| Operator | As an operator, you can perform platform actions required to configure and operate service instances, such as viewing a service's dashboard. |
{: row-headers}
{: caption="Table 85. Platform roles - Security Advisor" caption-side="top"}
...
| Writer | As a writer, you have permissions beyond the reader role, including creating and editing service-specific resources. |
{: row-headers}
{: caption="Table 85. Service roles - Security Advisor" caption-side="top"}
...
{: caption="Table 85. Service actions - Security Advisor" caption-side="top"}
{: #actions-table85}
{: tab-title="Actions"}
{: tab-group="security-advisor"}
{: class="simple-tab-table"}
...
| Viewer | As a viewer, you can view service instances, but you can't modify them. |
{: row-headers}
{: caption="Table 86. Platform roles - Security and Compliance Center" caption-side="top"}
...
{: row-headers}
{: caption="Table 86. Service roles - Security and Compliance Center" caption-side="top"}
...
{: caption="Table 86. Service actions - Security and Compliance Center" caption-side="top"}
{: #actions-table86}
{: tab-title="Actions"}
{: tab-group="compliance"}
{: class="simple-tab-table"}
...
| Viewer | As a viewer, you can view service instances, but you can't modify them. |
{: row-headers}
{: caption="Table 87. Platform roles - Security Group for VPC" caption-side="top"}
...
{: caption="Table 87. Service actions - Security Group for VPC" caption-side="top"}
{: #actions-table87}
{: tab-title="Actions"}
{: tab-group="is.security-group"}
{: class="simple-tab-table"}
...
| Operator | As an operator, you can perform platform actions required to configure and operate service instances, such as viewing a service's dashboard. |
{: row-headers}
{: caption="Table 88. Platform roles - Skytap On IBM Cloud" caption-side="top"}
...
{: caption="Table 88. Service actions - Skytap On IBM Cloud" caption-side="top"}
{: #actions-table88}
{: tab-title="Actions"}
{: tab-group="skytap"}
{: class="simple-tab-table"}
...
| Viewer | As a viewer, you can view service instances, but you can't modify them. |
{: row-headers}
{: caption="Table 89. Platform roles - Software Instance" caption-side="top"}
...
{: caption="Table 89. Service actions - Software Instance" caption-side="top"}
{: #actions-table89}
{: tab-title="Actions"}
{: tab-group="globalcatalog-instance"}
{: class="simple-tab-table"}
...
| Operator | As an operator, you can perform platform actions required to configure and operate service instances, such as viewing a service's dashboard. |
{: row-headers}
{: caption="Table 90. Platform roles - Speech to Text" caption-side="top"}
...
| Writer | As a writer, you have permissions beyond the reader role, including creating and editing service-specific resources. |
{: row-headers}
{: caption="Table 90. Service roles - Speech to Text" caption-side="top"}
...
{: caption="Table 90. Service actions - Speech to Text" caption-side="top"}
{: #actions-table90}
{: tab-title="Actions"}
{: tab-group="speech-to-text"}
{: class="simple-tab-table"}
...
| Writer | As a writer, you have permissions beyond the reader role, including creating and editing service-specific resources. |
{: row-headers}
{: caption="Table 91. Service roles - SQL Query" caption-side="top"}
...
{: caption="Table 91. Service actions - SQL Query" caption-side="top"}
{: #actions-table91}
{: tab-title="Actions"}
{: tab-group="sql-query"}
{: class="simple-tab-table"}
...
| Writer | Writer |
{: row-headers}
{: caption="Table 93. Service roles - Streaming Analytics" caption-side="top"}
...
{: caption="Table 93. Service actions - Streaming Analytics" caption-side="top"}
{: #actions-table93}
{: tab-title="Actions"}
{: tab-group="streaming-analytics"}
{: class="simple-tab-table"}
...
| Viewer | As a viewer, you can view service instances, but you can't modify them. |
{: row-headers}
{: caption="Table 94. Platform roles - Subnet" caption-side="top"}
...
{: caption="Table 94. Service actions - Subnet" caption-side="top"}
{: #actions-table94}
{: tab-title="Actions"}
{: tab-group="is.subnet"}
{: class="simple-tab-table"}
...
{: row-headers}
{: caption="Table 95. Platform roles - Support Center" caption-side="top"}
...
{: caption="Table 95. Service actions - Support Center" caption-side="top"}
{: #actions-table95}
{: tab-title="Actions"}
{: tab-group="support"}
{: class="simple-tab-table"}
...
{: caption="Table 96. Service actions - Text to Speech" caption-side="top"}
{: #actions-table96}
{: tab-title="Actions"}
{: tab-group="text-to-speech"}
{: class="simple-tab-table"}
...
| Operator | Operator |
{: row-headers}
{: caption="Table 97. Platform roles - Tone Analyzer" caption-side="top"}
...
| Writer | Writer |
{: row-headers}
{: caption="Table 97. Service roles - Tone Analyzer" caption-side="top"}
...
{: caption="Table 97. Service actions - Tone Analyzer" caption-side="top"}
{: #actions-table97}
{: tab-title="Actions"}
{: tab-group="tone-analyzer"}
{: class="simple-tab-table"}
...
| Viewer | As a viewer, you can view service instances, but you can't modify them. |
{: row-headers}
{: caption="Table 98. Platform roles - Toolchain" caption-side="top"}
...
| Service Configuration Reader | The ability to read services configuration for Governance management. |
{: row-headers}
{: caption="Table 98. Service roles - Toolchain" caption-side="top"}
...
{: caption="Table 98. Service actions - Toolchain" caption-side="top"}
{: #actions-table98}
{: tab-title="Actions"}
{: tab-group="toolchain"}
{: class="simple-tab-table"}
...
| Viewer | As a viewer, you can view service instances, but you can't modify them. |
{: row-headers}
{: caption="Table 99. Platform roles - Transit Gateway" caption-side="top"}
...
{: caption="Table 99. Service actions - Transit Gateway" caption-side="top"}
{: #actions-table99}
{: tab-title="Actions"}
{: tab-group="transit.gateway"}
{: class="simple-tab-table"}
...
{: row-headers}
{: caption="Table 100. Platform roles - User Management" caption-side="top"}
...
{: caption="Table 100. Service actions - User Management" caption-side="top"}
{: #actions-table100}
{: tab-title="Actions"}
{: tab-group="user-management"}
{: class="simple-tab-table"}
...
{: row-headers}
{: caption="Table 102. Platform roles - Virtual Private Endpoint for VPC" caption-side="top"}
...
{: caption="Table 102. Service actions - Virtual Private Endpoint for VPC" caption-side="top"}
{: #actions-table102}
{: tab-title="Actions"}
{: tab-group="is.endpoint-gateway"}
{: class="simple-tab-table"}
...
| Viewer | As a viewer, you can view service instances, but you can't modify them. |
{: row-headers}
{: caption="Table 103. Platform roles - Virtual Server for VPC" caption-side="top"}
...
{: row-headers}
{: caption="Table 103. Service roles - Virtual Server for VPC" caption-side="top"}
...
{: caption="Table 103. Service actions - Virtual Server for VPC" caption-side="top"}
{: #actions-table103}
{: tab-title="Actions"}
{: tab-group="is.instance"}
{: class="simple-tab-table"}
...
| Writer | Writer |
{: row-headers}
{: caption="Table 104. Service roles - Visual Recognition" caption-side="top"}
...
{: caption="Table 104. Service actions - Visual Recognition" caption-side="top"}
{: #actions-table104}
{: tab-title="Actions"}
{: tab-group="watson-vision-combined"}
{: class="simple-tab-table"}
...
| Viewer | As a viewer, you can view service instances, but you can't modify them. |
{: row-headers}
{: caption="Table 105. Platform roles - VMware Solutions" caption-side="top"}
...
{: caption="Table 105. Service actions - VMware Solutions" caption-side="top"}
{: #actions-table105}
{: tab-title="Actions"}
{: tab-group="vmware-solutions"}
{: class="simple-tab-table"}
...
| Operator | As an operator, you can perform platform actions required to configure and operate service instances, such as viewing a service's dashboard. |
{: row-headers}
{: caption="Table 106. Platform roles - Voice Agent with Watson" caption-side="top"}
...
| Writer | As a writer, you have permissions beyond the reader role, including creating and editing service-specific resources. |
{: row-headers}
{: caption="Table 106. Service roles - Voice Agent with Watson" caption-side="top"}
...
{: caption="Table 106. Service actions - Voice Agent with Watson" caption-side="top"}
{: #actions-table106}
{: tab-title="Actions"}
{: tab-group="voiceagent"}
{: class="simple-tab-table"}
...
| Viewer | As a viewer, you can view service instances, but you can't modify them. |
{: row-headers}
{: caption="Table 107. Platform roles - VPC+ Cloud Migration" caption-side="top"}
...
| Service Configuration Reader | The ability to read services configuration for Governance management. |
{: row-headers}
{: caption="Table 107. Service roles - VPC+ Cloud Migration" caption-side="top"}
...
{: caption="Table 107. Service actions - VPC+ Cloud Migration" caption-side="top"}
{: #actions-table107}
{: tab-title="Actions"}
{: tab-group="migrationtool-from-wanclds"}
{: class="simple-tab-table"}
...
| Viewer | As a viewer, you can view service instances, but you can't modify them. |
{: row-headers}
{: caption="Table 109. Platform roles - Watson Assistant" caption-side="top"}
...
| Writer | As a writer, you have permissions beyond the reader role, including creating and editing service-specific resources. |
{: row-headers}
{: caption="Table 109. Service roles - Watson Assistant" caption-side="top"}
...
{: caption="Table 109. Service actions - Watson Assistant" caption-side="top"}
{: #actions-table109}
{: tab-title="Actions"}
{: tab-group="conversation"}
{: class="simple-tab-table"}
...
| Writer | As a writer, you have permissions beyond the reader role, including creating and editing service-specific resources. |
{: row-headers}
{: caption="Table 110. Service roles - Watson Discovery" caption-side="top"}
...
{: caption="Table 110. Service actions - Watson Discovery" caption-side="top"}
{: #actions-table110}
{: tab-title="Actions"}
{: tab-group="discovery"}
{: class="simple-tab-table"}
...
| Administrator | As an administrator, you can perform all platform actions based on the resource this role is being assigned, including assigning access policies to other users. |
{: row-headers}
{: caption="Table 111. Platform roles - Watson Knowledge Catalog" caption-side="top"}
...
| Writer | As a writer, you have permissions beyond the reader role, including creating and editing service-specific resources. |
{: row-headers}
{: caption="Table 111. Service roles - Watson Knowledge Catalog" caption-side="top"}
...
{: caption="Table 111. Service actions - Watson Knowledge Catalog" caption-side="top"}
{: #actions-table111}
{: tab-title="Actions"}
{: tab-group="datacatalog"}
{: class="simple-tab-table"}
...
| Viewer | As a viewer, you can view service instances, but you can't modify them. |
{: row-headers}
{: caption="Table 112. Platform roles - Watson OpenScale" caption-side="top"}
...
{: caption="Table 112. Service actions - Watson OpenScale" caption-side="top"}
{: #actions-table112}
{: tab-title="Actions"}
{: tab-group="aiopenscale"}
{: class="simple-tab-table"}
...
| Operator | As an operator, you can perform platform actions required to configure and operate service instances, such as viewing a service's dashboard. |
{: row-headers}
{: caption="Table 114. Platform roles - WebSphere Application Server" caption-side="top"}
...
{: caption="Table 114. Service actions - WebSphere Application Server" caption-side="top"}
{: #actions-table114}
{: tab-title="Actions"}
{: tab-group="websphereappsvr"}
{: class="simple-tab-table"}

...
Or when you view the list of resource groups for the account, you no longer have a group that is named Default.
...
To resolve the issue, [create a support case](/docs/support?topic=support-open-case) and include the group name from the error message in the case details.
{: tsResolve}

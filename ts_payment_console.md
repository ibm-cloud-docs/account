...
You want to enter a credit card to pay for {{site.data.keyword.cloud_notm}} services, but the option doesn't appear.
{: tsSymptoms}
...
The information is verified and added to your {{site.data.keyword.cloud_notm}} account as your payment method for any charges.

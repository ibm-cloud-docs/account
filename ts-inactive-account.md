...
You can't create an app in {{site.data.keyword.cloud_notm}} if your account is inactive. You must contact the support team and open a request to fix this problem.
{: shortdesc}
...
- To reactivate your account, contact {{site.data.keyword.cloud_notm}} Support by calling 1 (866) 325-0045 and selecting option 3. Include the following information so the support team can help restore the correct account:
{: tsResolve}

* The IBMid that you use to log in to {{site.data.keyword.cloud_notm}}.

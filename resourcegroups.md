...
To easily view the resources that are assigned to a resource group, go to the **Navigation menu** icon ![Menu icon](../icons/icon_hamburger.svg) > **Resource list**. Then, filter by resource group.

If you can't find your classic infrastructure resource on the Resource list page, check the Device list by clicking **Navigation menu** icon ![Menu icon](../icons/icon_hamburger.svg) > **Classic infrastructure** > **Device list**.
{: tip}

...
For production deployments, consider using the [IAM Account Settings module](https://github.com/terraform-ibm-modules/terraform-ibm-iam-account-settings), which provides opinionated, production-ready configurations for IAM account settings. For more information about Terraform IBM Modules, see [About Terraform IBM Modules](https://cloud.ibm.com/docs/ibm-cloud-provider-for-terraform?topic=ibm-cloud-provider-for-terraform-about-tim).
{: tip}

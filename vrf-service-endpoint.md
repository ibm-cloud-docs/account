...
| {{site.data.keyword.ibmwatson_notm}} {{site.data.keyword.wh-acd_short}} | [Public and private network endpoints](/docs/wh-acd?topic=watson-public-private-endpoints) with {{site.data.keyword.wh-acd_short}} |

...
You can have a maximum of 1000 child accounts that can be distributed across a maximum of 300 account groups. An enterprise can contain up to five tiers of accounts and account groups. For more information, see [Enterprise hierarchy](/docs/secure-enterprise?topic=secure-enterprise-what-is-enterprise&interface=ui#enterprise-hierarchy).

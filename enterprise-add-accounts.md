...
You can have up to 1000 accounts in an enterprise. For more information, see [{{site.data.keyword.Bluemix}} IAM limits(/docs/account?topic=account-known-issues#iam_limits)].
{: note}

...
1. Click **Create**.
1. Describe your profile by providing a name, email, and a description, then click **Continue**.
...
1. Select the private catalogs where the trusted profile can access specific products and click **Save**.
